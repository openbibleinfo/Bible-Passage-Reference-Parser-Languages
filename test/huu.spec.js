...
describe("Localized book Gal (huu)", () => {
	...
	it("should handle book: Gal (huu)", () => {
		expect(p.parse("Carta a los Gálatas 1:1").osis()).toEqual("Gal.1.1");
...
describe("Localized book Phlm (huu)", () => {
	...
	it("should handle book: Phlm (huu)", () => {
		expect(p.parse("Carta a Filemón 1:1").osis()).toEqual("Phlm.1.1");
...
describe("Parser helper should handle book ranges (huu)", () => {
	let p = {}
	beforeEach(() => {
		p = new bcv_parser(lang);
		p.set_options({ book_alone_strategy: "ignore", book_sequence_strategy: "ignore", osis_compaction_strategy: "bc", captive_end_digits_strategy: "delete", testaments: "ona" });
	});
	it("should handle book ranges (huu)", () => {
		p.set_options({"book_alone_strategy":"full","book_sequence_strategy":"ignore","osis_compaction_strategy":"bc","captive_end_digits_strategy":"delete","testaments":"ona","book_range_strategy":"include"});
		expect(p.parse("1 Carta de San Juan - Tercera Carta de San Juan").osis()).toEqual("1John.1-3John.1");
		p.set_options({"book_alone_strategy":"full","book_sequence_strategy":"ignore","osis_compaction_strategy":"bc","captive_end_digits_strategy":"delete","testaments":"ona","book_range_strategy":"include"});
		expect(p.parse("1 Carta de San Juan – Tercera Carta de San Juan").osis()).toEqual("1John.1-3John.1");
		p.set_options({"book_alone_strategy":"full","book_sequence_strategy":"ignore","osis_compaction_strategy":"bc","captive_end_digits_strategy":"delete","testaments":"ona","book_range_strategy":"include"});
		expect(p.parse("1 Carta de San Juan — Tercera Carta de San Juan").osis()).toEqual("1John.1-3John.1");
