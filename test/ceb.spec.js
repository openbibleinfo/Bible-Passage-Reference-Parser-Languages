...
import * as lang from "../lang/ceb.js";
...
describe("Localized book Bel (ceb)", () => {
	...
	it("should handle book: Bel (ceb)", () => {
		expect(p.parse("Si Bel ug ang Dragon 1:1").osis()).toEqual("Bel.1.1");
...
describe("Localized book Wis (ceb)", () => {
	...
	it("should handle book: Wis (ceb)", () => {
		expect(p.parse("Kaalam ni Solomon 1:1").osis()).toEqual("Wis.1.1");
...
describe("Localized book EpJer (ceb)", () => {
	...
	it("should handle book: EpJer (ceb)", () => {
		...
		expect(p.parse("Sul Jer 1:1").osis()).toEqual("EpJer.1.1");
...
describe("Localized book Rev (ceb)", () => {
	...
	it("should handle book: Rev (ceb)", () => {
		...
		expect(p.parse("Gipa 1:1").osis()).toEqual("Rev.1.1");
...
describe("Localized book SgThree (ceb)", () => {
	...
	it("should handle book: SgThree (ceb)", () => {
		expect(p.parse("Awit sa Tulo ka Batan-ong Lalaki 1:1").osis()).toEqual("SgThree.1.1");
		expect(p.parse("Awit sa 3 1:1").osis()).toEqual("SgThree.1.1");
