var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["rmz"];
    this.translations = [/(?:BBS)?RMZ\b/gi];
    this.first = /১\.?\s*/;
    this.second = /২\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:প(?:্রক(?:াশ(?:িত(?:\s*ব(?:াক্?য|ক্?য))?|ত(?:\s*ব(?:াক্?য|ক্?য))?)|শ(?:িত(?:\s*ব(?:াক্?য|ক্?য))?|ত(?:\s*ব(?:াক্?য|ক্?য))?))|রক(?:াশ(?:িত(?:\s*ব(?:াক্?য|ক্?য))?|ত(?:\s*ব(?:াক্?য|ক্?য))?)|শ(?:িত(?:\s*ব(?:াক্?য|ক্?য))?|ত(?:\s*ব(?:াক্?য|ক্?য))?)))|ဗ(?:(?:ျာ?ဒ|ာ?ဒ)ိ?တ်|(?:(?:ျာ?ဒ|ာ?ဒ)ိ?တ|ျာ?|ာ)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:မ(?:ဿဲ|ဿ?)|মথি?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ম(?:ার্?ক|র্?ক)|မ(?:ာ?ကု|(?:ာက?|က)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:လ(?:ု?ကာ|(?:ုက?|က)?)|লূ?ক))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:၃ယ(?:(?:ော?ဟ|ာ?ဟ)န်|(?:(?:ော?ဟ|ာ?ဟ)န|ော?|ာ)?)|৩\s*যো?হন))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(১(?:\.\s*যো?হন|\s*যো?হন))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(২(?:\.\s*যো?হন|\s*যো?হন))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ယ(?:(?:ော?ဟ|ာ?ဟ)န်|(?:(?:ော?ဟ|ာ?ဟ)န|ော?|ာ)?)|যো?হন))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:တ(?:မန(?:်တ(?:ော?်|ာ?်)|တ(?:ော?်|ာ?်))|(?:မန(?:်တ(?:ော?|ာ)?|တ(?:ော?|ာ)?))?)|প(?:্র(?:েরি?ত|রি?ত)|র(?:েরি?ত|রি?ত))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:র(?:োম(?:ীয়?|য়?)|ম(?:ীয়?|য়?))|ရ(?:(?:ော?မ|ာ?မ)|(?:ော?|ာ)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(১(?:\.\s*কর(?:ি?ন(?:্থ(?:ীয়?|য়?)|থ(?:ীয়?|য়?))|ি)?|\s*কর(?:ি?ন(?:্থ(?:ীয়?|য়?)|থ(?:ীয়?|য়?))|ি)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(২(?:\.\s*কর(?:ি?ন(?:্থ(?:ীয়?|য়?)|থ(?:ীয়?|য়?))|ি)?|\s*কর(?:ি?ন(?:্থ(?:ীয়?|য়?)|থ(?:ীয়?|য়?))|ি)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁က(?:(?:ော?ရ|ာ?ရ)(?:ိန(?:္သု?|သု?)|န(?:္သု?|သု?))|ော?|ာ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂က(?:(?:ော?ရ|ာ?ရ)(?:ိန(?:္သု?|သု?)|န(?:္သု?|သု?))|ော?|ာ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:က(?:(?:ော?လ|ာ?လ)(?:ော?သဲ|ာ?သဲ)|(?:(?:ော?လ|ာ?လ)(?:ော?သ|ာ?သ)|ော?|ာ)?)|কল(?:স(?:ীয়?|য়?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:গ(?:াল(?:া?ত(?:ীয়?|য়?)|া)?|ল(?:া?ত(?:ীয়?|য়?)|া)?)|ဂ(?:ါ?လာ?တိ|(?:ါ?လာ?တ|ါ)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ইফ(?:ি?ষ(?:ীয়?|য়?)|ি)?|ဧ(?:ဖက်|(?:ဖက)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ဖ(?:ိ?လ(?:ိပ္?ပိ|ပ္?ပိ)|(?:ိ?လ(?:ိပ္?ပ|ပ္?ပ)|ိ)?)|ফ(?:িল(?:ি?প(?:ীয়?|য়?)|ি)?|ল(?:ি?প(?:ীয়?|য়?)|ি)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(১(?:\.\s*থ(?:িষ(?:লন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))?|ষ(?:লন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))?)|\s*থ(?:িষ(?:লন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))?|ষ(?:লন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(২(?:\.\s*থ(?:িষ(?:লন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))?|ষ(?:লন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))?)|\s*থ(?:িষ(?:লন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))?|ষ(?:লন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁သက(?:်?သ(?:ာလ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|လ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?)))|်)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂သက(?:်?သ(?:ာလ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|လ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?)))|်)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(১(?:\.\s*ত(?:ীম(?:থ(?:িয়?|য়?))?|ম(?:থ(?:িয়?|য়?))?)|\s*ত(?:ীম(?:থ(?:িয়?|য়?))?|ম(?:থ(?:িয়?|য়?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(২(?:\.\s*ত(?:ীম(?:থ(?:িয়?|য়?))?|ম(?:থ(?:িয়?|য়?))?)|\s*ত(?:ীম(?:থ(?:িয়?|য়?))?|ম(?:থ(?:িয়?|য়?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁တ(?:ိ?မ(?:ေ(?:ာသေ?|သေ?)|ာသေ?|သေ?)|ိ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂တ(?:ိ?မ(?:ေ(?:ာသေ?|သေ?)|ာသေ?|သေ?)|ိ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:တ(?:ိ?တု|(?:ိတ?|တ)?)|তী?ত))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ဖ(?:ိလ(?:ေ?မ(?:ုန်?|န်?)|ေ)?|လ(?:ေ?မ(?:ုန်?|န်?)|ေ)?)|ফ(?:(?:িলী?মন|লী?মন)|(?:িলী?|লী?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ইব(?:্র(?:ীয়?|য়?)|র(?:ীয়?|য়?))|ဟ(?:(?:ေဗြ?ဲ|ဗြ?ဲ)|(?:ေဗြ?|ဗြ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ယ(?:ာ?ကု?ပ်|(?:ာ?ကု?ပ|ာ)?)|য(?:াকো?ব|কো?ব)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁ပ(?:ေ?တရု?|ေ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂ပ(?:ေ?တရု?|ေ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:য(?:িহ(?:ূদা?|দা?)|হ(?:ূদা?|দা?))|ယ(?:ု?ဒ|ု?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
