var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["mdf"];
    this.translations = [/MOK16\b/gi];
    this.first = /(?:1\.?\s*|Павелонь\.?\s*)/;
    this.second = /(?:2\.?\s*|Павелонь\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Иоанн(?:онди\s*панчф\s*ня[ий]фкс|\.\s*ня[ий]фкс))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Матф(?:е[ий]|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Лук[.а])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Иоаннонь\s*васенце\s*с[её]рмац)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Иоаннонь\s*омбоце\s*с[её]рмац)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Иоаннонь\s*колмоце\s*с[её]рмац|3\s*Иоанн\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь\.?\s*Иоанн\.|1\.?\s*Иоанн\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь\.?\s*Иоанн\.|2\.?\s*Иоанн\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Иоанн)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Апост(?:олхнень\s*тевсна|\.\s*т\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Павелонь\s*с[её]рмац\s*Риму|Рим\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь(?:\.\s*(?:васенце\s*с[её]рмац\s*Коринфу|Кор\.)|\s*(?:васенце\s*с[её]рмац\s*Коринфу|Кор\.))|1(?:\.\s*(?:васенце\s*с[её]рмац\s*Коринфу|Кор\.)|\s*(?:васенце\s*с[её]рмац\s*Коринфу|Кор\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь(?:\.\s*(?:омбоце\s*с[её]рмац\s*Коринфу|Кор\.)|\s*(?:омбоце\s*с[её]рмац\s*Коринфу|Кор\.))|2(?:\.\s*(?:омбоце\s*с[её]рмац\s*Коринфу|Кор\.)|\s*(?:омбоце\s*с[её]рмац\s*Коринфу|Кор\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Павелонь\s*с[её]рмац\s*Колоссав|Кол\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Павелонь\s*с[её]рмац\s*Галатияв|Гал\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Павелонь\s*с[её]рмац\s*Ефесу|Еф\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Павелонь\s*с[её]рмац\s*Филиппав|Фил\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь(?:\.\s*(?:васенце\s*с[её]рмац\s*Фессалоникав|Фесс\.)|\s*(?:васенце\s*с[её]рмац\s*Фессалоникав|Фесс\.))|1(?:\.\s*(?:васенце\s*с[её]рмац\s*Фессалоникав|Фесс\.)|\s*(?:васенце\s*с[её]рмац\s*Фессалоникав|Фесс\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь(?:\.\s*(?:омбоце\s*с[её]рмац\s*Фессалоникав|Фесс\.)|\s*(?:омбоце\s*с[её]рмац\s*Фессалоникав|Фесс\.))|2(?:\.\s*(?:омбоце\s*с[её]рмац\s*Фессалоникав|Фесс\.)|\s*(?:омбоце\s*с[её]рмац\s*Фессалоникав|Фесс\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь(?:\.\s*(?:васенце\s*с[её]рмац\s*Тимофеенди|Тим\.)|\s*(?:васенце\s*с[её]рмац\s*Тимофеенди|Тим\.))|1(?:\.\s*(?:васенце\s*с[её]рмац\s*Тимофеенди|Тим\.)|\s*(?:васенце\s*с[её]рмац\s*Тимофеенди|Тим\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь(?:\.\s*(?:омбоце\s*с[её]рмац\s*Тимофеенди|Тим\.)|\s*(?:омбоце\s*с[её]рмац\s*Тимофеенди|Тим\.))|2(?:\.\s*(?:омбоце\s*с[её]рмац\s*Тимофеенди|Тим\.)|\s*(?:омбоце\s*с[её]рмац\s*Тимофеенди|Тим\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Павелонь\s*с[её]рмац\s*Титонди|Тит\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Павелонь\s*с[её]рмац\s*Филимононди|Филим\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Евр(?:е[ий]хненди\s*с[её]рмась|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Иак(?:овонь\s*с[её]рмац|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь(?:\.\s*П[её]тр\.|\s*П[её]тр\.)|1(?:\.\s*П[её]тр\.|\s*П[её]тр\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Павелонь(?:\.\s*П[её]тр\.|\s*П[её]тр\.)|2(?:\.\s*П[её]тр\.|\s*П[её]тр\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(П[её]торонь\s*васенце\s*с[её]рмац)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(П[её]торонь\s*омбоце\s*с[её]рмац)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Иуд(?:ань\s*с[её]рмац|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
