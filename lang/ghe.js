  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(म(?:ूल\s*स(?:्य(?:ूस(?:्स(?:्य(?:ा(?:यूजे\s*कामजे\s*किताब)?)?|या?)|स्?या|स्?य)|स्?स्?या|स्?स्?य)|यू?स्?स्?या|यू?स्?स्?य)|ल\s*सयससययज\s*कमज\s*कतब|(?:(?:(?:ल\s*स(?:्यू?स|यूस)्?स|ल\s*सयस्स)्?य|ल\s*सयसस्य)|ल\s*सयससय)ा|(?:ल\s*स(?:्यू?स|यूस)्?स|ल\s*सयस्स)्?य|ल\s*सयसस्य|ल\s*सयससय))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
