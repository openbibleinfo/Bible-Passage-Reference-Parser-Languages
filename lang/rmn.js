var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["rmn"];
    this.translations = [/(?:CHERGASH|GURBET|ARLI|KRB)\b/gi];
    this.first = /(?:1\.?\s*|1\.?\s*|Angluni\.?\s*)/;
    this.second = /(?:2\.?\s*|2\.?\s*|Dujto\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(К(?:ердипэ|рд))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Otk(?:rivenje)?|Phu[cć](?:ardipe)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ruth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Руфь)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jonah"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Иона)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelium\s*e\s*Matejestar|M(?:(?:ateje|t)|atej)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelium\s*e\s*Markostar|M(?:arko|k)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelium\s*e\s*Lukastar|Lukahtar|Luk[eé]star|Luka?|Л(?:ука|к)|Lk))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Trito\s*e\s*Jovanesiri|3(?:(?:\.\s*J(?:ovanesko|n)|\s*Jn)|\.\s*Jovan)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Angluni(?:\.\s*(?:e\s*Jovanesiri|J(?:(?:ovanesko|n)|ovan))|\s*(?:e\s*Jovanesiri|J(?:(?:ovanesko|n)|ovan)))|1(?:\.\s*(?:e\s*Jovanesiri|J(?:(?:ovanesko|n)|ovan))|\s*(?:e\s*Jovanesiri|J(?:(?:ovanesko|n)|ovan)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dujto(?:\.\s*(?:e\s*Jovanesiri|J(?:(?:ovanesko|n)|ovan))|\s*(?:e\s*Jovanesiri|J(?:(?:ovanesko|n)|ovan)))|2(?:\.\s*(?:e\s*Jovanesiri|J(?:(?:ovanesko|n)|ovan))|\s*(?:e\s*Jovanesiri|J(?:(?:ovanesko|n)|ovan)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelium\s*e\s*Jovanostar|J(?:(?:ovan[eo]|n)|ovan)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:[CĆ]e(?:rdipna\s*e\s*apostolengere|ap)|Delj?a|Bu[cć]a|Д(?:ила|л)|Dap))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Rim(?:ljanen[gđ]e)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Angluni(?:\.\s*(?:e\s*Korin[cć]anjenge|Korin[cć]anenđe|Kor)|\s*(?:e\s*Korin[cć]anjenge|Korin[cć]anenđe|Kor))|1(?:\.\s*(?:e\s*Korin[cć]anjenge|Korin[cć]anenđe|Kor)|\s*(?:e\s*Korin[cć]anjenge|Korin[cć]anenđe|Kor))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dujto(?:\.\s*Kor(?:in[cć]an(?:jeng|enđ)e)?|\s*Kor(?:in[cć]an(?:jeng|enđ)e)?)|2(?:\.\s*Kor(?:in[cć]an(?:jeng|enđ)e)?|\s*Kor(?:in[cć]an(?:jeng|enđ)e)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Kolo[sš]an(?:ur)?enđe|E\s*Kolo[sš]anenge|Kol))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Gala(?:[cć]an(?:ur)?enđ|tenđ)e|E\s*Galatenge|Gal))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ef(?:e(?:sc(?:oneng|urenđ)|[zž]anenđ)e)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:E\s*Filipljanenge|F(?:ilipljanenđe|(?:il|lp))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Angluni(?:\.\s*(?:e\s*Solunjamnenge|Sol(?:unjanenđe)?)|\s*(?:e\s*Solunjamnenge|Sol(?:unjanenđe)?))|1(?:\.\s*(?:e\s*Solunjamnenge|Sol(?:unjanenđe)?)|\s*(?:e\s*Solunjamnenge|Sol(?:unjanenđe)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dujto(?:\.\s*(?:e\s*Solunjamnenge|Sol(?:unjanenđe)?)|\s*(?:e\s*Solunjamnenge|Sol(?:unjanenđe)?))|2(?:\.\s*(?:e\s*Solunjamnenge|Sol(?:unjanenđe)?)|\s*(?:e\s*Solunjamnenge|Sol(?:unjanenđe)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Angluni(?:\.\s*(?:e\s*Timotejese|Timoteje[sš][cć]e|Tim(?:otej)?)|\s*(?:e\s*Timotejese|Timoteje[sš][cć]e|Tim(?:otej)?))|1(?:\.\s*(?:e\s*Timotejese|Timoteje[sš][cć]e|Tim(?:otej)?)|\s*(?:e\s*Timotejese|Timoteje[sš][cć]e|Tim(?:otej)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dujto(?:\.\s*(?:e\s*Timotejese|Timoteje[sš][cć]e|Tim(?:otej)?)|\s*(?:e\s*Timotejese|Timoteje[sš][cć]e|Tim(?:otej)?))|2(?:\.\s*(?:e\s*Timotejese|Timoteje[sš][cć]e|Tim(?:otej)?)|\s*(?:e\s*Timotejese|Timoteje[sš][cć]e|Tim(?:otej)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:E\s*Titose|Tito[sš][cć]e|Tit(?:us)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:E\s*Filimonose|Filemone[sš][cć]e|F(?:ilimon|lm)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:E\s*Jevrejenge|Jev))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:E\s*Jakovesiri|Jak(?:ovesko|(?:ov)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Angluni(?:\.\s*(?:e\s*Petresiri|Pet(?:(?:resko|ar))?)|\s*(?:e\s*Petresiri|Pet(?:(?:resko|ar))?))|1(?:\.\s*(?:e\s*Petresiri|Pet(?:(?:resko|ar))?)|\s*(?:e\s*Petresiri|Pet(?:(?:resko|ar))?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dujto(?:\.\s*(?:e\s*Petresiri|Pet(?:(?:resko|ar))?)|\s*(?:e\s*Petresiri|Pet(?:(?:resko|ar))?))|2(?:\.\s*(?:e\s*Petresiri|Pet(?:(?:resko|ar))?)|\s*(?:e\s*Petresiri|Pet(?:(?:resko|ar))?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:E\s*Judesiri|Jud(?:asko|a?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
