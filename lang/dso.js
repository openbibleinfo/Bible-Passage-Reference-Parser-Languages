var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["dso"];
    this.translations = [/NTSAA20\b/gi];
    this.first = /(?:୧\.?\s*|୧ମ\.?\s*)/;
    this.second = /(?:୨\.?\s*|୨ୟ\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପର(?:୍‌କ(?:ାସି?ତ|ସି?ତ)|‌କ(?:ାସି?ତ|ସି?ତ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ମ(?:ାତି?ଉ|ତି?ଉ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଲ(?:ୁକ୍?‌|କ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:ମ(?:\.\s*ମ\s*ଜଅନ୍?‌|\s*ମ\s*ଜଅନ୍?‌)|\.\s*ମ\s*ଜଅନ୍?‌|\s*ମ\s*ଜଅନ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୩\s*ୟ\s*ଜଅନ୍?‌)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:ୟ(?:\.\s*ୟ\s*ଜଅନ୍?‌|\s*ୟ\s*ଜଅନ୍?‌)|\.\s*ୟ\s*ଜଅନ୍?‌|\s*ୟ\s*ଜଅନ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଜଅନ୍?‌)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:େର(?:ିତ୍?‌|ତ୍?‌)|ର(?:ିତ୍?‌|ତ୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ରମି?ୟ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:ମ(?:\.\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)|\s*କରନ(?:୍ତି?ୟ|ତି?ୟ))|\.\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)|\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:ୟ(?:\.\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)|\s*କରନ(?:୍ତି?ୟ|ତି?ୟ))|\.\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)|\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(କଲସି?ଅ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଗ(?:ାଲ(?:ାତି?ୟ|ତି?ୟ)|ଲ(?:ାତି?ୟ|ତି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଏପ(?:ିସି?ୟ|ସି?ୟ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:ିଲ(?:ିପି?ୟ|ପି?ୟ)|ଲ(?:ିପି?ୟ|ପି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:ମ(?:\.\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))|\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ)))|\.\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))|\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:ୟ(?:\.\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))|\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ)))|\.\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))|\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:ମ(?:\.\s*ତ(?:ିମତି?|ମତି?)|\s*ତ(?:ିମତି?|ମତି?))|\.\s*ତ(?:ିମତି?|ମତି?)|\s*ତ(?:ିମତି?|ମତି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:ୟ(?:\.\s*ତ(?:ିମତି?|ମତି?)|\s*ତ(?:ିମତି?|ମତି?))|\.\s*ତ(?:ିମତି?|ମତି?)|\s*ତ(?:ିମତି?|ମତି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ତ(?:ିତସ୍?‌|ତସ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:ିଲ(?:ିମନ୍?‌|ମନ୍?‌)|ଲ(?:ିମନ୍?‌|ମନ୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଏବ(?:୍‌ରି?|‌ରି?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଜ(?:ାକୁ?ବ|କୁ?ବ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:ମ(?:\.\s*ମ\s*ପ(?:ିତର୍?‌|ତର୍?‌)|\s*ମ\s*ପ(?:ିତର୍?‌|ତର୍?‌))|\.\s*ମ\s*ପ(?:ିତର୍?‌|ତର୍?‌)|\s*ମ\s*ପ(?:ିତର୍?‌|ତର୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:ୟ(?:\.\s*ୟ\s*ପ(?:ିତର୍?‌|ତର୍?‌)|\s*ୟ\s*ପ(?:ିତର୍?‌|ତର୍?‌))|\.\s*ୟ\s*ପ(?:ିତର୍?‌|ତର୍?‌)|\s*ୟ\s*ପ(?:ିତର୍?‌|ତର୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଜ(?:ିଉଦା?|ଉଦା?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
