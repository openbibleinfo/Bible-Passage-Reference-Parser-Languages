  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:I(?:ꞌd[oó]ŋ[aá]|da)|Íꞌd[oó]ŋ[aá]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Exod"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Af(?:u(?:ŋ[aá])?|ũŋ[aá])|Ãf[uũ]ŋ[aá]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ic(?:e(?:t[aá]ŋ[aá])?|ét[aá]ŋ[aá])|Íc[eé]t[aá]ŋ[aá]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Deut"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Az[iị](?:́t[aá]ŋ[aá]\s*Amviŋ[aá]|t[aá]ŋ[aá]\s*Amviŋ[aá])|Ãz[iị](?:́t[aá]ŋ[aá]\s*Amviŋ[aá]|t[aá]ŋ[aá]\s*Amviŋ[aá])|Aza))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ruth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(R(?:út[uụ]̃?|ụ(?:́t[uụ]̃?|t[uụ]̃?)|ut[uụ]̃?|ut))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Prov"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:I(?:́j[oọ](?:́\s*Uꞌb[eé]ŋ[aá]|\s*Uꞌb[eé]ŋ[aá])|(?:j[oọ](?:́\s*Uꞌb[eé]ŋ[aá]|\s*Uꞌb[eé]ŋ[aá])|bu))|Ị(?:́j[oọ](?:́\s*Uꞌb[eé]ŋ[aá]|\s*Uꞌb[eé]ŋ[aá])|j[oọ](?:́\s*Uꞌb[eé]ŋ[aá]|\s*Uꞌb[eé]ŋ[aá]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(M(?:at[aá]y[oõ]|ãt[aá]y[oõ]|at))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(M(?:ar[aá]k[oõ]|ãr[aá]k[oõ]|ar))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(L(?:u(?:́k[aã]|k(?:[aã])?)|ụ(?:́k[aã]|k[aã])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1Yn)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2Yn)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\s*Y[oõ]h[aá]n[aã]|Yn))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*Y[oõ]h[aá]n[aã]|\s*Y[oõ]h[aá]n[aã]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*Y[oõ]h[aá]n[aã]|\s*Y[oõ]h[aá]n[aã]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Y(?:oh[aá]n[aã]|õh[aá]n[aã]|oh))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ꞌEt[aá]ŋ[aá]|Eta))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(R(?:úm[iị]̃?|ụ(?:́m[iị]̃?|m[iị]̃?)|um[iị]̃?|um))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*K[oọ](?:̃r[iị](?:̃n[iị](?:́t[oọ]̃?|t[oọ]̃?)|n[iị](?:́t[oọ]̃?|t[oọ]̃?))|r[iị](?:̃n[iị](?:́t[oọ]̃?|t[oọ]̃?)|n[iị](?:́t[oọ]̃?|t[oọ]̃?)))|\s*K[oọ](?:̃r[iị](?:̃n[iị](?:́t[oọ]̃?|t[oọ]̃?)|n[iị](?:́t[oọ]̃?|t[oọ]̃?))|r[iị](?:̃n[iị](?:́t[oọ]̃?|t[oọ]̃?)|n[iị](?:́t[oọ]̃?|t[oọ]̃?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*K[oọ](?:̃r[iị](?:̃n[iị](?:́t[oọ]̃?|t[oọ]̃?)|n[iị](?:́t[oọ]̃?|t[oọ]̃?))|r[iị](?:̃n[iị](?:́t[oọ]̃?|t[oọ]̃?)|n[iị](?:́t[oọ]̃?|t[oọ]̃?)))|\s*K[oọ](?:̃r[iị](?:̃n[iị](?:́t[oọ]̃?|t[oọ]̃?)|n[iị](?:́t[oọ]̃?|t[oọ]̃?))|r[iị](?:̃n[iị](?:́t[oọ]̃?|t[oọ]̃?)|n[iị](?:́t[oọ]̃?|t[oọ]̃?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
          ...
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(K(?:ol[oõ]s[aá]y[iĩ]|õl[oõ]s[aá]y[iĩ]|ol))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(G(?:al[aã]t[iị](?:́y[aã]|y[aã])|ãl[aã]t[iị](?:́y[aã]|y[aã])|al))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ef(?:e(?:s[oõ])?|és[oõ])|Ẽf[eé]s[oõ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F(?:ĩl[iị](?:́p[iị]̃?|p[iị]̃?)|ị(?:̃l[iị](?:́p[iị]̃?|p[iị]̃?)|l[iị](?:́p[iị]̃?|p[iị]̃?))|il[iị](?:́p[iị]̃?|p[iị]̃?)|il))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*T(?:ẹ̃sãlọ̃nị́kị̃|esaloniki)|\s*T(?:ẹ̃sãlọ̃nị́kị̃|esaloniki)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*T(?:ẹ̃sãlọ̃nị́kị̃|esaloniki)|\s*T(?:ẹ̃sãlọ̃nị́kị̃|esaloniki)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
          ...
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*T[iị](?:̃m[iị](?:̃t[iị](?:́y[oọ]̃?|y[oọ]̃?)|t[iị](?:́y[oọ]̃?|y[oọ]̃?))|m[iị](?:̃t[iị](?:́y[oọ]̃?|y[oọ]̃?)|t[iị](?:́y[oọ]̃?|y[oọ]̃?)))|\s*T[iị](?:̃m[iị](?:̃t[iị](?:́y[oọ]̃?|y[oọ]̃?)|t[iị](?:́y[oọ]̃?|y[oọ]̃?))|m[iị](?:̃t[iị](?:́y[oọ]̃?|y[oọ]̃?)|t[iị](?:́y[oọ]̃?|y[oọ]̃?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*T[iị](?:̃m[iị](?:̃t[iị](?:́y[oọ]̃?|y[oọ]̃?)|t[iị](?:́y[oọ]̃?|y[oọ]̃?))|m[iị](?:̃t[iị](?:́y[oọ]̃?|y[oọ]̃?)|t[iị](?:́y[oọ]̃?|y[oọ]̃?)))|\s*T[iị](?:̃m[iị](?:̃t[iị](?:́y[oọ]̃?|y[oọ]̃?)|t[iị](?:́y[oọ]̃?|y[oọ]̃?))|m[iị](?:̃t[iị](?:́y[oọ]̃?|y[oọ]̃?)|t[iị](?:́y[oọ]̃?|y[oọ]̃?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
          ...
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(T(?:ít[oọ]̃?|ị(?:́t[oọ]̃?|t[oọ]̃?)|it[oọ]̃?|it))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F(?:[iị](?:̃l[iị](?:̃m[oọ](?:́n[aã]|n[aã])|m[oọ](?:́n[aã]|n[aã]))|l[iị](?:̃m[oọ](?:́n[aã]|n[aã])|m[oọ](?:́n[aã]|n[aã])))|lm))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Eb[uũ]r[aã]n[ií]y[aã]|Ẽb[uũ]r[aã]n[ií]y[aã]|Ebr))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Y(?:ak[oó]ꞌb[oõ]|ãk[oó]ꞌb[oõ]|ak))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*P[eé]t[eẽ]r[oõ]|\s*P[eé]t[eẽ]r[oõ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*P[eé]t[eẽ]r[oõ]|\s*P[eé]t[eẽ]r[oõ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
          ...
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Y(?:u(?:́d[aã]|d(?:[aã])?)|ụ(?:́d[aã]|d[aã])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
