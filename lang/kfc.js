var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["kfc"];
    this.translations = [/(?:NTKOO20|KFC)\b/gi];
    this.first = /୧\.?\s*/;
    this.second = /୨\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ପ(?:୍ରକ(?:ାଶି?ତ|ଶି?ତ)|ରକ(?:ାଶି?ତ|ଶି?ତ))|ప్?రకటన))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:మత(?:్తయి?|తయి?)|ମ(?:ାତି?ଉ|ତି?ଉ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:మ(?:ార(?:్కు?|కు?)|ర(?:్కు?|కు?))|ମ(?:ାର୍?କ|ର୍?କ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ల(?:ూకా?|కా?)|ଲୁ?କ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:3య(?:(?:ోహా?ను|హా?ను)|(?:ోహా?న|హా?న))|୩\s*ଜୋ?ହନ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ଜୋ?ହନ|\s*ଜୋ?ହନ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ଜୋ?ହନ|\s*ଜୋ?ହନ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?))|ଜୋ?ହନ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ପ(?:୍ର(?:େରି?ତ|ରି?ତ)|ର(?:େରି?ତ|ରି?ତ))|అప(?:ొస(?:్తు?|తు?)|స(?:్తు?|తు?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ର(?:ୋମି?ୟ|ମି?ୟ)|రో?మ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*କର(?:ିନ(?:୍ତି?ୟ|ତି?ୟ)|ନ(?:୍ତି?ୟ|ତି?ୟ))|\s*କର(?:ିନ(?:୍ତି?ୟ|ତି?ୟ)|ନ(?:୍ତି?ୟ|ତି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*କର(?:ିନ(?:୍ତି?ୟ|ତି?ୟ)|ନ(?:୍ତି?ୟ|ତି?ୟ))|\s*କର(?:ିନ(?:୍ତି?ୟ|ତି?ୟ)|ନ(?:୍ତି?ୟ|ତି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1క(?:ొర(?:ి(?:ంతి?|తి?)|ంతి?|తి?)|ర(?:ి(?:ంతి?|తి?)|ంతి?|తి?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2క(?:ొర(?:ి(?:ంతి?|తి?)|ంతి?|తి?)|ర(?:ి(?:ంతి?|తి?)|ంతి?|తి?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:క(?:(?:ొలొ?సి|లొ?సి)|(?:ొలొ?స|లొ?స))|କଲସି?ୟ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଗ(?:ାଲ(?:ାତି?ୟ|ତି?ୟ)|ଲ(?:ାତି?ୟ|ତି?ୟ))|గలతీ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଏପ(?:ିସି?ୟ|ସି?ୟ)|ఎప(?:ె?సి|ె?స)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ప(?:ిల(?:ిప(?:్పి?|పి?)|ప(?:్పి?|పి?))|ల(?:ిప(?:్పి?|పి?)|ప(?:్పి?|పి?)))|ପ(?:ିଲ(?:ିପି?ୟ|ପି?ୟ)|ଲ(?:ିପି?ୟ|ପି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))|\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))|\s*ତ(?:େସଲନ(?:ିକି?ୟ|କି?ୟ)|ସଲନ(?:ିକି?ୟ|କି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1ద(?:ెస్?స|స్?స))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2ద(?:ెస్?స|స్?స))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ତ(?:ିମତି?|ମତି?)|\s*ତ(?:ିମତି?|ମତି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ତ(?:ିମତି?|ମତି?)|\s*ତ(?:ିମତି?|ମତି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1త(?:ిమ(?:ోతి?|తి?)|మ(?:ోతి?|తి?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2త(?:ిమ(?:ోతి?|తి?)|మ(?:ోతి?|తి?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:త(?:ీ?తు|ీ?త)|ତି?ତସ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ప(?:(?:ిలొ?మో|లొ?మో)|(?:ిలొ?మ|లొ?మ))|ପ(?:ିଲି?ମନ|ଲି?ମନ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଏବ(?:୍?ରି|୍?ର)|ఎబ(?:్రి?|రి?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:య(?:ాక(?:ోబు?|బు?)|క(?:ోబు?|బు?))|ଜ(?:ାକୁ?ବ|କୁ?ବ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ପି?ତର|\s*ପି?ତର))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1ప(?:ేత(?:ురు?|రు?)|త(?:ురు?|రు?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2ప(?:ేత(?:ురు?|రు?)|త(?:ురు?|రు?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଜ(?:ିହ(?:ୁଦା?|ଦା?)|ହ(?:ୁଦା?|ଦା?))|య(?:ూ?దా|ూ?ద)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
