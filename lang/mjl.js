  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्रक(?:ा?सन(?:ा\s*र(?:ी\s*गल(?:्ला?|ला?)|\s*गल(?:्ला?|ला?))|\s*र(?:ी\s*गल(?:्ला?|ला?)|\s*गल(?:्ला?|ला?)))|ा?\.)|रक(?:ा?सन(?:ा\s*र(?:ी\s*गल(?:्ला?|ला?)|\s*गल(?:्ला?|ला?))|\s*र(?:ी\s*गल(?:्ला?|ला?)|\s*गल(?:्ला?|ला?)))|ा?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मरक(?:ु[.स]|[.स]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*यह(?:ू?न(?:्ना?|ना?)|ू?\.)|\s*यह(?:ू?न(?:्ना?|ना?)|ू?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*यह(?:ू?न(?:्ना?|ना?)|ू?\.)|\s*यह(?:ू?न(?:्ना?|ना?)|ू?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*यह(?:ू?न(?:्ना?|ना?)|ू?\.)|\s*यह(?:ू?न(?:्ना?|ना?)|ू?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यह(?:ू?न(?:्ना?|ना?)|ू?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(च(?:ुण(?:िर(?:े\s*च(?:ेल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?|ल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?)|\s*च(?:ेल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?|ल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?))|र(?:े\s*च(?:ेल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?|ल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?)|\s*च(?:ेल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?|ल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?)))|ण(?:िर(?:े\s*च(?:ेल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?|ल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?)|\s*च(?:ेल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?|ल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?))|र(?:े\s*च(?:ेल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?|ल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?)|\s*च(?:ेल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?|ल(?:े?\s*र(?:े\s*का?म|\s*का?म)|े)?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुर(?:ि?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ि?\.)|र(?:ि?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ि?\.))|\s*क(?:ुर(?:ि?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ि?\.)|र(?:ि?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ि?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुर(?:ि?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ि?\.)|र(?:ि?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ि?\.))|\s*क(?:ुर(?:ि?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ि?\.)|र(?:ि?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ि?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(गल(?:ा?त(?:ियो?|यो?)|ा?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इफ(?:ि?स(?:ियो?|यो?)|ि?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:िप(?:्प(?:ियो?|ी?\.|यो?)|प(?:ियो?|ी?\.|यो?))|प(?:्प(?:ियो?|ी?\.|यो?)|प(?:ियो?|ी?\.|यो?)))|ल(?:िप(?:्प(?:ियो?|ी?\.|यो?)|प(?:ियो?|ी?\.|यो?))|प(?:्प(?:ियो?|ी?\.|यो?)|प(?:ियो?|ी?\.|यो?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:िस(?:्स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)|स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.))|स(?:्स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)|स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)))|\s*थ(?:िस(?:्स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)|स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.))|स(?:्स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)|स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:िस(?:्स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)|स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.))|स(?:्स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)|स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)))|\s*थ(?:िस(?:्स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)|स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.))|स(?:्स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)|स(?:ल(?:ुनक(?:ियो?|यो?)|नक(?:ियो?|यो?))|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:िम(?:ि?थ(?:ियु?स|यु?स)|ि?\.)|म(?:ि?थ(?:ियु?स|यु?स)|ि?\.))|\s*त(?:िम(?:ि?थ(?:ियु?स|यु?स)|ि?\.)|म(?:ि?थ(?:ियु?स|यु?स)|ि?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:िम(?:ि?थ(?:ियु?स|यु?स)|ि?\.)|म(?:ि?थ(?:ियु?स|यु?स)|ि?\.))|\s*त(?:िम(?:ि?थ(?:ियु?स|यु?स)|ि?\.)|म(?:ि?थ(?:ियु?स|यु?स)|ि?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ित(?:ु[.स]|[.स])|त(?:ु[.स]|[.स])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ेम(?:ो[.न]|[.न])|म(?:ो[.न]|[.न]))|ल(?:ेम(?:ो[.न]|[.न])|म(?:ो[.न]|[.न]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
