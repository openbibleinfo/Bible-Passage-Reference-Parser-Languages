var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["ote"];
    this.translations = [/OTE\b/gi];
    this.first = /(?:1\.?\s*|Rá\.?\s*|Ra\.?\s*)/;
    this.second = /(?:2\.?\s*|Rá\.?\s*|Ra\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Apocalipsi|Ap\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Nsan\s*Mateo|Mt\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Nsan\s*Marco|Mc\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Nsan\s*Luca|Lc\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá]\s*H[nñ]u\s*Ra\s*Xuua|3\s*Jn\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:Mʉdi\s*Ra\s*Xuua|Jn\.)|\s*(?:Mʉdi\s*Ra\s*Xuua|Jn\.))|1(?:\.\s*(?:Mʉdi\s*Ra\s*Xuua|Jn\.)|\s*(?:Mʉdi\s*Ra\s*Xuua|Jn\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:[NÑ]oho\s*Ra\s*Xuua|Jn\.)|\s*(?:[NÑ]oho\s*Ra\s*Xuua|Jn\.))|2(?:\.\s*(?:[NÑ]oho\s*Ra\s*Xuua|Jn\.)|\s*(?:[NÑ]oho\s*Ra\s*Xuua|Jn\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Nsanjua|Jn\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Echo|Hch\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(R(?:a\s*Romanu|o\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:Mʉdi\s*Ra\s*Corintio|Co\.)|\s*(?:Mʉdi\s*Ra\s*Corintio|Co\.))|1(?:\.\s*(?:Mʉdi\s*Ra\s*Corintio|Co\.)|\s*(?:Mʉdi\s*Ra\s*Corintio|Co\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:[NÑ]oho\s*Ra\s*Corintio|Co\.)|\s*(?:[NÑ]oho\s*Ra\s*Corintio|Co\.))|2(?:\.\s*(?:[NÑ]oho\s*Ra\s*Corintio|Co\.)|\s*(?:[NÑ]oho\s*Ra\s*Corintio|Co\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Colosense|Col\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Galata|G[aá]\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Efesio|Ef\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Filipense|Fil\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:Mʉdi\s*Ra\s*Tesalonicense|Ts\.)|\s*(?:Mʉdi\s*Ra\s*Tesalonicense|Ts\.))|1(?:\.\s*(?:Mʉdi\s*Ra\s*Tesalonicense|Ts\.)|\s*(?:Mʉdi\s*Ra\s*Tesalonicense|Ts\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:[NÑ]oho\s*Ra\s*Tesalonicense|Ts\.)|\s*(?:[NÑ]oho\s*Ra\s*Tesalonicense|Ts\.))|2(?:\.\s*(?:[NÑ]oho\s*Ra\s*Tesalonicense|Ts\.)|\s*(?:[NÑ]oho\s*Ra\s*Tesalonicense|Ts\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:Mʉdi\s*Ra\s*Timoteo|Ti\.)|\s*(?:Mʉdi\s*Ra\s*Timoteo|Ti\.))|1(?:\.\s*(?:Mʉdi\s*Ra\s*Timoteo|Ti\.)|\s*(?:Mʉdi\s*Ra\s*Timoteo|Ti\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:[NÑ]oho\s*Ra\s*Timoteo|Ti\.)|\s*(?:[NÑ]oho\s*Ra\s*Timoteo|Ti\.))|2(?:\.\s*(?:[NÑ]oho\s*Ra\s*Timoteo|Ti\.)|\s*(?:[NÑ]oho\s*Ra\s*Timoteo|Ti\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Tito|Tit\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Filem[oó]n|Flm\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Ebreo|Heb\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*Santiago|Stg\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:Mʉdi\s*Ra\s*)?Pedro|\s*(?:Mʉdi\s*Ra\s*)?Pedro)|1(?:\.\s*(?:Mʉdi\s*Ra\s*)?Pedro|\s*(?:Mʉdi\s*Ra\s*)?Pedro)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:R[aá](?:\.\s*(?:[NÑ]oho\s*Ra\s*)?Pedro|\s*(?:[NÑ]oho\s*Ra\s*)?Pedro)|2(?:\.\s*(?:[NÑ]oho\s*Ra\s*)?Pedro|\s*(?:[NÑ]oho\s*Ra\s*)?Pedro)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ra\s*)?Juda)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
