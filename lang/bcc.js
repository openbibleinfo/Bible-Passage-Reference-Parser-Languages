var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["bcc"];
    this.translations = [/BAL\b/gi];
    this.first = /(?:1\.?\s*|Pa\.?\s*|په\.?\s*)/;
    this.second = /(?:Pa\.?\s*|په\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:P(?:[eé]d[aá]esh|[eé]d)|پێدایش))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Exod"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Dargwaz|د(?:َرگوَ?ز|رگوَ?ز)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:اِ?لهام|Elh[aá]m))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ps"],
            testament: "oa",
            testament_books: { Ps: "oa" },
            regexp: /(?:^|(?<=[^\p{L}]))((?:Zabur|زَ?بور))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Dan"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:D[aá]ny[aá]l|دانیال))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Mat(?:t[aá])?|م(?:َتّ?ا|تّ?ا)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Mar(?:k[aá]s)?|مَ?رکاس))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Luk(?:[aá])?|لوکا))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Yuh(?:ann[aá]ay\s*Awali\s*K[aá]gad|1)|یوه(?:َن(?:ّا(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1)|ا(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1))|ن(?:ّا(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1)|ا(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Yuh(?:ann[aá]ay\s*Domi\s*K[aá]gad|2)|یوه(?:َن(?:ّا(?:[ئي]ے\s*دومی\s*کاگد|2)|ا(?:[ئي]ے\s*دومی\s*کاگد|2))|ن(?:ّا(?:[ئي]ے\s*دومی\s*کاگد|2)|ا(?:[ئي]ے\s*دومی\s*کاگد|2)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Yuh(?:ann[aá]ay\s*Saymi\s*K[aá]gad|3)|یوه(?:َن(?:ّا(?:[ئي]ے\s*س[ئي]یمی\s*کاگد|3)|ا(?:[ئي]ے\s*س[ئي]یمی\s*کاگد|3))|ن(?:ّا(?:[ئي]ے\s*س[ئي]یمی\s*کاگد|3)|ا(?:[ئي]ے\s*س[ئي]یمی\s*کاگد|3)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Yuh(?:ann[aá])?|یوه(?:َنّ?ا|نّ?ا)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:K[aá](?:sed[aá]ni\s*K[aá]r|r)|کا(?:سِ?دانی\s*کار|ر)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Pulosay\s*k[aá]gad\s*pa\s*Rumi[aá]n|پول(?:ُس[ئي]ے\s*کاگد\s*په\s*رومیان|س[ئي]ے\s*کاگد\s*په\s*رومیان)|رومیان|Rum))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Pa\s*Gal[aá]ti[aá]n\s*Pulosay\s*k[aá]gad|په\s*گ(?:َلاتیان\s*پول(?:ُس[ئي]ے\s*کاگد|س[ئي]ے\s*کاگد)|لاتیان\s*پول(?:ُس[ئي]ے\s*کاگد|س[ئي]ے\s*کاگد))|Gal[aá]ti[aá]n|گَ?لاتیان))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:P(?:a\s*Pilipi[aá]n\s*Pulosay\s*k[aá]gad|ilipi[aá]n)|پ(?:ه\s*پیلیپیان\s*پول(?:ُس[ئي]ے\s*کاگد|س[ئي]ے\s*کاگد)|یلیپیان)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pa(?:\.\s*(?:Tes[aá]luniki[aá]n\s*Pulosay\s*domi\s*k[aá]gad|ت(?:ِسالونیکیان\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد)|سالونیکیان\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد)))|\s*(?:Tes[aá]luniki[aá]n\s*Pulosay\s*domi\s*k[aá]gad|ت(?:ِسالونیکیان\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد)|سالونیکیان\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد))))|په(?:\.\s*(?:Tes[aá]luniki[aá]n\s*Pulosay\s*domi\s*k[aá]gad|ت(?:ِسالونیکیان\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد)|سالونیکیان\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد)))|\s*(?:Tes[aá]luniki[aá]n\s*Pulosay\s*domi\s*k[aá]gad|ت(?:ِسالونیکیان\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد)|سالونیکیان\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2\s*(?:Tes[aá]luniki[aá]n|تِ?سالونیکیان))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Pa|1)(?:\.\s*(?:Tes(?:[aá]luniki[aá]n\s*Pulosay\s*awali\s*k[aá]gad|[aá]luniki[aá]n)|ت(?:ِسالونیکیان(?:\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))?|سالونیکیان(?:\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))?))|\s*(?:Tes(?:[aá]luniki[aá]n\s*Pulosay\s*awali\s*k[aá]gad|[aá]luniki[aá]n)|ت(?:ِسالونیکیان(?:\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))?|سالونیکیان(?:\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))?)))|په(?:\.\s*(?:Tes(?:[aá]luniki[aá]n\s*Pulosay\s*awali\s*k[aá]gad|[aá]luniki[aá]n)|ت(?:ِسالونیکیان(?:\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))?|سالونیکیان(?:\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))?))|\s*(?:Tes(?:[aá]luniki[aá]n\s*Pulosay\s*awali\s*k[aá]gad|[aá]luniki[aá]n)|ت(?:ِسالونیکیان(?:\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))?|سالونیکیان(?:\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Pa|1)(?:\.\s*(?:Timut(?:[aá]us[aá]\s*Pulosay\s*awali\s*k[aá]gad|[aá]us)|تیموتاووسا\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))|\s*(?:Timut(?:[aá]us[aá]\s*Pulosay\s*awali\s*k[aá]gad|[aá]us)|تیموتاووسا\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد)))|په(?:\.\s*(?:Timut(?:[aá]us[aá]\s*Pulosay\s*awali\s*k[aá]gad|[aá]us)|تیموتاووسا\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد))|\s*(?:Timut(?:[aá]us[aá]\s*Pulosay\s*awali\s*k[aá]gad|[aá]us)|تیموتاووسا\s*پول(?:ُس[ئي]ے\s*ا[ئي]ولی\s*کاگد|س[ئي]ے\s*ا[ئي]ولی\s*کاگد)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1تیموتاووس)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pa(?:\.\s*(?:Timut[aá]us[aá]\s*Pulosay\s*domi\s*k[aá]gad|تیموتاووسا\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد))|\s*(?:Timut[aá]us[aá]\s*Pulosay\s*domi\s*k[aá]gad|تیموتاووسا\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد)))|په(?:\.\s*(?:Timut[aá]us[aá]\s*Pulosay\s*domi\s*k[aá]gad|تیموتاووسا\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد))|\s*(?:Timut[aá]us[aá]\s*Pulosay\s*domi\s*k[aá]gad|تیموتاووسا\s*پول(?:ُس[ئي]ے\s*دومی\s*کاگد|س[ئي]ے\s*دومی\s*کاگد)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:تیموتاووس|Timut[aá]us))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Pa\s*Titus[aá]\s*Pulosay\s*k[aá]gad|په\s*تیتوسا\s*پول(?:ُس[ئي]ے\s*کاگد|س[ئي]ے\s*کاگد)|Titus|تیتوس))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:P(?:a\s*Pilimun[aá]\s*Pulosay\s*k[aá]gad|ilimun)|پ(?:ه\s*پیلیمونا\s*پول(?:ُس[ئي]ے\s*کاگد|س[ئي]ے\s*کاگد)|یلیمون)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:[AÁ]kub|[آا]کوب))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:پ(?:ِت(?:ْر(?:ُس(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1)|س(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1))|ر(?:ُس(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1)|س(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1)))|ت(?:ْر(?:ُس(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1)|س(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1))|ر(?:ُس(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1)|س(?:[ئي]ے\s*ا[ئي]ولی\s*کاگد|1))))|Pet(?:rosay\s*Awal\s*K[aá]gad|1)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Pet(?:rosay\s*Domi\s*K[aá]gad|2)|پ(?:ِت(?:ْر(?:ُس(?:[ئي]ے\s*دومی\s*کاگد|2)|س(?:[ئي]ے\s*دومی\s*کاگد|2))|ر(?:ُس(?:[ئي]ے\s*دومی\s*کاگد|2)|س(?:[ئي]ے\s*دومی\s*کاگد|2)))|ت(?:ْر(?:ُس(?:[ئي]ے\s*دومی\s*کاگد|2)|س(?:[ئي]ے\s*دومی\s*کاگد|2))|ر(?:ُس(?:[ئي]ے\s*دومی\s*کاگد|2)|س(?:[ئي]ے\s*دومی\s*کاگد|2))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Yah(?:ud[aá]ay\s*K[aá]gad)?|ی(?:َهودا(?:[ئي]ے\s*کاگد)?|هودا(?:[ئي]ے\s*کاگد)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
