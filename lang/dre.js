  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(མར་ཀུ?།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ལ(?:ུ་ཀཱ?།|་ཀཱ?།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཡ(?:ོ་ཧ་ནན་དང་པོ?།|་ཧ་ནན་དང་པོ?།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཡ(?:ོ་ཧ་ནན་གཉ(?:ིས་པ​?།|ས་པ​?།)|་ཧ་ནན་གཉ(?:ིས་པ​?།|ས་པ​?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཡ(?:ོ་ཧ་ནན་(?:​གསུ?མ་པ།|གསུ?མ་པ།)|་ཧ་ནན་(?:​གསུ?མ་པ།|གསུ?མ་པ།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(མཛད་པ།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཀ(?:ོ་ར(?:ིན་ཐ(?:ུ་པ་དང་པོ?།|་པ་དང་པོ?།)|ན་ཐ(?:ུ་པ་དང་པོ?།|་པ་དང་པོ?།))|་ར(?:ིན་ཐ(?:ུ་པ་དང་པོ?།|་པ་དང་པོ?།)|ན་ཐ(?:ུ་པ་དང་པོ?།|་པ་དང་པོ?།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཀ(?:ོ་ར(?:ིན་ཐ(?:ུ་པ་གཉི?ས་པ།|་པ་གཉི?ས་པ།)|ན་ཐ(?:ུ་པ་གཉི?ས་པ།|་པ་གཉི?ས་པ།))|་ར(?:ིན་ཐ(?:ུ་པ་གཉི?ས་པ།|་པ་གཉི?ས་པ།)|ན་ཐ(?:ུ་པ་གཉི?ས་པ།|་པ་གཉི?ས་པ།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཨ(?:ེ་ཕ(?:ེ་སི?་པ།|་སི?་པ།)|་ཕ(?:ེ་སི?་པ།|་སི?་པ།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཕ(?:ི་ལ(?:ིབ་པི?་པ།|བ་པི?་པ།)|་ལ(?:ིབ་པི?་པ།|བ་པི?་པ།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཐ(?:ེ་ས་ལ(?:ོ་ན(?:ི་ཀ(?:ེ་​དང་པོ?།|་​དང་པོ?།)|་ཀ(?:ེ་​དང་པོ?།|་​དང་པོ?།))|་ན(?:ི་ཀ(?:ེ་​དང་པོ?།|་​དང་པོ?།)|་ཀ(?:ེ་​དང་པོ?།|་​དང་པོ?།)))|་ས་ལ(?:ོ་ན(?:ི་ཀ(?:ེ་​དང་པོ?།|་​དང་པོ?།)|་ཀ(?:ེ་​དང་པོ?།|་​དང་པོ?།))|་ན(?:ི་ཀ(?:ེ་​དང་པོ?།|་​དང་པོ?།)|་ཀ(?:ེ་​དང་པོ?།|་​དང་པོ?།)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཐ(?:ེ་ས་ལ(?:ོ་ན(?:ི་ཀ(?:ེ་​གཉི?ས་པ།|་​གཉི?ས་པ།)|་ཀ(?:ེ་​གཉི?ས་པ།|་​གཉི?ས་པ།))|་ན(?:ི་ཀ(?:ེ་​གཉི?ས་པ།|་​གཉི?ས་པ།)|་ཀ(?:ེ་​གཉི?ས་པ།|་​གཉི?ས་པ།)))|་ས་ལ(?:ོ་ན(?:ི་ཀ(?:ེ་​གཉི?ས་པ།|་​གཉི?ས་པ།)|་ཀ(?:ེ་​གཉི?ས་པ།|་​གཉི?ས་པ།))|་ན(?:ི་ཀ(?:ེ་​གཉི?ས་པ།|་​གཉི?ས་པ།)|་ཀ(?:ེ་​གཉི?ས་པ།|་​གཉི?ས་པ།)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཐ(?:ི་མ(?:ོ་ཐ(?:ེ་དང་པོ?།|་དང་པོ?།)|་ཐ(?:ེ་དང་པོ?།|་དང་པོ?།))|་མ(?:ོ་ཐ(?:ེ་དང་པོ?།|་དང་པོ?།)|་ཐ(?:ེ་དང་པོ?།|་དང་པོ?།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ཐ(?:ི་མ(?:ོ་ཐ(?:ེ་གཉི?ས་པ།|་གཉི?ས་པ།)|་ཐ(?:ེ་གཉི?ས་པ།|་གཉི?ས་པ།))|་མ(?:ོ་ཐ(?:ེ་གཉི?ས་པ།|་གཉི?ས་པ།)|་ཐ(?:ེ་གཉི?ས་པ།|་གཉི?ས་པ།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཐ(?:ེ་ཏོ?།|་ཏོ?།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཨ(?:ིབ་རི?་པ།|བ་རི?་པ།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(པ(?:ེ་ཏ(?:ྲ(?:ོ་དང་པོ?།|་དང་པོ?།)|ོ་དང་པོ?།|་དང་པོ?།)|་ཏ(?:ྲ(?:ོ་དང་པོ?།|་དང་པོ?།)|ོ་དང་པོ?།|་དང་པོ?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(པ(?:ེ་ཏ(?:ྲ(?:ོ་གཉི?ས་པ།|་གཉི?ས་པ།)|ོ་གཉི?ས་པ།|་གཉི?ས་པ།)|་ཏ(?:ྲ(?:ོ་གཉི?ས་པ།|་གཉི?ས་པ།)|ོ་གཉི?ས་པ།|་གཉི?ས་པ།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
