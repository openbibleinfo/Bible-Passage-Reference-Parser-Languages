var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["zas"];
    this.translations = [/ZAS\b/gi];
    this.first = /(?:1\.?\s*|Guiꞌch\.?\s*)/;
    this.second = /(?:2\.?\s*|Guiꞌch\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ni\s*bal[uü][uü]\s*Jesucrist\s*loj\s*San\s*Juan|Ap))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:San\s*Matew|Mt))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:San\s*Marcw|Mc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:San\s*Luj|L)c)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch\s*bayon\s*bacaa\s*San\s*Jua|3\s*J)n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:yaloj\s*bacaa\s*San\s*Jua|J)n|\s*(?:yaloj\s*bacaa\s*San\s*Jua|J)n)|1(?:\.\s*(?:yaloj\s*bacaa\s*San\s*Jua|J)n|\s*(?:yaloj\s*bacaa\s*San\s*Jua|J)n)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:barojp\s*bacaa\s*San\s*Jua|J)n|\s*(?:barojp\s*bacaa\s*San\s*Jua|J)n)|2(?:\.\s*(?:barojp\s*bacaa\s*San\s*Jua|J)n|\s*(?:barojp\s*bacaa\s*San\s*Jua|J)n)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ni\s*been\s*ree\s*ap[oó]stoles|Hch))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*par\s*ree\s*b[eé]n\s*Rom|Ro))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:yaloj\s*par\s*ree\s*b[eé]n\s*Corinto|Co)|\s*(?:yaloj\s*par\s*ree\s*b[eé]n\s*Corinto|Co))|1(?:\.\s*(?:yaloj\s*par\s*ree\s*b[eé]n\s*Corinto|Co)|\s*(?:yaloj\s*par\s*ree\s*b[eé]n\s*Corinto|Co))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:barojp\s*par\s*ree\s*b[eé]n\s*Corinto|Co)|\s*(?:barojp\s*par\s*ree\s*b[eé]n\s*Corinto|Co))|2(?:\.\s*(?:barojp\s*par\s*ree\s*b[eé]n\s*Corinto|Co)|\s*(?:barojp\s*par\s*ree\s*b[eé]n\s*Corinto|Co))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*par\s*ree\s*b[eé]n\s*Colosas|Col))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(G(?:uiꞌch\s*par\s*ree\s*b[eé]n\s*Galacia|l))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*par\s*ree\s*b[eé]n\s*[EÉ]feso|Ef))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*par\s*ree\s*b[eé]n\s*Filipos|Flp))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:yaloj\s*par\s*ree\s*b[eé]n\s*Tesal[oó]nica|Ts)|\s*(?:yaloj\s*par\s*ree\s*b[eé]n\s*Tesal[oó]nica|Ts))|1(?:\.\s*(?:yaloj\s*par\s*ree\s*b[eé]n\s*Tesal[oó]nica|Ts)|\s*(?:yaloj\s*par\s*ree\s*b[eé]n\s*Tesal[oó]nica|Ts))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:barojp\s*par\s*ree\s*b[eé]n\s*Tesal[oó]nica|Ts)|\s*(?:barojp\s*par\s*ree\s*b[eé]n\s*Tesal[oó]nica|Ts))|2(?:\.\s*(?:barojp\s*par\s*ree\s*b[eé]n\s*Tesal[oó]nica|Ts)|\s*(?:barojp\s*par\s*ree\s*b[eé]n\s*Tesal[oó]nica|Ts))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:yaloj\s*par\s*Timoteo|Ti)|\s*(?:yaloj\s*par\s*Timoteo|Ti))|1(?:\.\s*(?:yaloj\s*par\s*Timoteo|Ti)|\s*(?:yaloj\s*par\s*Timoteo|Ti))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:barojp\s*par\s*Timoteo|Ti)|\s*(?:barojp\s*par\s*Timoteo|Ti))|2(?:\.\s*(?:barojp\s*par\s*Timoteo|Ti)|\s*(?:barojp\s*par\s*Timoteo|Ti))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*par\s*Tito|Tit))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*par\s*Filem[oó]n|Flm))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*par\s*ree\s*b[eé]n\s*Hebreos|Heb))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*bacaa\s*Santiaaw|Stg))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:yaloj\s*bacaa\s*San\s*Pedr|Pe)|\s*(?:yaloj\s*bacaa\s*San\s*Pedr|Pe))|1(?:\.\s*(?:yaloj\s*bacaa\s*San\s*Pedr|Pe)|\s*(?:yaloj\s*bacaa\s*San\s*Pedr|Pe))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Guiꞌch(?:\.\s*(?:barojp\s*bacaa\s*San\s*Pedr|Pe)|\s*(?:barojp\s*bacaa\s*San\s*Pedr|Pe))|2(?:\.\s*(?:barojp\s*bacaa\s*San\s*Pedr|Pe)|\s*(?:barojp\s*bacaa\s*San\s*Pedr|Pe))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Guiꞌch\s*bacaa\s*San\s*Judas|Jud))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
