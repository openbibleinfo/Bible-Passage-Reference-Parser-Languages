  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:ारक(?:ास?|स)?|रक(?:ास?|स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(म(?:ार(?:कु?स)?|र(?:कु?स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ल(?:ुक[ा्]?|क[ा्]?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)|\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)|\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(३(?:\.\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)|\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(म(?:ुल(?:िच(?:ेल(?:ा?\s*ट(?:ोॽवा?|ॽवा?)|ा)?|ल(?:ा?\s*ट(?:ोॽवा?|ॽवा?)|ा)?)|च(?:ेल(?:ा?\s*ट(?:ोॽवा?|ॽवा?)|ा)?|ल(?:ा?\s*ट(?:ोॽवा?|ॽवा?)|ा)?))|ल(?:िच(?:ेल(?:ा?\s*ट(?:ोॽवा?|ॽवा?)|ा)?|ल(?:ा?\s*ट(?:ोॽवा?|ॽवा?)|ा)?)|च(?:ेल(?:ा?\s*ट(?:ोॽवा?|ॽवा?)|ा)?|ल(?:ा?\s*ट(?:ोॽवा?|ॽवा?)|ा)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ाल(?:ास(?:्‌सि?|‌सि?)|स(?:्‌सि?|‌सि?))?|ल(?:ास(?:्‌सि?|‌सि?)|स(?:्‌सि?|‌सि?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ग(?:ाल(?:ाति?|ति?)?|ल(?:ाति?|ति?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*थ(?:ेस(?:ा?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ा)?|स(?:ा?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ा)?)|\s*थ(?:ेस(?:ा?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ा)?|स(?:ा?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ा)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*थ(?:ेस(?:ा?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ा)?|स(?:ा?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ा)?)|\s*थ(?:ेस(?:ा?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ा)?|स(?:ा?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ा)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*त(?:ि?म(?:ोथि?|थि?)|ि)?|\s*त(?:ि?म(?:ोथि?|थि?)|ि)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*त(?:ि?म(?:ोथि?|थि?)|ि)?|\s*त(?:ि?म(?:ोथि?|थि?)|ि)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ि?ता?स|ि)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*प(?:ाटर(?:ुस?|स)?|टर(?:ुस?|स)?)|\s*प(?:ाटर(?:ुस?|स)?|टर(?:ुस?|स)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*प(?:ाटर(?:ुस?|स)?|टर(?:ुस?|स)?)|\s*प(?:ाटर(?:ुस?|स)?|टर(?:ुस?|स)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
