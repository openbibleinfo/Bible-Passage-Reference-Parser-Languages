  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मर(?:्(?:कू?स|‌क)|कू?स|‌क))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*ठ(?:ेस(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?|स(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?)|\s*ठ(?:ेस(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?|स(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*ठ(?:ेस(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?|स(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?)|\s*ठ(?:ेस(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?|स(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*ट(?:ी?म(?:ोठी?|ठी?)|ी)?|\s*ट(?:ी?म(?:ोठी?|ठी?)|ी)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*ट(?:ी?म(?:ोठी?|ठी?)|ी)?|\s*ट(?:ी?म(?:ोठी?|ठी?)|ी)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(टी?टस)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*पट(?:्?‍रु?स|्)?|\s*पट(?:्?‍रु?स|्)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*पट(?:्?‍रु?स|्)?|\s*पट(?:्?‍रु?स|्)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यह(?:ु(?:डा?)?|डा?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
