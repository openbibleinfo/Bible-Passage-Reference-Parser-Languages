var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["ltg"];
    this.translations = [/LGT\b/gi];
    this.first = /(?:1\.?\s*|I\.?\s*|Sv\.?\s*)/;
    this.second = /(?:2\.?\s*|II\.?\s*|Sv\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ap(?:okalipsis|k))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelijs\s*p[eē]c\s*Mateusa|Mt))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelijs\s*p[eē]c\s*Marka|Mk))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelijs\s*p[eē]c\s*Lukasa|Lk))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Sv\.\s*J[oō][nņ]a\s*III|3\s*J))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Sv\.\s*J(?:[oō][nņ]a\s*I)?|[1I]\.\s*J(?:[oō][nņ]a\s*I)?|[1I]\s*J(?:[oō][nņ]a\s*I)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:II|2)\.\s*J(?:[oō][nņ]a\s*II)?|Sv\.\s*J(?:[oō][nņ]a\s*II)?|(?:II|2)\s*J(?:[oō][nņ]a\s*II)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Evangelijs\s*p[eē]c\s*J[oō][nņ]a|J))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ap(?:ostolu\s*Dorbi|\.\s*d))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:v[eē]stule\s*rom[iī][sš]im|Rom))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Sv\.\s*(?:v[eē]stule\s*korint[iī][sš]im|Kor)|[1I]\.\s*(?:v[eē]stule\s*korint[iī][sš]im|Kor)|[1I]\s*(?:v[eē]stule\s*korint[iī][sš]im|Kor)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:II|2)\.\s*(?:v[eē]stule\s*korint[iī][sš]im|Kor)|Sv\.\s*(?:v[eē]stule\s*korint[iī][sš]im|Kor)|(?:II|2)\s*(?:v[eē]stule\s*korint[iī][sš]im|Kor)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:v[eē]stule\s*kolos[iī][sš]im|Kol))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:v[eē]stule\s*galat[iī][sš]im|Gal))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:v[eē]stule\s*efez[iī][sš]im|Ef))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:v[eē]stule\s*filip[iī][sš]im|Filip))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Sv\.\s*(?:v[eē]stule\s*tessalonik[iī][sš]im\.|Tes)|[1I]\.\s*(?:v[eē]stule\s*tessalonik[iī][sš]im\.|Tes)|[1I]\s*(?:v[eē]stule\s*tessalonik[iī][sš]im\.|Tes)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:II|2)\.\s*(?:v[eē]stule\s*tessalonik[iī][sš]im\.|Tes)|Sv\.\s*(?:v[eē]stule\s*tessalonik[iī][sš]im\.|Tes)|(?:II|2)\s*(?:v[eē]stule\s*tessalonik[iī][sš]im\.|Tes)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Sv\.\s*(?:v[eē]stule\s*Timotejam|Tim)|[1I]\.\s*(?:v[eē]stule\s*Timotejam|Tim)|[1I]\s*(?:v[eē]stule\s*Timotejam|Tim)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:II|2)\.\s*(?:v[eē]stule\s*Timotejam|Tim)|Sv\.\s*(?:v[eē]stule\s*Timotejam|Tim)|(?:II|2)\s*(?:v[eē]stule\s*Timotejam|Tim)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:v[eē]stule\s*Titam|Tit))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:v[eē]stule\s*Filemonam|Filem))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:v[eē]stule\s*ebrejim|Ebr))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Sv\.\s*J[aā]kuba|Jk))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Sv\.\s*P(?:it(?:era\s*I)?|ītera\s*I)|[1I]\.\s*P(?:it(?:era\s*I)?|ītera\s*I)|[1I]\s*P(?:it(?:era\s*I)?|ītera\s*I)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:II|2)\.\s*P(?:it(?:era\s*II)?|ītera\s*II)|Sv\.\s*P(?:it(?:era\s*II)?|ītera\s*II)|(?:II|2)\s*P(?:it(?:era\s*II)?|ītera\s*II)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Sv\.\s*Judas|Jud))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
