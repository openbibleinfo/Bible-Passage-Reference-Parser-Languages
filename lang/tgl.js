var bcv_regexps = class {
  constructor() {
    ...
    this.first = /(?:Unang\.?\s*|Una\.?\s*|1\.?\s*|I\.?\s*)/;
    this.second = /(?:Ikalawang\.?\s*|2\.?\s*|II\.?\s*)/;
    this.third = /(?:Ikatlong\.?\s*|3\.?\s*|III\.?\s*)/;
    this.range_and = /(?:[&\u2013\u2014-]|at\.?\s*|(?:\x2d\.?\s*|–\.?\s*|—\.?\s*))/;
    this.range_only = /(?:[\u2013\u2014-]|(?:\x2d\.?\s*|–\.?\s*|—\.?\s*))/;
    this.match_end_split = /\d\W*(?:(?:pamagat|titik))|\d\W*(?:k)(?:[\s*]*\.)?|\d[\s*]*(?:(?:[a-e](?!\w)))|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—]|(?:titik\.?\s*|pamagat\.?\s*)(?![a-z])|(?:(?:(?:kap(?:itulo)?|pang(?:kat)?)\.?\s*)|(?:tal(?:atang)?\.?\s*)|(?:k\.?\s*)|(?:at\.?\s*)|(?:[\-–—]\.?\s*))|(?:[a-e]\.?\s*(?!\w))(?!\w)|$)+)/giu;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["1Esd"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng(?:\.\s*E(?:sdras|zra)|\s*E(?:sdras|zra))|\.\s*E(?:sdras|zra)|\s*E(?:sdras|zra))|[1I](?:\.\s*E(?:sdras|zra)|\s*E(?:sdras|zra))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Esd"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang(?:\.\s*E(?:sdras|zra)|\s*E(?:sdras|zra))|I(?:\.\s*E(?:sdras|zra)|\s*E(?:sdras|zra)))|2(?:\.\s*E(?:sdras|zra)|\s*E(?:sdras|zra))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ezra"],
            testament: "o",
          ...
          },
          {
            osis: ["1Sam"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng\.?\s*Samuel|\.?\s*Samuel)|[1I]\.?\s*Samuel))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Sam"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang\.?\s*Samuel|I\.?\s*Samuel)|2\.?\s*Samuel))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Sam"],
            testament: "o",
          ...
          },
          {
            osis: ["1Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng\.?\s*Hari|\.?\s*Hari)|[1I]\.?\s*Hari))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang\.?\s*Hari|I\.?\s*Hari)|2\.?\s*Hari))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng\.?\s*Mga\s*Hari|\.?\s*Mga\s*Hari)|[1I]\.?\s*Mga\s*Hari))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:katlong\.?\s*Mga\s*Hari|II\.?\s*Mga\s*Hari)|3\.?\s*Mga\s*Hari))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kaapat\.?\s*Mga\s*Hari|V\.?\s*Mga\s*Hari)|4\.?\s*Mga\s*Hari))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang\.?\s*Mga\s*Hari|I\.?\s*Mga\s*Hari)|2\.?\s*Mga\s*Hari))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\s*(?:Mga\s*Hari|Ha)|Kgs))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\s*(?:Mga\s*Hari|Ha)|Kgs))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Chr"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng(?:\.\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica)|\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica))|\.\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica)|\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica))|[1I](?:\.\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica)|\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Chr"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang(?:\.\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica)|\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica))|I(?:\.\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica)|\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica)))|2(?:\.\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica)|\s*(?:Paralipomeno|Mga\s*(?:Cronic|Kronik)a|Chronicle|Kronik(?:el|a)|Cronica))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Chr"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\s*(?:Paralipomeno|Cron?)|Chr))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Chr"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\s*(?:Paralipomeno|Cron?)|Chr))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Neh"],
            testament: "o",
          ...
          },
          {
            osis: ["SgThree"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Awit\s*ng\s*(?:Tatlong\s*Banal\s*na|3)\s*Kabataan|Aw(?:it\s*ng\s*Tatlong\s*(?:Kabataang\s*Banal|Binata)|\s*ng\s*3\s*Kab)|Awit\s*ng\s*Tatlong\s*Kabataan|Tatlong\s*Kabataan|SgThree))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Song"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:A(?:ng\s*Awit\s*n(?:g\s*mga\s*Awit|i\s*S[ao]lom[oó]n)|wit\s*n(?:g\s*mga\s*Awit|i\s*S[ao]lom[oó]n)|\.?\s*ng\s*A\.|w\s*ni\s*S)|Kantik(?:ul)?o|A\.?\s*ng\s*A|Song))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ps"],
            testament: "oa",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng\.?\s*Juan|\.?\s*Juan)|[1I]\.?\s*Juan))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang\.?\s*Juan|I\.?\s*Juan)|2\.?\s*Juan))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:katlong\.?\s*Juan|II\.?\s*Juan)|3\.?\s*Juan))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Juan)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Mabuting\s*Balita\s*ayon\s*kay\s*(?:San\s*)?Juan|Ebanghelyo\s*ayon\s*kay\s*(?:San\s*)?Juan|(?:Ebanghelyo\s*ni\s*San\s*Jua|J(?:oh)?)n))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng(?:\.\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o)|\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o))|\.\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o)|\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o))|[1I](?:\.\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o)|\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang(?:\.\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o)|\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o))|I(?:\.\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o)|\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o)))|2(?:\.\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o)|\s*(?:Mga\s*Taga-?\s*Corinto|(?:[CK]orinti|[CK]orint)o))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ika-?\s*2\s*Sulat\s*sa\s*mga\s*Corinti?o|SECOND\s*Sulat\s*sa\s*mga\s*Corinti?o|2\s*Corinto|2\s*?Cor))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng(?:\.\s*Sulat\s*sa\s*mga\s*Corinti?o|\s*Sulat\s*sa\s*mga\s*Corinti?o)|\.\s*Sulat\s*sa\s*mga\s*Corinti?o|\s*Sulat\s*sa\s*mga\s*Corinti?o)|[1I](?:\.\s*Sulat\s*sa\s*mga\s*Corinti?o|\s*Sulat\s*sa\s*mga\s*Corinti?o)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ika(?:-\s*1\s*Sulat\s*sa\s*mga\s*Corinti?o|\s*1\s*Sulat\s*sa\s*mga\s*Corinti?o)|1\s*Corinto|1\s*?Cor))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng(?:\.\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka))|\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka)))|\.\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka))|\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka)))|[1I](?:\.\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka))|\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang(?:\.\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka))|\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka)))|I(?:\.\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka))|\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka))))|2(?:\.\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka))|\s*(?:Mga\s*T(?:aga(?:-\s*Tesaloni[ck]a|\s*Tesaloni[ck]a)|esaloni[cs]ense)|Tesaloni(?:(?:c(?:ense|a)|sense)|ka)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\s*T(?:es(?:alonica)?|hes)|Thess))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\s*T(?:es(?:alonica)?|hes)|Thess))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng(?:\.\s*(?:Kay\s*)?Timoteo|\s*(?:Kay\s*)?Timoteo)|\.\s*(?:Kay\s*)?Timoteo|\s*(?:Kay\s*)?Timoteo)|[1I](?:\.\s*(?:Kay\s*)?Timoteo|\s*(?:Kay\s*)?Timoteo)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang(?:\.\s*(?:Kay\s*)?Timoteo|\s*(?:Kay\s*)?Timoteo)|I(?:\.\s*(?:Kay\s*)?Timoteo|\s*(?:Kay\s*)?Timoteo))|2(?:\.\s*(?:Kay\s*)?Timoteo|\s*(?:Kay\s*)?Timoteo)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\s*Tim(?:oteo)?|Tim))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\s*Tim(?:oteo)?|Tim))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng\.?\s*Pedro|\.?\s*Pedro)|[1I]\.?\s*Pedro))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang\.?\s*Pedro|I\.?\s*Pedro)|2\.?\s*Pedro))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\s*Ped(?:ro)?|Pet))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\s*Ped(?:ro)?|Pet))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
          ...
          },
          {
            osis: ["1Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Una(?:ng(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))|\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))|[1I](?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kalawang(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))|I(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?)))|2(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:katlong(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))|II(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?)))|3(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["4Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:I(?:kaapat(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))|V(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?)))|4(?:\.\s*M(?:ga\s*Macabeo|acabeos?)|\s*M(?:ga\s*Macabeo|acabeos?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\s*M(?:ga\s*Macabeo|cb)|Macc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\s*M(?:ga\s*Macabeo|cb)|Macc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["4Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(4(?:\s*M(?:ga\s*Macabeo|cb)|Macc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\s*M(?:ga\s*Macabeo|cb)|Macc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ezek", "Ezra"],
            testament: "o",
...
var bcv_grammar_options_default = {
  ab: /^(?:(?:a|b|c|d|e))(?!\p{L})/iu,
  and: /^(?:(?:(?:at\.?\s*)|&))/i,
  c_explicit: /^[\s*]*(?:(?:(?:kap(?:itulo)?|pang(?:kat)?)\.?\s*))[\s*]*/i,
  c_sep_eu: /^\x1f\x1f\x1f/i,
  c_sep_us: /^\x1f\x1f\x1f/i,
  cv_sep_weak: /^(?:[\s*]*["'][\s*]*|[\s*])+/i,
  cv_sep_eu: /^[\s*]*,+[\s*]*/i,
  cv_sep_us: /^[\s*]*(?::+|\.(?!\s*\.\s*\.))[\s*]*/i,
  ff: /^[\s*]*(?:(?:k\.?\s*))(?![\p{L}\p{N}])(?:\.(?!\s*\.))?/iu,
  in_book_of: /^[\s*]*(?:from|of|in)[\s*]*(?:the[\s*]*book[\s*]*of[\s*]*)?/i,
  next: /^(?:\x1f\x1f\x1f)/i,
  ordinal: /^(?:th|st|nd|rd)/i,
  range: /^[\s*]*(?:[\-–—]|(?:[\-–—]\.?\s*))+[\s*]*/i,
  sequence_eu: /^(?:[;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|(?:at\.?\s*))+/i,
  sequence_us: /^(?:[,;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|(?:at\.?\s*))+/i,
  space: /^[\s*]+/,
  title: /^[\s*]*(?:(?:(?:pamagat|titik)\.?\s*))(?!\p{L})[\s*]*/iu,
  v_explicit: /^[\s*]*(?:(?:tal(?:atang)?\.?\s*))[\s*]*(?!\p{L})/iu
};
