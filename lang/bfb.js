  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ल(?:ुक[.ा]?|क[.ा]?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3\s*य(?:ोह(?:ान|[.न])|ह(?:ान|[.न])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*य(?:ोह(?:ान|[.न])|ह(?:ान|[.न]))|\s*य(?:ोह(?:ान|[.न])|ह(?:ान|[.न]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*य(?:ोह(?:ान?|न)?|ह(?:ान?|न)?)|\s*य(?:ोह(?:ान?|न)?|ह(?:ान?|न)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र(?:ेष(?:ि[.त]|[.त])|ष(?:ि[.त]|[.त]))|र(?:ेष(?:ि[.त]|[.त])|ष(?:ि[.त]|[.त]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(र(?:ोम[.ी]?|म[.ी]?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुर(?:ी?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ी?\.)|र(?:ी?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ी?\.))|\s*क(?:ुर(?:ी?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ी?\.)|र(?:ी?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ी?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुर(?:ी?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ी?\.)|र(?:ी?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ी?\.))|\s*क(?:ुर(?:ी?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ी?\.)|र(?:ी?न(?:्थ(?:ियो?|यो?)|थ(?:ियो?|यो?))|ी?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ु?स(?:्सि?|सि?)|ु?\.)|ल(?:ु?स(?:्सि?|सि?)|ु?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इफ(?:ि?स(?:ीयो?|यो?)|ि?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ि?प(?:्पि?|पि?)|ि?\.)|ल(?:ि?प(?:्पि?|पि?)|ि?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:िस(?:्स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?)))|\.)|स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?)))|\.))|स(?:्स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?)))|\.)|स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?)))|\.)))|\s*थ(?:िस(?:्स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?)))|\.)|स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?)))|\.))|स(?:्स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?)))|\.)|स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?)))|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:िस(?:्स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))))?|स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))))?)|स(?:्स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))))?|स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))))?))|\s*थ(?:िस(?:्स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))))?|स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))))?)|स(?:्स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))))?|स(?:ल(?:ुन(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))|न(?:ीक(?:ियो?|यो?)|क(?:ियो?|यो?))))?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:ीम(?:थी?)?|म(?:थी?)?)|\s*त(?:ीम(?:थी?)?|म(?:थी?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:ीम(?:थी?|\.)|म(?:थी?|\.))|\s*त(?:ीम(?:थी?|\.)|म(?:थी?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
