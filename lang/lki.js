var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["lki"];
    this.translations = [/LBT\b/gi];
    this.first = /اول\.?\s*/;
    this.second = /(?:دوئِم\.?\s*|دويم\.?\s*|دوئم\.?\s*|دويِم\.?\s*)/;
    this.third = /(?:سِئِم\.?\s*|سيم\.?\s*|سِئم\.?\s*|سِيِم\.?\s*|سِيم\.?\s*|سئِم\.?\s*|سئم\.?\s*|سيِم\.?\s*)/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(م(?:ِکاشفَ?ه|کاشفَ?ه))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(دو[ئي](?:ِم\.?\s*یوحنا|م\.?\s*یوحنا))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(س(?:ِ[ئي](?:ِم\.?\s*یوحنا|م\.?\s*یوحنا)|[ئي](?:ِم\.?\s*یوحنا|م\.?\s*یوحنا)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(کار(?:َل\s*رسولَ?ل|ل\s*رسولَ?ل))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(دو[ئي](?:ِم(?:\.\s*ق(?:ُرَ?نتیان|رَ?نتیان)|\s*ق(?:ُرَ?نتیان|رَ?نتیان))|م(?:\.\s*ق(?:ُرَ?نتیان|رَ?نتیان)|\s*ق(?:ُرَ?نتیان|رَ?نتیان))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(کول(?:ُسیَ?ل|سیَ?ل))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(غ(?:َلاطیَ?ل|لاطیَ?ل))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ا(?:َف(?:ِس(?:ُسیَ?ل|سیَ?ل)|س(?:ُسیَ?ل|سیَ?ل))|ف(?:ِس(?:ُسیَ?ل|سیَ?ل)|س(?:ُسیَ?ل|سیَ?ل))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(فیلیپیَ?ل)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(اول(?:\.\s*ت(?:ِسالونیکیَ?ل|سالونیکیَ?ل)|\s*ت(?:ِسالونیکیَ?ل|سالونیکیَ?ل)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(دو[ئي](?:ِم(?:\.\s*ت(?:ِسالونیکیَ?ل|سالونیکیَ?ل)|\s*ت(?:ِسالونیکیَ?ل|سالونیکیَ?ل))|م(?:\.\s*ت(?:ِسالونیکیَ?ل|سالونیکیَ?ل)|\s*ت(?:ِسالونیکیَ?ل|سالونیکیَ?ل))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(اول(?:\.\s*تیموتا[ئي]وس|\s*تیموتا[ئي]وس))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(دو[ئي](?:ِم(?:\.\s*تیموتا[ئي]وس|\s*تیموتا[ئي]وس)|م(?:\.\s*تیموتا[ئي]وس|\s*تیموتا[ئي]وس)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ع(?:ِبرانیَ?ل|برانیَ?ل))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(اول\.?\s*پطرس)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(دو[ئي](?:ِم\.?\s*پطرس|م\.?\s*پطرس))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
