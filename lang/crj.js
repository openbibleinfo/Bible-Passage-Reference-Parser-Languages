var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["crj"];
    this.translations = [/(?:CRJR|JBC)NT\b/gi];
    this.first = /(?:1\.?\s*|ᓃᔥᑕᒻ\.?\s*)/;
    this.second = /(?:2\.?\s*|ᓃᔓ\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ᒋᔅᒉᔨᐦᑖᑯᐦᑖᒉᐎᓐ|Rev(?:elation)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Mat(?:thew)?|ᒫᑎᔫ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ma?rk|ᒫᕐᒃ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Luke?|ᓘᒃ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:3\s*J(?:oh)?n|ᓂᔥᑐ\s*ᒞᓐ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔥᑕᒻ(?:\.\s*(?:J(?:oh)?n|ᒞᓐ)|\s*(?:J(?:oh)?n|ᒞᓐ))|1(?:\.\s*(?:J(?:oh)?n|ᒞᓐ)|\s*(?:J(?:oh)?n|ᒞᓐ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔓ(?:\.\s*(?:J(?:oh)?n|ᒞᓐ)|\s*(?:J(?:oh)?n|ᒞᓐ))|2(?:\.\s*(?:J(?:oh)?n|ᒞᓐ)|\s*(?:J(?:oh)?n|ᒞᓐ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Jo?hn|ᒞᓐ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ᐊᐸᔅᑕᓚᒡ|Acts?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Rom(?:ans)?|ᕎᒪᓐ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔥᑕᒻ(?:\.\s*(?:Cor(?:inthians)?|ᑯᕆᓐᑎᔭᓐ)|\s*(?:Cor(?:inthians)?|ᑯᕆᓐᑎᔭᓐ))|1(?:\.\s*(?:Cor(?:inthians)?|ᑯᕆᓐᑎᔭᓐ)|\s*(?:Cor(?:inthians)?|ᑯᕆᓐᑎᔭᓐ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔓ(?:\.\s*(?:Cor(?:inthians)?|ᑯᕆᓐᑎᔭᓐ)|\s*(?:Cor(?:inthians)?|ᑯᕆᓐᑎᔭᓐ))|2(?:\.\s*(?:Cor(?:inthians)?|ᑯᕆᓐᑎᔭᓐ)|\s*(?:Cor(?:inthians)?|ᑯᕆᓐᑎᔭᓐ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Col(?:ossians)?|ᑯᓨᓯᔭᓐ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Gal(?:atians)?|ᑲᓓᔑᔭᓐ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Eph(?:esians)?|ᐃᐲᓯᔭᓐ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:P(?:hilippians|lp)|ᐱᓕᐱᔭᓐ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔥᑕᒻ(?:\.\s*(?:Th(?:essalonians)?|ᑌᓴᓨᓂᔭᓐ)|\s*(?:Th(?:essalonians)?|ᑌᓴᓨᓂᔭᓐ))|1(?:\.\s*(?:Th(?:essalonians)?|ᑌᓴᓨᓂᔭᓐ)|\s*(?:Th(?:essalonians)?|ᑌᓴᓨᓂᔭᓐ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔓ(?:\.\s*(?:Th(?:essalonians)?|ᑌᓴᓨᓂᔭᓐ)|\s*(?:Th(?:essalonians)?|ᑌᓴᓨᓂᔭᓐ))|2(?:\.\s*(?:Th(?:essalonians)?|ᑌᓴᓨᓂᔭᓐ)|\s*(?:Th(?:essalonians)?|ᑌᓴᓨᓂᔭᓐ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔥᑕᒻ(?:\.\s*(?:Ti(?:mothy)?|ᑎᒧᑏ)|\s*(?:Ti(?:mothy)?|ᑎᒧᑏ))|1(?:\.\s*(?:Ti(?:mothy)?|ᑎᒧᑏ)|\s*(?:Ti(?:mothy)?|ᑎᒧᑏ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔓ(?:\.\s*(?:Ti(?:mothy)?|ᑎᒧᑏ)|\s*(?:Ti(?:mothy)?|ᑎᒧᑏ))|2(?:\.\s*(?:Ti(?:mothy)?|ᑎᒧᑏ)|\s*(?:Ti(?:mothy)?|ᑎᒧᑏ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Tit(?:us)?|ᑕᐃᑕᔅ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ph(?:ilemon|m)|ᐹᐃᓖᒪᓐ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Heb(?:rews)?|ᐦᐄᑉᕈᐗ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ja(?:me)?s|ᒉᒥᔅ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔥᑕᒻ(?:\.\s*(?:Pe(?:ter)?|ᐲᑕᕐ)|\s*(?:Pe(?:ter)?|ᐲᑕᕐ))|1(?:\.\s*(?:Pe(?:ter)?|ᐲᑕᕐ)|\s*(?:Pe(?:ter)?|ᐲᑕᕐ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:ᓃᔓ(?:\.\s*(?:Pe(?:ter)?|ᐲᑕᕐ)|\s*(?:Pe(?:ter)?|ᐲᑕᕐ))|2(?:\.\s*(?:Pe(?:ter)?|ᐲᑕᕐ)|\s*(?:Pe(?:ter)?|ᐲᑕᕐ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Jude?|ᒎᑦ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
