  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ય(?:ોહ(?:ા[.ન]|[.ન])|હ(?:ા[.ન]|[.ન]))|\s*ય(?:ોહ(?:ા[.ન]|[.ન])|હ(?:ા[.ન]|[.ન]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ય(?:ોહ(?:ા[.ન]|[.ન])|હ(?:ા[.ન]|[.ન]))|\s*ય(?:ોહ(?:ા[.ન]|[.ન])|હ(?:ા[.ન]|[.ન]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*ય(?:ોહ(?:ા[.ન]|[.ન])|હ(?:ા[.ન]|[.ન]))|\s*ય(?:ોહ(?:ા[.ન]|[.ન])|હ(?:ા[.ન]|[.ન]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(પ(?:્ર(?:ેષ(?:િ(?:તોનાં\s*ક્રત્યો|\.)|\.)|ષિ?\.)|ર(?:ષ(?:(?:તન\s*કરતય|\.)|િ\.)|ેષિ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ર(?:ોમ(?:ન(?:ોન(?:ે\s*પત્?ર|\s*પત્?ર)|ન(?:ે\s*પત્?ર|\s*પત્?ર))|િ?\.)|મ(?:ન(?:ોન(?:ે\s*પત્?ર|\s*પત્?ર)|ન(?:ે\s*પત્?ર|\s*પત્?ર))|િ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*કર(?:(?:િં?થ|ં?થ)(?:ીઓને?|ઓને?)|િં?\.|ં?\.)|\s*કર(?:(?:િં?થ|ં?થ)(?:ીઓને?|ઓને?)|િં?\.|ં?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*કર(?:(?:િં?થ|ં?થ)(?:ીઓને?|ઓને?)|િં?\.|ં?\.)|\s*કર(?:(?:િં?થ|ં?થ)(?:ીઓને?|ઓને?)|િં?\.|ં?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*થ(?:ેસ(?:્સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)|સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.))|સ(?:્સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)|સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)))|\s*થ(?:ેસ(?:્સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)|સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.))|સ(?:્સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)|સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*થ(?:ેસ(?:્સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)|સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.))|સ(?:્સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)|સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)))|\s*થ(?:ેસ(?:્સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)|સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.))|સ(?:્સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)|સ(?:લ(?:ોન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?))|ન(?:િક(?:ીઓને?|ઓને?)|ક(?:ીઓને?|ઓને?)))|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ત(?:િમ(?:ો(?:થી?|\.)|થી?|\.)|મ(?:ો(?:થી?|\.)|થી?|\.))|\s*ત(?:િમ(?:ો(?:થી?|\.)|થી?|\.)|મ(?:ો(?:થી?|\.)|થી?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ત(?:િમ(?:ો(?:થી?|\.)|થી?|\.)|મ(?:ો(?:થી?|\.)|થી?|\.))|\s*ત(?:િમ(?:ો(?:થી?|\.)|થી?|\.)|મ(?:ો(?:થી?|\.)|થી?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ત(?:િતસ(?:ન(?:ં\s*પત્?ર|\s*પત્?ર)|\.)|તસ(?:ન(?:ં\s*પત્?ર|\s*પત્?ર)|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ફ(?:િલ(?:ે?મ(?:ોન(?:ે\s*પત્?ર|\s*પત્?ર)|ન(?:ે\s*પત્?ર|\s*પત્?ર))|ે?\.)|લ(?:ે?મ(?:ોન(?:ે\s*પત્?ર|\s*પત્?ર)|ન(?:ે\s*પત્?ર|\s*પત્?ર))|ે?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
          ...
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ય(?:ાક(?:ૂ?બનો?|ૂ?\.)|ક(?:ૂ?બનો?|ૂ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
