var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["bdv"];
    this.translations = [/(?:NTBPL20|BDVNT)\b/gi];
    this.first = /(?:1\.?\s*|୧\.?\s*)/;
    this.second = /(?:2\.?\s*|୨\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:୍ରକ(?:ା?ଶ(?:ିତ(?:୍\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ))|ତ(?:୍\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)))|ା?ସ(?:ିତ୍?‌|ତ୍?‌)|ା?\.|ା)?|ରକ(?:ା?ଶ(?:ିତ(?:୍\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ))|ତ(?:୍\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)))|ା?ସ(?:ିତ୍?‌|ତ୍?‌)|ା?\.|ା)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ମ(?:ା(?:ତ(?:ି?ଉ|ି?)|ଥ(?:ି[.ଉ]|[.ଉ]))|ତ(?:ି?ଉ|ି?)|ଥ(?:ି[.ଉ]|[.ଉ])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ମ(?:ାର୍?କ|ର୍?କ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଲୁ?କ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:୩\s*(?:(?:ଜହନ୍?‌|ଯୋ?ହ\.)|ଜହ)|3\s*ଯ(?:ୋହନ୍?|ହନ୍?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1୧](?:\.\s*(?:ଜହ(?:ନ୍?‌)?|ଯ(?:ୋହ(?:ନ୍?|\.)|ହ(?:ନ୍?|\.)))|\s*(?:ଜହ(?:ନ୍?‌)?|ଯ(?:ୋହ(?:ନ୍?|\.)|ହ(?:ନ୍?|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2୨](?:\.\s*(?:ଜହ(?:ନ୍?‌)?|ଯ(?:ୋହ(?:ନ୍?|\.)|ହ(?:ନ୍?|\.)))|\s*(?:ଜହ(?:ନ୍?‌)?|ଯ(?:ୋହ(?:ନ୍?|\.)|ହ(?:ନ୍?|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଜହ(?:ନ୍?‌)?|ଯ(?:ୋହ(?:ନ୍?|\.)|ହ(?:ନ୍?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:େରି?ତ୍?‌|୍ର(?:େର(?:ି[.ତ]|[.ତ])|ର(?:ି[.ତ]|[.ତ]))|ରି?ତ୍?‌|ରେର(?:ି[.ତ]|[.ତ])|ରର(?:ି[.ତ]|[.ତ])|େରି?|ରି?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ର(?:ୋମ(?:ୀ[.ୟ]|[.ୟ])|ମ(?:(?:(?:ିୟ|[.ୟ])|ି?)|ୀ[.ୟ])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1୧](?:\.\s*କର(?:ିନ୍?ଥୀ?ୟ|ନ(?:୍(?:ଥୀ?ୟ|ତି?)|ଥୀ?ୟ|ତି?)|ି?\.)?|\s*କର(?:ିନ୍?ଥୀ?ୟ|ନ(?:୍(?:ଥୀ?ୟ|ତି?)|ଥୀ?ୟ|ତି?)|ି?\.)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2୨](?:\.\s*କ(?:ର(?:(?:ିନ(?:୍ଥୀ?ୟ|ଥୀ?ୟ)|ନ୍?ଥୀ?ୟ|ନ୍?ତି)|(?:ନ୍?ତ)?)|୍‍ରି?\.|‍ରି?\.)|\s*କ(?:ର(?:(?:ିନ(?:୍ଥୀ?ୟ|ଥୀ?ୟ)|ନ୍?ଥୀ?ୟ|ନ୍?ତି)|(?:ନ୍?ତ)?)|୍‍ରି?\.|‍ରି?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(କଲ(?:ସ(?:ୀୟ|[ିୟ])?|\.)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଗ(?:ାଲ(?:ା?ତ(?:[ିୀ])?ୟ|ା?\.|ା)?|ଲ(?:ା?ତ(?:[ିୀ])?ୟ|ା?\.|ା)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଏ(?:ପି?ସିୟ|ଫ(?:ି?ସୀ?ୟ|ି?\.)|ପ(?:ି?ସୟ|ି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଫ(?:ିଲ(?:ିପ(?:୍ପ(?:ୀୟ|[.ୟ])|ପ(?:ୀୟ|[.ୟ]))|ପ(?:୍ପ(?:ୀୟ|[.ୟ])|ପ(?:ୀୟ|[.ୟ])))|ଲ(?:ିପ(?:୍ପ(?:ୀୟ|[.ୟ])|ପ(?:ୀୟ|[.ୟ]))|ପ(?:୍ପ(?:ୀୟ|[.ୟ])|ପ(?:ୀୟ|[.ୟ]))))|ପ(?:(?:ିଲ(?:ିପି?ୟ|ପି?ୟ)|ଲ(?:ିପି?ୟ|ପି?ୟ))|(?:ିଲ(?:ିପି?|ପି?)|ଲ(?:ିପି?|ପି?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1୧](?:\.\s*(?:ଥ(?:େସ(?:ଲନ(?:ିକି?ୟ|କି?ୟ)|୍?\.)|ସ(?:ଲନ(?:ିକି?ୟ|କି?ୟ)|୍?\.))|ତ(?:(?:େସଲନି?କି|ସଲନି?କି)|(?:େସ(?:ଲନି?କ)?|ସ(?:ଲନି?କ)?)))|\s*(?:ଥ(?:େସ(?:ଲନ(?:ିକି?ୟ|କି?ୟ)|୍?\.)|ସ(?:ଲନ(?:ିକି?ୟ|କି?ୟ)|୍?\.))|ତ(?:(?:େସଲନି?କି|ସଲନି?କି)|(?:େସ(?:ଲନି?କ)?|ସ(?:ଲନି?କ)?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2୨](?:\.\s*(?:ଥ(?:େସ(?:ଲନ(?:ିକି?ୟ|କି?ୟ)|୍?\.)|ସ(?:ଲନ(?:ିକି?ୟ|କି?ୟ)|୍?\.))|ତ(?:(?:େସଲନି?କି|ସଲନି?କି)|(?:େସ(?:ଲନି?କ)?|ସ(?:ଲନି?କ)?)))|\s*(?:ଥ(?:େସ(?:ଲନ(?:ିକି?ୟ|କି?ୟ)|୍?\.)|ସ(?:ଲନ(?:ିକି?ୟ|କି?ୟ)|୍?\.))|ତ(?:(?:େସଲନି?କି|ସଲନି?କି)|(?:େସ(?:ଲନି?କ)?|ସ(?:ଲନି?କ)?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1୧](?:\.\s*ତ(?:(?:ିମତ|ମ[ତଥ])ି?|ୀମ(?:ଥି?|\.)|ି?ମ|ମ\.)|\s*ତ(?:(?:ିମତ|ମ[ତଥ])ି?|ୀମ(?:ଥି?|\.)|ି?ମ|ମ\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2୨](?:\.\s*ତ(?:(?:ିମତ|ମ[ତଥ])ି?|ୀମ(?:ଥି?|\.)|ି?ମ|ମ\.)|\s*ତ(?:(?:ିମତ|ମ[ତଥ])ି?|ୀମ(?:ଥି?|\.)|ି?ମ|ମ\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ତ(?:ିତସ୍?‌|ତ(?:ସ୍?‌|\.)|ୀତ(?:ସ୍?|\.)|ତ(?:ସ୍?)?|ିତ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଫ(?:ିଲି?ମନ|ଲି?ମନ)୍?|ପ(?:ିଲ(?:ିମ(?:ନ୍?)?|ମ(?:ନ୍?)?)|ଲ(?:ିମ(?:ନ୍?)?|ମ(?:ନ୍?)?))|ଫ(?:ିଲି?\.|ଲି?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଏବ(?:୍ର[ିୀ]?|ର[ିୀ]?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଜ(?:(?:ାକୁ?ବ|କୁ?ବ)|(?:ାକୁ?|କୁ?))|ଯ(?:ାକ(?:ୁ[.ବ]|[.ବ])|କ(?:ୁ[.ବ]|[.ବ]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1୧](?:\.\s*ପ(?:ିତ(?:ର(?:୍?‌|୍)?|\.)?|ତ(?:ର(?:୍?‌|୍)?|\.)?)|\s*ପ(?:ିତ(?:ର(?:୍?‌|୍)?|\.)?|ତ(?:ର(?:୍?‌|୍)?|\.)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2୨](?:\.\s*ପ(?:ିତ(?:ର(?:୍?‌|୍)?|\.)?|ତ(?:ର(?:୍?‌|୍)?|\.)?)|\s*ପ(?:ିତ(?:ର(?:୍?‌|୍)?|\.)?|ତ(?:ର(?:୍?‌|୍)?|\.)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଯ(?:ିହ(?:ୁ(?:ଦି?|\.)|ଦି?|\.)|ହ(?:ୁ(?:ଦି?|\.)|ଦି?|\.))|ଜ(?:ି?ଉଦା|(?:ିଉଦ?|ଉଦ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
