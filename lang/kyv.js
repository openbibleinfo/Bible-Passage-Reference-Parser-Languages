  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*य(?:ूह(?:न(?:्ना?|ना?))?|ह(?:न(?:्ना?|ना?))?)|\s*य(?:ूह(?:न(?:्ना?|ना?))?|ह(?:न(?:्ना?|ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*य(?:ूह(?:न(?:्ना?|ना?))?|ह(?:न(?:्ना?|ना?))?)|\s*य(?:ूह(?:न(?:्ना?|ना?))?|ह(?:न(?:्ना?|ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(३(?:\.\s*य(?:ूह(?:न(?:्ना?|ना?))?|ह(?:न(?:्ना?|ना?))?)|\s*य(?:ूह(?:न(?:्ना?|ना?))?|ह(?:न(?:्ना?|ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:च(?:ुन(?:्ल\s*आर\s*भ(?:ेज(?:्ल\s*च(?:ेला?सब|ला?सब)|ल\s*च(?:ेला?सब|ला?सब))|ज(?:्ल\s*च(?:ेला?सब|ला?सब)|ल\s*च(?:ेला?सब|ला?सब)))|ल\s*आर\s*भ(?:ेज(?:्ल\s*च(?:ेला?सब|ला?सब)|ल\s*च(?:ेला?सब|ला?सब))|ज(?:्ल\s*च(?:ेला?सब|ला?सब)|ल\s*च(?:ेला?सब|ला?सब))))|न(?:्ल\s*आर\s*भ(?:ेज(?:्ल\s*च(?:ेला?सब|ला?सब)|ल\s*च(?:ेला?सब|ला?सब))|ज(?:्ल\s*च(?:ेला?सब|ला?सब)|ल\s*च(?:ेला?सब|ला?सब)))|ल\s*आर\s*भ(?:ेज(?:्ल\s*च(?:ेला?सब|ला?सब)|ल\s*च(?:ेला?सब|ला?सब))|ज(?:्ल\s*च(?:ेला?सब|ला?सब)|ल\s*च(?:ेला?सब|ला?सब)))))|प(?:्?रे|्?र)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(र(?:ो(?:मी?)?|मी?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*क(?:ोर(?:न(?:्थी?|थी?))?|र(?:न(?:्थी?|थी?))?)|\s*क(?:ोर(?:न(?:्थी?|थी?))?|र(?:न(?:्थी?|थी?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ोर(?:न(?:्थी?|थी?))?|र(?:न(?:्थी?|थी?))?)|\s*क(?:ोर(?:न(?:्थी?|थी?))?|र(?:न(?:्थी?|थी?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
