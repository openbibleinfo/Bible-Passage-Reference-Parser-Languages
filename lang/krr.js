  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:កណ(?:ើត\s*ពដ(?:ិ?ះ\s*គ(?:្រែ?|រែ?)|ិ?\s*គ(?:្រែ?|រែ?))|ត\s*ពដ(?:ិ?ះ\s*គ(?:្រែ?|រែ?)|ិ?\s*គ(?:្រែ?|រែ?)))|ពគ្?រ\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ក(?:ាន\s*ប(?:៉(?:ើក\s*ពដៃ?|ក\s*ពដៃ?)|ើក\s*ពដៃ?|ក\s*ពដៃ?)|ន\s*ប(?:៉(?:ើក\s*ពដៃ?|ក\s*ពដៃ?)|ើក\s*ពដៃ?|ក\s*ពដៃ?))|បព\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ruth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ណ(?:ាង\s*រូ?ត|ង\s*រូ?ត)|រូ?ត))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Esth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ណ(?:ាង\s*អ(?:៊(?:ែសថើ?រ|សថើ?រ)|ែសថើ?រ|សថើ?រ)|ង\s*អ(?:៊(?:ែសថើ?រ|សថើ?រ)|ែសថើ?រ|សថើ?រ))|អថ\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ម(?:៉(?:ាថា?យ|ថា?យ)|ាថា?យ|ថ(?:ាយ|[.យ])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ម(?:៉(?:ាក(?:ុ?ះ|ុ)?|ក(?:ុ?ះ|ុ)?)|ាក(?:ុ?ះ|ុ)?|ក(?:(?:ុះ|[.ះ])|ុ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ល(?:ូកា?|ក(?:[.ា])?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១យហ\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២យហ\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(៣(?:\s*យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន)|យហ\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន)|\s*យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន)|\s*យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហ(?:ាន|[.ន])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ហណ(?:ាយ|[.យ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(រ(?:៉ូ?ម|ូ?ម))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ក(?:ូរ(?:ិនថូ?ស|នថូ?ស)|រ(?:ិនថូ?ស|នថូ?ស))|\s*ក(?:ូរ(?:ិនថូ?ស|នថូ?ស)|រ(?:ិនថូ?ស|នថូ?ស))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ក(?:ូរ(?:ិនថូ?ស|នថូ?ស)|រ(?:ិនថូ?ស|នថូ?ស))|\s*ក(?:ូរ(?:ិនថូ?ស|នថូ?ស)|រ(?:ិនថូ?ស|នថូ?ស))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១ករ\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ករ\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ក(?:ូឡ(?:ូស|[.ស])|ឡ(?:ូស|[.ស])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ឝ(?:៉(?:ាឡ(?:ាទី?|ទី?|\.)|ឡ(?:ាទី?|ទី?|\.))|ាឡ(?:ាទី?|ទី?|\.)|ឡ(?:ាទី?|ទី?|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(អ(?:៊(?:ែភ(?:ីសូ?|សូ?)|ភ(?:ីសូ?|សូ?))|ែភ(?:ីសូ?|សូ?)|ភ(?:ីសូ?|(?:សូ?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ភ(?:ីល(?:ីប|[.ប])|ល(?:ីប|[.ប])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ធ(?:ែស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក))|ស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក)))|\s*ធ(?:ែស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក))|ស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ធ(?:ែស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក))|ស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក)))|\s*ធ(?:ែស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក))|ស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១ធស\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ធស\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ធ(?:ីម(?:៉(?:ូធែ?|ធែ?)|ូធែ?|ធែ?)|ម(?:៉(?:ូធែ?|ធែ?)|ូធែ?|ធែ?))|\s*ធ(?:ីម(?:៉(?:ូធែ?|ធែ?)|ូធែ?|ធែ?)|ម(?:៉(?:ូធែ?|ធែ?)|ូធែ?|ធែ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ធ(?:ីម(?:៉(?:ូធែ?|ធែ?)|ូធែ?|ធែ?)|ម(?:៉(?:ូធែ?|ធែ?)|ូធែ?|ធែ?))|\s*ធ(?:ីម(?:៉(?:ូធែ?|ធែ?)|ូធែ?|ធែ?)|ម(?:៉(?:ូធែ?|ធែ?)|ូធែ?|ធែ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១ធម\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ធម\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ទ(?:ីត(?:ុ?ះ|ុ)?|ត(?:(?:ុះ|[.ះ])|ុ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ភ(?:ី?ល(?:ីម(?:៉ូ?ន|ូ?ន)|ម(?:៉ូ?ន|ូ?ន))|ី?ម\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ហ(?:៊(?:ែប(?:្រ(?:៊ឺ?|ឺ)?|រ(?:៊ឺ?|ឺ)?)|ប(?:្រ(?:៊ឺ?|ឺ)?|រ(?:៊ឺ?|ឺ)?))|ែប(?:្រ(?:៊ឺ?|ឺ)?|រ(?:៊ឺ?|ឺ)?)|ប(?:្រ(?:៊ឺ?|ឺ)?|(?:រ(?:៊ឺ?|ឺ)?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|ក(?:ុប|[.ប])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ព(?:ីត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?))|\s*ព(?:ីត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ព(?:ីត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?))|\s*ព(?:ីត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១ពត្?រ\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ពត្?រ\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:ូដា?ស|ដ(?:ាស|[.ស])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
