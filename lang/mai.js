  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*य(?:ूहन(?:्‍ना?|‍ना?)|हन(?:्‍ना?|‍ना?))|\s*य(?:ूहन(?:्‍ना?|‍ना?)|हन(?:्‍ना?|‍ना?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*य(?:ूहन(?:्‍ना?|‍ना?)|हन(?:्‍ना?|‍ना?))|\s*य(?:ूहन(?:्‍ना?|‍ना?)|हन(?:्‍ना?|‍ना?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*य(?:ूहन(?:्‍ना?|‍ना?)|हन(?:्‍ना?|‍ना?))|\s*य(?:ूहन(?:्‍ना?|‍ना?)|हन(?:्‍ना?|‍ना?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मस(?:ीह-दू?त|ह-दू?त))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ोर(?:िन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?))|र(?:िन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?)))|\s*क(?:ोर(?:िन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?))|र(?:िन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ोर(?:िन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?))|र(?:िन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?)))|\s*क(?:ोर(?:िन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?))|र(?:िन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ुस(?:्‍सी?|‍सी?)|स(?:्‍सी?|‍सी?))|ल(?:ुस(?:्‍सी?|‍सी?)|स(?:्‍सी?|‍सी?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इफ(?:िसी?|सी?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:िसल(?:ुन(?:िकी?|की?)|न(?:िकी?|की?))|सल(?:ुन(?:िकी?|की?)|न(?:िकी?|की?)))|\s*थ(?:िसल(?:ुन(?:िकी?|की?)|न(?:िकी?|की?))|सल(?:ुन(?:िकी?|की?)|न(?:िकी?|की?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:िसल(?:ुन(?:िकी?|की?)|न(?:िकी?|की?))|सल(?:ुन(?:िकी?|की?)|न(?:िकी?|की?)))|\s*थ(?:िसल(?:ुन(?:िकी?|की?)|न(?:िकी?|की?))|सल(?:ुन(?:िकी?|की?)|न(?:िकी?|की?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:िम(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|म(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स)))|\s*त(?:िम(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|म(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:िम(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|म(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स)))|\s*त(?:िम(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|म(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इब(?:्र(?:ानी?|नी?)|र(?:ानी?|नी?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*पत(?:्रु?स|रु?स)|\s*पत(?:्रु?स|रु?स)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*पत(?:्रु?स|रु?स)|\s*पत(?:्रु?स|रु?स)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
