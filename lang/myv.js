var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["myv"];
    this.translations = [/ERZNT\b/gi];
    this.first = /(?:1\.?\s*|Паволонь\.?\s*)/;
    this.second = /(?:2\.?\s*|Паволонь\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Матв(?:е[ий]|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Иоаннонь\s*васенце\s*с[её]рмазо)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Иоаннонь\s*омбоце\s*с[её]рмазо)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Иоаннонь\s*колмоце\s*с[её]рмазо|3\s*Иоанн\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь\.?\s*Иоанн\.|1\.?\s*Иоанн\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь\.?\s*Иоанн\.|2\.?\s*Иоанн\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ап(?:остолтнэнь\s*тевест|\.т\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Паволонь\s*с[её]рмазо\s*Римев|Рим\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь(?:\.\s*(?:васенце\s*с[её]рмазо\s*Коринфев|Кор\.)|\s*(?:васенце\s*с[её]рмазо\s*Коринфев|Кор\.))|1(?:\.\s*(?:васенце\s*с[её]рмазо\s*Коринфев|Кор\.)|\s*(?:васенце\s*с[её]рмазо\s*Коринфев|Кор\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь(?:\.\s*(?:омбоце\s*с[её]рмазо\s*Коринфев|Кор\.)|\s*(?:омбоце\s*с[её]рмазо\s*Коринфев|Кор\.))|2(?:\.\s*(?:омбоце\s*с[её]рмазо\s*Коринфев|Кор\.)|\s*(?:омбоце\s*с[её]рмазо\s*Коринфев|Кор\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Паволонь\s*с[её]рмазо\s*Колоссав|Кол\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Паволонь\s*с[её]рмазо\s*Галатияв|Гал\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Паволонь\s*с[её]рмазо\s*Эфесэв|Эф\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Паволонь\s*с[её]рмазо\s*Филиппав|Фил\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь(?:\.\s*(?:васенце\s*с[её]рмазо\s*Фессалоникав|Фесс\.)|\s*(?:васенце\s*с[её]рмазо\s*Фессалоникав|Фесс\.))|1(?:\.\s*(?:васенце\s*с[её]рмазо\s*Фессалоникав|Фесс\.)|\s*(?:васенце\s*с[её]рмазо\s*Фессалоникав|Фесс\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь(?:\.\s*(?:омбоце\s*с[её]рмазо\s*Фессалоникав|Фесс\.)|\s*(?:омбоце\s*с[её]рмазо\s*Фессалоникав|Фесс\.))|2(?:\.\s*(?:омбоце\s*с[её]рмазо\s*Фессалоникав|Фесс\.)|\s*(?:омбоце\s*с[её]рмазо\s*Фессалоникав|Фесс\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь(?:\.\s*(?:васенце\s*с[её]рмазо\s*Тимофе[ий]нень|Тим\.)|\s*(?:васенце\s*с[её]рмазо\s*Тимофе[ий]нень|Тим\.))|1(?:\.\s*(?:васенце\s*с[её]рмазо\s*Тимофе[ий]нень|Тим\.)|\s*(?:васенце\s*с[её]рмазо\s*Тимофе[ий]нень|Тим\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь(?:\.\s*(?:омбоце\s*с[её]рмазо\s*Тимофе[ий]нень|Тим\.)|\s*(?:омбоце\s*с[её]рмазо\s*Тимофе[ий]нень|Тим\.))|2(?:\.\s*(?:омбоце\s*с[её]рмазо\s*Тимофе[ий]нень|Тим\.)|\s*(?:омбоце\s*с[её]рмазо\s*Тимофе[ий]нень|Тим\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Паволонь\s*с[её]рмазо\s*Титнэнь|Тит\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Паволонь\s*с[её]рмазо\s*Филемоннэнь|Филем\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Евр(?:е[ий]тненень\s*с[её]рмась|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Як(?:овонь\s*с[её]рмазо|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь\.?\s*Петр\.|1\.?\s*Петр\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Паволонь\.?\s*Петр\.|2\.?\s*Петр\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Петрань\s*васенце\s*с[её]рмазо)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Петрань\s*омбоце\s*с[её]рмазо)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Иуд(?:ань\s*с[её]рмазо|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
