var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["huv"];
    this.translations = [/HUV\b/gi];
    this.first = /(?:1\.?\s*|1ª\.?\s*)/;
    this.second = /(?:2\.?\s*|2ª\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:ª\s*Carta\s*de\s*San\s*Juan|\s*Jn\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*(?:carta\s*de\s*San\s*Juan|Jn\.)|\s*(?:carta\s*de\s*San\s*Juan|Jn\.))|\.\s*(?:carta\s*de\s*San\s*Juan|Jn\.)|\s*(?:carta\s*de\s*San\s*Juan|Jn\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*(?:Carta\s*de\s*San\s*Juan|Jn\.)|\s*(?:Carta\s*de\s*San\s*Juan|Jn\.))|\.\s*(?:Carta\s*de\s*San\s*Juan|Jn\.)|\s*(?:Carta\s*de\s*San\s*Juan|Jn\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:San\s*Juan|Jn\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Los\s*Hechos\s*de\s*los\s*Ap[oó]stoles|Hch\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*Co(?:rintios|\.)|\s*Co(?:rintios|\.))|\.\s*Co(?:rintios|\.)|\s*Co(?:rintios|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*Co(?:rintios|\.)|\s*Co(?:rintios|\.))|\.\s*Co(?:rintios|\.)|\s*Co(?:rintios|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*T(?:esalonicenses|s\.)|\s*T(?:esalonicenses|s\.))|\.\s*T(?:esalonicenses|s\.)|\s*T(?:esalonicenses|s\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*T(?:esalonicenses|s\.)|\s*T(?:esalonicenses|s\.))|\.\s*T(?:esalonicenses|s\.)|\s*T(?:esalonicenses|s\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*Ti(?:moteo|\.)|\s*Ti(?:moteo|\.))|\.\s*Ti(?:moteo|\.)|\s*Ti(?:moteo|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*Ti(?:moteo|\.)|\s*Ti(?:moteo|\.))|\.\s*Ti(?:moteo|\.)|\s*Ti(?:moteo|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F(?:ilemn|lm\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*(?:Carta\s*de\s*San\s*)?Pedro|\s*(?:Carta\s*de\s*San\s*)?Pedro)|\.\s*(?:Carta\s*de\s*San\s*)?Pedro|\s*(?:Carta\s*de\s*San\s*)?Pedro))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*(?:Carta\s*de\s*San\s*)?Pedro|\s*(?:Carta\s*de\s*San\s*)?Pedro)|\.\s*(?:Carta\s*de\s*San\s*)?Pedro|\s*(?:Carta\s*de\s*San\s*)?Pedro))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
