  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(தர(?:ிசன\.?|சன\.?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(மத(?:்த(?:ாயி?|யி?)|த(?:ாயி?|யி?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ம(?:ாற(?:்க(?:ு\.?|\.)?|க(?:ு\.?|\.)?)|ற(?:்க(?:ு\.?|\.)?|க(?:ு\.?|\.)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ய(?:ோவ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?)|வ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?))|\s*ய(?:ோவ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?)|வ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ய(?:ோவ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?)|வ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?))|\s*ய(?:ோவ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?)|வ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*ய(?:ோவ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?)|வ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?))|\s*ய(?:ோவ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?)|வ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ய(?:ோவ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?)|வ(?:ான(?:ு\.?|\.)?|ன(?:ு\.?|\.)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(அப(?:்?ப(?:ோஸ(?:்தலம(?:்ம(?:ாரு?|ரு?)|ம(?:ாரு?|ரு?))|தலம(?:்ம(?:ாரு?|ரு?)|ம(?:ாரு?|ரு?)))|ஸ(?:்தலம(?:்ம(?:ாரு?|ரு?)|ம(?:ாரு?|ரு?))|தலம(?:்ம(?:ாரு?|ரு?)|ம(?:ாரு?|ரு?))))|்?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ர(?:ோம(?:ா?க(?:்க(?:ாரு?|ரு?)|க(?:ாரு?|ரு?))|ா?\.)|ம(?:ா?க(?:்க(?:ாரு?|ரு?)|க(?:ாரு?|ரு?))|ா?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*க(?:ொர(?:ி?ந(?:்தி?|தி?)|ி?\.)|ர(?:ி?ந(?:்தி?|தி?)|ி?\.))|\s*க(?:ொர(?:ி?ந(?:்தி?|தி?)|ி?\.)|ர(?:ி?ந(?:்தி?|தி?)|ி?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*க(?:ொர(?:ி?ந(?:்தி?|தி?)|ி?\.)|ர(?:ி?ந(?:்தி?|தி?)|ி?\.))|\s*க(?:ொர(?:ி?ந(?:்தி?|தி?)|ி?\.)|ர(?:ி?ந(?:்தி?|தி?)|ி?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(க(?:ொல(?:ோச(?:ி?க(?:்க(?:ாரு?|ரு?)|க(?:ாரு?|ரு?))|ி?\.)|ச(?:ி?க(?:்க(?:ாரு?|ரு?)|க(?:ாரு?|ரு?))|ி?\.))|ல(?:ோச(?:ி?க(?:்க(?:ாரு?|ரு?)|க(?:ாரு?|ரு?))|ி?\.)|ச(?:ி?க(?:்க(?:ாரு?|ரு?)|க(?:ாரு?|ரு?))|ி?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(கல(?:ா?த(?:்தி?|தி?)|ா?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(எப(?:ேச(?:ி?யம(?:்ம(?:ாரு?|ரு?)|ம(?:ாரு?|ரு?))|ி?\.)|ச(?:ி?யம(?:்ம(?:ாரு?|ரு?)|ம(?:ாரு?|ரு?))|ி?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ப(?:ில(?:ி?ப(?:்பி?|பி?)|ி?\.)|ல(?:ி?ப(?:்பி?|பி?)|ி?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*த(?:ெச(?:ல(?:ோனி?|னி?)|\.)|ச(?:ல(?:ோனி?|னி?)|\.))|\s*த(?:ெச(?:ல(?:ோனி?|னி?)|\.)|ச(?:ல(?:ோனி?|னி?)|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*த(?:ெச(?:ல(?:ோனி?|னி?)|\.)|ச(?:ல(?:ோனி?|னி?)|\.))|\s*த(?:ெச(?:ல(?:ோனி?|னி?)|\.)|ச(?:ல(?:ோனி?|னி?)|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*த(?:ிம(?:ோ?த(?:்தி?|தி?)|ோ?\.)|ம(?:ோ?த(?:்தி?|தி?)|ோ?\.))|\s*த(?:ிம(?:ோ?த(?:்தி?|தி?)|ோ?\.)|ம(?:ோ?த(?:்தி?|தி?)|ோ?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*த(?:ிம(?:ோ?த(?:்தி?|தி?)|ோ?\.)|ம(?:ோ?த(?:்தி?|தி?)|ோ?\.))|\s*த(?:ிம(?:ோ?த(?:்தி?|தி?)|ோ?\.)|ம(?:ோ?த(?:்தி?|தி?)|ோ?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(த(?:ீத(?:்த(?:ு\.?|\.)?|த(?:ு\.?|\.)?)|த(?:்த(?:ு\.?|\.)?|த(?:ு\.?|\.)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ப(?:ில(?:ே?ம(?:ோனு?|னு?)|ே?\.)|ல(?:ே?ம(?:ோனு?|னு?)|ே?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(எப(?:ி?ர(?:ெயம(?:்ம(?:ாரு?|ரு?)|ம(?:ாரு?|ரு?))|யம(?:்ம(?:ாரு?|ரு?)|ம(?:ாரு?|ரு?)))|ி?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ப(?:ேத(?:ுர(?:ு\.?|\.)?|ர(?:ு\.?|\.)?)|த(?:ுர(?:ு\.?|\.)?|ர(?:ு\.?|\.)?))|\s*ப(?:ேத(?:ுர(?:ு\.?|\.)?|ர(?:ு\.?|\.)?)|த(?:ுர(?:ு\.?|\.)?|ர(?:ு\.?|\.)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ப(?:ேத(?:ுர(?:ு\.?|\.)?|ர(?:ு\.?|\.)?)|த(?:ுர(?:ு\.?|\.)?|ர(?:ு\.?|\.)?))|\s*ப(?:ேத(?:ுர(?:ு\.?|\.)?|ர(?:ு\.?|\.)?)|த(?:ுர(?:ு\.?|\.)?|ர(?:ு\.?|\.)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ய(?:ூத(?:ா\.?|\.)?|த(?:ா\.?|\.)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
