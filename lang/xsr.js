  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ज(?:्‍यल(?:्‍का?|‍का?)|‍यल(?:्‍का?|‍का?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(३(?:\.\s*य(?:ूहन(?:्‍ना?|‍ना?)|हन(?:्‍ना?|‍ना?))|\s*य(?:ूहन(?:्‍ना?|‍ना?)|हन(?:्‍ना?|‍ना?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ल(?:ोम(?:ा\s*छ(?:्‍य(?:ेत(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))|त(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))))|‍य(?:ेत(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))|त(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))))|\s*छ(?:्‍य(?:ेत(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))|त(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))))|‍य(?:ेत(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))|त(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))))))|म(?:ा\s*छ(?:्‍य(?:ेत(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))|त(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))))|‍य(?:ेत(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))|त(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))))|\s*छ(?:्‍य(?:ेत(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))|त(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))))|‍य(?:ेत(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?)))|त(?:िव(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))|व(?:ी\s*ल(?:ाका?|का?)|\s*ल(?:ाका?|का?))))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ोर(?:िन(?:्थी?|थी?)|न(?:्थी?|थी?))|र(?:िन(?:्थी?|थी?)|न(?:्थी?|थी?)))|\s*क(?:ोर(?:िन(?:्थी?|थी?)|न(?:्थी?|थी?))|र(?:िन(?:्थी?|थी?)|न(?:्थी?|थी?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(कलस(?:्सी?|सी?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:िप(?:्पी?|पी?)|प(?:्पी?|पी?))|ल(?:िप(?:्पी?|पी?)|प(?:्पी?|पी?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*थ(?:ेसल(?:ोन(?:िकी?|की?)|न(?:िकी?|की?))|सल(?:ोन(?:िकी?|की?)|न(?:िकी?|की?)))|\s*थ(?:ेसल(?:ोन(?:िकी?|की?)|न(?:िकी?|की?))|सल(?:ोन(?:िकी?|की?)|न(?:िकी?|की?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*थ(?:ेसल(?:ोन(?:िकी?|की?)|न(?:िकी?|की?))|सल(?:ोन(?:िकी?|की?)|न(?:िकी?|की?)))|\s*थ(?:ेसल(?:ोन(?:िकी?|की?)|न(?:िकी?|की?))|सल(?:ोन(?:िकी?|की?)|न(?:िकी?|की?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
