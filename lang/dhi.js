var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["dhi"];
    this.translations = [/DHI(?:NT|M)\b/gi];
    this.first = /(?:1\.?\s*|१\.?\s*)/;
    this.second = /(?:2\.?\s*|२\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्रक(?:ास?|स)?|रक(?:ास?|स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मत(?:्?‍ति?|्|ि)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मर(?:्क(?:ुस?|स)?|क(?:ुस?|स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ल(?:ुका?|का?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:3\s*य(?:ुहा?न|हा?न)(?:्‍ना?|‍ना?)|३\s*य(?:ुह(?:न(?:्‍ना?|‍ना?))?|ह(?:न(?:्‍ना?|‍ना?))?)|3\s*यु?ह))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1१](?:\.\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)|\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2२](?:\.\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)|\s*य(?:ुह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?|ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ुह(?:ा?न(?:्‍ना?|‍ना?)|ा)?|ह(?:ा?न(?:्‍ना?|‍ना?)|ा)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:स(?:ाल(?:्?‍त(?:ेङ\s*द(?:िङग(?:िल(?:्‍का?|‍का?)|ल(?:्‍का?|‍का?))|ङग(?:िल(?:्‍का?|‍का?)|ल(?:्‍का?|‍का?)))|ङ\s*द(?:िङग(?:िल(?:्‍का?|‍का?)|ल(?:्‍का?|‍का?))|ङग(?:िल(?:्‍का?|‍का?)|ल(?:्‍का?|‍का?))))|्?न(?:्ह(?:ाक(?:ा\s*च(?:ात्?य|त्?य)|\s*च(?:ात्?य|त्?य))|क(?:ा\s*च(?:ात्?य|त्?य)|\s*च(?:ात्?य|त्?य)))|ह(?:ाक(?:ा\s*च(?:ात्?य|त्?य)|\s*च(?:ात्?य|त्?य))|क(?:ा\s*च(?:ात्?य|त्?य)|\s*च(?:ात्?य|त्?य))))ा?|्)?|ल(?:्?‍त(?:ेङ\s*द(?:िङग(?:िल(?:्‍का?|‍का?)|ल(?:्‍का?|‍का?))|ङग(?:िल(?:्‍का?|‍का?)|ल(?:्‍का?|‍का?)))|ङ\s*द(?:िङग(?:िल(?:्‍का?|‍का?)|ल(?:्‍का?|‍का?))|ङग(?:िल(?:्‍का?|‍का?)|ल(?:्‍का?|‍का?))))|्?न(?:्ह(?:ाक(?:ा\s*च(?:ात्?य|त्?य)|\s*च(?:ात्?य|त्?य))|क(?:ा\s*च(?:ात्?य|त्?य)|\s*च(?:ात्?य|त्?य)))|ह(?:ाक(?:ा\s*च(?:ात्?य|त्?य)|\s*च(?:ात्?य|त्?य))|क(?:ा\s*च(?:ात्?य|त्?य)|\s*च(?:ात्?य|त्?य))))ा?|्)?)|प(?:्?रे|्?र)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(र(?:ोमि?|मि?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1१](?:\.\s*क(?:ोर(?:ि?न(?:्?‍थि?|्?थि?)|ि)?|र(?:ि?न(?:्?‍थि?|्?थि?)|ि)?)|\s*क(?:ोर(?:ि?न(?:्?‍थि?|्?थि?)|ि)?|र(?:ि?न(?:्?‍थि?|्?थि?)|ि)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2२](?:\.\s*क(?:ोर(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?))?|र(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?))?)|\s*क(?:ोर(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?))?|र(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(कल(?:स(?:्?‍सि?|्?सि?))?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(गल(?:ा(?:ति?)?|ति?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(एफ(?:ि(?:सि?)?|सि?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ि?प(?:्?‍पि?|्?पि?)|ि)?|ल(?:ि?प(?:्?‍पि?|्?पि?)|ि)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1१](?:\.\s*थ(?:ेस(?:ो?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|्ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ो)?|स(?:ो?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|्ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ो)?)|\s*थ(?:ेस(?:ो?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|्ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ो)?|स(?:ो?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|्ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ो)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2२](?:\.\s*थ(?:ेस(?:ो?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|्ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ो)?|स(?:ो?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|्ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ो)?)|\s*थ(?:ेस(?:ो?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|्ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ो)?|स(?:ो?ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|्ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|ो)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1१](?:\.\s*त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?)|\s*त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2२](?:\.\s*त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?)|\s*त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ितस?|तस?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ह(?:िब(?:्रु?|रु?)|ब(?:्रु?|रु?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ाक(?:ुब?|ब)?|क(?:ुब?|ब)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1१](?:\.\s*पत(?:्?‍रु?स|्)?|\s*पत(?:्?‍रु?स|्)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2२](?:\.\s*पत(?:्?‍रु?स|्)?|\s*पत(?:्?‍रु?स|्)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1पतरु?स)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(पतरु?स)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यह(?:ु(?:दा?)?|दा?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
