  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र(?:ेर(?:ीत?|त)?|र(?:ीत?|त)?)|र(?:ेर(?:ीत?|त)?|र(?:ीत?|त)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*क(?:ो?र(?:ीन(?:्थी?|थी?)|न(?:्थी?|थी?))|ो)?|\s*क(?:ो?र(?:ीन(?:्थी?|थी?)|न(?:्थी?|थी?))|ो)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ो?र(?:ीन(?:्थी?|थी?)|न(?:्थी?|थी?))|ो)?|\s*क(?:ो?र(?:ीन(?:्थी?|थी?)|न(?:्थी?|थी?))|ो)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(एफ(?:ी(?:सी?)?|सी?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*थ(?:ेस(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?|स(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?)|\s*थ(?:ेस(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?|स(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*थ(?:ेस(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?|स(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?)|\s*थ(?:ेस(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?|स(?:ल(?:ोन(?:ीकी?|की?)|न(?:ीकी?|की?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*त(?:ी?म(?:ोथी?|थी?)|ी)?|\s*त(?:ी?म(?:ोथी?|थी?)|ी)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*त(?:ी?म(?:ोथी?|थी?)|ी)?|\s*त(?:ी?म(?:ोथी?|थी?)|ी)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:ील(?:े?मो?न|े)?|ल(?:े?मो?न|े)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
