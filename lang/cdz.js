  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ক(?:ুল(?:ি?জক(?:ুর(?:াআ\s*ক(?:ামি?|মি?)|আ\s*ক(?:ামি?|মি?))|র(?:াআ\s*ক(?:ামি?|মি?)|আ\s*ক(?:ামি?|মি?)))|ি?চ)|ল(?:ি?জক(?:ুর(?:াআ\s*ক(?:ামি?|মি?)|আ\s*ক(?:ামি?|মি?))|র(?:াআ\s*ক(?:ামি?|মি?)|আ\s*ক(?:ামি?|মি?)))|ি?চ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*কর(?:িন(?:্থ(?:ীয়?|য়?)|থ(?:ীয়?|য়?))|ন(?:্থ(?:ীয়?|য়?)|থ(?:ীয়?|য়?)))|\s*কর(?:িন(?:্থ(?:ীয়?|য়?)|থ(?:ীয়?|য়?))|ন(?:্থ(?:ীয়?|য়?)|থ(?:ীয়?|য়?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1করি?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*থ(?:িষলন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?))|ষলন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))|\s*থ(?:িষলন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?))|ষলন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*থ(?:িষলন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?))|ষলন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))|\s*থ(?:িষলন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?))|ষলন(?:ীক(?:ীয়?|য়?)|ক(?:ীয়?|য়?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1থি?ষ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2থি?ষ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
          ...
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2ত(?:ীমথ(?:িয়?|য়?)|মথ(?:িয়?|য়?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ত(?:ীত।?|ত।?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
