  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Tercera\s*Carta\s*de\s*San\s*Jua|3\s*J)n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primera(?:\.\s*(?:Carta\s*de\s*San\s*Jua|J)n|\s*(?:Carta\s*de\s*San\s*Jua|J)n)|1(?:\.\s*(?:Carta\s*de\s*San\s*Jua|J)n|\s*(?:Carta\s*de\s*San\s*Jua|J)n)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segunda(?:\.\s*(?:Carta\s*de\s*San\s*Jua|J)n|\s*(?:Carta\s*de\s*San\s*Jua|J)n)|2(?:\.\s*(?:Carta\s*de\s*San\s*Jua|J)n|\s*(?:Carta\s*de\s*San\s*Jua|J)n)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(H(?:echos\s*de\s*los\s*Ap[oó]stoles|ch))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Carta\s*a\s*los\s*Romanos|Rom))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primera(?:\.\s*C(?:arta\s*a\s*los\s*Corintios|o)|\s*C(?:arta\s*a\s*los\s*Corintios|o))|1(?:\.\s*C(?:arta\s*a\s*los\s*Corintios|o)|\s*C(?:arta\s*a\s*los\s*Corintios|o))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segunda(?:\.\s*C(?:arta\s*a\s*los\s*Corintios|o)|\s*C(?:arta\s*a\s*los\s*Corintios|o))|2(?:\.\s*C(?:arta\s*a\s*los\s*Corintios|o)|\s*C(?:arta\s*a\s*los\s*Corintios|o))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(C(?:arta\s*a\s*los\s*Colosenses|ol))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Carta\s*a\s*los\s*G[aá]latas|G[aá]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Carta\s*a\s*los\s*Efesios|Ef))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Carta\s*a\s*los\s*Filipenses|Flp))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primera(?:\.\s*(?:Carta\s*a\s*los\s*Tesalonicenses|Te)|\s*(?:Carta\s*a\s*los\s*Tesalonicenses|Te))|1(?:\.\s*(?:Carta\s*a\s*los\s*Tesalonicenses|Te)|\s*(?:Carta\s*a\s*los\s*Tesalonicenses|Te))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segunda(?:\.\s*(?:Carta\s*a\s*los\s*Tesalonicenses|Te)|\s*(?:Carta\s*a\s*los\s*Tesalonicenses|Te))|2(?:\.\s*(?:Carta\s*a\s*los\s*Tesalonicenses|Te)|\s*(?:Carta\s*a\s*los\s*Tesalonicenses|Te))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Primera(?:\.\s*(?:Carta\s*a\s*Timoteo|Ti)|\s*(?:Carta\s*a\s*Timoteo|Ti))|1(?:\.\s*(?:Carta\s*a\s*Timoteo|Ti)|\s*(?:Carta\s*a\s*Timoteo|Ti))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Segunda(?:\.\s*(?:Carta\s*a\s*Timoteo|Ti)|\s*(?:Carta\s*a\s*Timoteo|Ti))|2(?:\.\s*(?:Carta\s*a\s*Timoteo|Ti)|\s*(?:Carta\s*a\s*Timoteo|Ti))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Carta\s*a\s*Tito|Tit))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Carta\s*a\s*Filem[oó]n|Flm))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Carta\s*a\s*los\s*Hebreos|Heb))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Carta\s*de\s*Santiago|Stg))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
