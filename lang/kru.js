var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["kru"];
    this.translations = [/KURUXBSI\b/gi];
    this.first = /1\.?\s*/;
    this.second = /2\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(दहद(?:र\s*म(?:ंजक(?:ा\s*कत(?:्‍था?|‍था?)|\s*कत(?:्‍था?|‍था?))|जक(?:ा\s*कत(?:्‍था?|‍था?)|\s*कत(?:्‍था?|‍था?))))?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मत(?:्त(?:ा?यो?स|ा)?|त(?:ा?यो?स|ा)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ल(?:ू?‍कस|ू?क))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1यॊ?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2यॊ?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\s*यॊ?हन|यॊ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*यॊ?हन|\s*यॊ?हन))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*यॊ?हन|\s*यॊ?हन))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ॊ?हनस|ॊ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त‍इ(?:रकर)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ोर(?:िन्?‍थ|न्?‍थ)|र(?:िन्?‍थ|न्?‍थ))|\s*क(?:ोर(?:िन्?‍थ|न्?‍थ)|र(?:िन्?‍थ|न्?‍थ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ोर(?:िन्?‍थ|न्?‍थ)|र(?:िन्?‍थ|न्?‍थ))|\s*क(?:ोर(?:िन्?‍थ|न्?‍थ)|र(?:िन्?‍थ|न्?‍थ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1क(?:ोरि?|रि?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2क(?:ोरि?|रि?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ोल(?:ो?स(?:्से?|से?)|ो)?|ल(?:ो?स(?:्से?|से?)|ो)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(गल(?:ा?त(?:िया?|या?)|ा)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इफ(?:े?सु?स|े)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:ेस(?:्‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))|‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर)))|स(?:्‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))|‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))))|\s*थ(?:ेस(?:्‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))|‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर)))|स(?:्‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))|‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:ेस(?:्‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))|‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर)))|स(?:्‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))|‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))))|\s*थ(?:ेस(?:्‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))|‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर)))|स(?:्‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))|‍सल(?:ोन(?:िकॆ?यर|कॆ?यर)|न(?:िकॆ?यर|कॆ?यर))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1थ(?:ेस्?‍स|स्?‍स))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2थ(?:ेस्?‍स|स्?‍स))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:ीम(?:ोथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|म(?:ोथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स)))|\s*त(?:ीम(?:ोथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|म(?:ोथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:ीम(?:ोथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|म(?:ोथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स)))|\s*त(?:ीम(?:ोथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|म(?:ोथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1त(?:ीमो?|मो?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2त(?:ीमो?|मो?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ॆ?मॊ?न|ॆ)?|ल(?:ॆ?मॊ?न|ॆ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
          ...
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ाक(?:ॊब?|ब)?|क(?:ॊब?|ब)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1पत)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2पत)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
