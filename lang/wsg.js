  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ఉజగ(?:ిర(?:ి\s*అ(?:ర(?:ుస(?:్వల్?|వల్?)|స(?:్వల్?|వల్?))|\.)|\s*అ(?:ర(?:ుస(?:్వల్?|వల్?)|స(?:్వల్?|వల్?))|\.))|ర(?:ి\s*అ(?:ర(?:ుస(?:్వల్?|వల్?)|స(?:్వల్?|వల్?))|\.)|\s*అ(?:ర(?:ుస(?:్వల్?|వల్?)|స(?:్వల్?|వల్?))|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(మత(?:్తయి?|తయి?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(మ(?:ార(?:్క్?|క్?)|ర(?:్క్?|క్?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(లూ?క)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1వ(?:\.\s*య(?:ోహన్?|హన్?)|\s*య(?:ోహన్?|హన్?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2వ(?:\.\s*య(?:ోహన్?|హన్?)|\s*య(?:ోహన్?|హన్?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3వ(?:\.\s*య(?:ోహన్?|హన్?)|\s*య(?:ోహన్?|హన్?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(య(?:ోహన్?|హన్?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(అప(?:ొ\.\s*కా?\.|\.\s*కా?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(రో?మ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1వ(?:\.\s*క(?:ొర(?:ంతి?|తి?)|ర(?:ంతి?|తి?))|\s*క(?:ొర(?:ంతి?|తి?)|ర(?:ంతి?|తి?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2వ(?:\.\s*క(?:ొర(?:ంతి?|తి?)|ర(?:ంతి?|తి?))|\s*క(?:ొర(?:ంతి?|తి?)|ర(?:ంతి?|తి?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(క(?:ొలసి?|లసి?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1వ(?:\.\s*త(?:ెసల(?:ొని?క|ని?క)|సల(?:ొని?క|ని?క))|\s*త(?:ెసల(?:ొని?క|ని?క)|సల(?:ొని?క|ని?క))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2వ(?:\.\s*త(?:ెసల(?:ొని?క|ని?క)|సల(?:ొని?క|ని?క))|\s*త(?:ెసల(?:ొని?క|ని?క)|సల(?:ొని?క|ని?క))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1వ(?:\.\s*త(?:ిమ(?:ొతి?|తి?)|మ(?:ొతి?|తి?))|\s*త(?:ిమ(?:ొతి?|తి?)|మ(?:ొతి?|తి?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2వ(?:\.\s*త(?:ిమ(?:ొతి?|తి?)|మ(?:ొతి?|తి?))|\s*త(?:ిమ(?:ొతి?|తి?)|మ(?:ొతి?|తి?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ప(?:ిల(?:ెమ(?:ోన్?|న్?)|మ(?:ోన్?|న్?))|ల(?:ెమ(?:ోన్?|న్?)|మ(?:ోన్?|న్?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(హ(?:ెబ(?:్రి?|రి?)|బ(?:్రి?|రి?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(య(?:ాక(?:ొబ్?|బ్?)|క(?:ొబ్?|బ్?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1వ(?:\.\s*ప(?:ేత(?:ురు?|రు?)|త(?:ురు?|రు?))|\s*ప(?:ేత(?:ురు?|రు?)|త(?:ురు?|రు?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2వ(?:\.\s*ప(?:ేత(?:ురు?|రు?)|త(?:ురు?|రు?))|\s*ప(?:ేత(?:ురు?|రు?)|త(?:ురు?|రు?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
