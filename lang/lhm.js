  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ॱस(?:ाल(?:्?‍क(?:ेत्?|त्?)|्)?|ल(?:्?‍क(?:ेत्?|त्?)|्)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मर(?:्क(?:ुस्?|स्?)?|क(?:ुस्?|स्?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*य(?:ुह(?:न(?:्‍ना?|‍ना?))?|ह(?:न(?:्‍ना?|‍ना?))?)|\s*य(?:ुह(?:न(?:्‍ना?|‍ना?))?|ह(?:न(?:्‍ना?|‍ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*य(?:ुह(?:न(?:्‍ना?|‍ना?))?|ह(?:न(?:्‍ना?|‍ना?))?)|\s*य(?:ुह(?:न(?:्‍ना?|‍ना?))?|ह(?:न(?:्‍ना?|‍ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(३(?:\.\s*य(?:ुह(?:न(?:्‍ना?|‍ना?))?|ह(?:न(?:्‍ना?|‍ना?))?)|\s*य(?:ुह(?:न(?:्‍ना?|‍ना?))?|ह(?:न(?:्‍ना?|‍ना?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ुह(?:न(?:्‍ना?|‍ना?))?|ह(?:न(?:्‍ना?|‍ना?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ठ(?:ीक(?:्?‍नल|्)?|क(?:्?‍नल|्)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(एफ(?:ी?सस्?|ी)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:ील(?:ी?प(?:्‍पी?|‍पी?)|ी)?|ल(?:ी?प(?:्‍पी?|‍पी?)|ी)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*थ(?:ीस(?:्‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?|‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?)|स(?:्‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?|‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?))|\s*थ(?:ीस(?:्‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?|‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?)|स(?:्‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?|‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*थ(?:ीस(?:्‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?|‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?)|स(?:्‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?|‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?))|\s*थ(?:ीस(?:्‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?|‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?)|स(?:्‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?|‍स(?:ल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?)))?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*त(?:ीम(?:ो(?:थी?)?|थी?)?|म(?:ो(?:थी?)?|थी?)?)|\s*त(?:ीम(?:ो(?:थी?)?|थी?)?|म(?:ो(?:थी?)?|थी?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*त(?:ीम(?:ो(?:थी?)?|थी?)?|म(?:ो(?:थी?)?|थी?)?)|\s*त(?:ीम(?:ो(?:थी?)?|थी?)?|म(?:ो(?:थी?)?|थी?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ीत(?:स्?)?|त(?:स्?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:ील(?:े?म(?:ोन्?|न्?)|े)?|ल(?:े?म(?:ोन्?|न्?)|े)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ह(?:ीब(?:्रु?|रु?)|ब(?:्रु?|रु?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
