var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["dty"];
    this.translations = [/D(?:TYNT|OTY)\b/gi];
    this.first = /१\.?\s*/;
    this.second = /२\.?\s*/;
    this.third = /३\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यू?ह)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र(?:े(?:र(?:ित?|त)?)?|र(?:ित?|त)?)?|र(?:े(?:र(?:ित?|त)?)?|र(?:ित?|त)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*क(?:ोर(?:ि?न(?:्थी?|थी?)|ि)?|र(?:ि?न(?:्थी?|थी?)|ि)?)|\s*क(?:ोर(?:ि?न(?:्थी?|थी?)|ि)?|र(?:ि?न(?:्थी?|थी?)|ि)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ोर(?:ि?न(?:्थी?|थी?)|ि)?|र(?:ि?न(?:्थी?|थी?)|ि)?)|\s*क(?:ोर(?:ि?न(?:्थी?|थी?)|ि)?|र(?:ि?न(?:्थी?|थी?)|ि)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*थ(?:ेस(?:ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?|स(?:ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?)|\s*थ(?:ेस(?:ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?|स(?:ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*थ(?:ेस(?:ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?|स(?:ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?)|\s*थ(?:ेस(?:ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?|स(?:ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
          ...
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*त(?:िम(?:ो(?:थ[िी]?)?|थ[िी]?)?|म(?:ो(?:थ[िी]?)?|थ[िी]?)?)|\s*त(?:िम(?:ो(?:थ[िी]?)?|थ[िी]?)?|म(?:ो(?:थ[िी]?)?|थ[िी]?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*त(?:िम(?:ो(?:थ[िी]?)?|थ[िी]?)?|म(?:ो(?:थ[िी]?)?|थ[िी]?)?)|\s*त(?:िम(?:ो(?:थ[िी]?)?|थ[िी]?)?|म(?:ो(?:थ[िी]?)?|थ[िी]?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
