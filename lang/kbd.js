var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["kbd"];
    this.translations = [/K(?:BDNTGP2017|ABBBL)\b/gi];
    this.first = /(?:1\.?\s*|Апостол\.?\s*)/;
    this.second = /(?:2\.?\s*|Апостол\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(1\s*Мусэ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Апок(?:алипсис|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ruth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Руфэ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Esth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Сэфирэт(?:\s*и\s*тхылъ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ps"],
            testament: "oa",
            testament_books: { Ps: "oa" },
            regexp: /(?:^|(?<=[^\p{L}]))(Уэрэд)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Prov"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Гъэс(?:эпэтхыдэхэр|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eccl"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ДжакӀуэ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Dan"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Данил)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jonah"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Инус)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(М(?:аттэ|т\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол\s*Петр\s*и\s*ещанэ\s*тхылъ|3\s*Ин\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол(?:\.\s*И(?:уан\s*и\s*япэ\s*тхылъ|н\.)|\s*И(?:уан\s*и\s*япэ\s*тхылъ|н\.))|1(?:\.\s*И(?:уан\s*и\s*япэ\s*тхылъ|н\.)|\s*И(?:уан\s*и\s*япэ\s*тхылъ|н\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол(?:\.\s*И(?:уан\s*и\s*етӀуанэ\s*тхылъ|н\.)|\s*И(?:уан\s*и\s*етӀуанэ\s*тхылъ|н\.))|2(?:\.\s*И(?:уан\s*и\s*етӀуанэ\s*тхылъ|н\.)|\s*И(?:уан\s*и\s*етӀуанэ\s*тхылъ|н\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(И(?:уан|н\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Апост(?:ол)?\.)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Фӏэщхъуныгъэ\s*яӀэу\s*Рим\s*къалэм\s*дэсхэм\s*апостол\s*Паул\s*яхуитха\s*тхылъ|Рим\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол\.?\s*Кор\.|1\.?\s*Кор\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол\.?\s*Кор\.|2\.?\s*Кор\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Фӏэщхъуныгъэ\s*яӀэу\s*Колоссэ\s*къалэм\s*дэсхэм\s*апостол\s*Паул\s*яхуитха\s*тхылъ|Кол\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Фӏэщхъуныгъэ\s*яӀэу\s*Галатие\s*хэкум\s*исхэм\s*апостол\s*Паул\s*яхуитха\s*тхылъ|Гал\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Фӏэщхъуныгъэ\s*яӀэу\s*Ефес\s*къалэм\s*дэсхэм\s*апостол\s*Паул\s*яхуитха\s*тхылъ|Еф\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ф(?:ӏэщхъуныгъэ\s*яӀэу\s*Филиппи\s*къалэм\s*дэсхэм\s*апостол\s*Паул\s*яхуитха\s*тхылъ|лп\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол\.?\s*Фес\.|1\.?\s*Фес\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол\.?\s*Фес\.|2\.?\s*Фес\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Фӏэщхъуныгъэ\s*яӀэу\s*Фессалоникэ\s*къалэм\s*дэсхэм\s*Паул\s*яхуитха\s*япэ\s*тхылъ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Фӏэщхъуныгъэ\s*яӀэу\s*Фессалоникэ\s*дэсхэм\s*апостол\s*Паул\s*яхуитха\s*етӀуанэ\s*тхылъ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол(?:\.\s*(?:Паул\s*Тимофе[ий]\s*хуитха\s*япэ\s*тхылъ|Тим\.)|\s*(?:Паул\s*Тимофе[ий]\s*хуитха\s*япэ\s*тхылъ|Тим\.))|1(?:\.\s*(?:Паул\s*Тимофе[ий]\s*хуитха\s*япэ\s*тхылъ|Тим\.)|\s*(?:Паул\s*Тимофе[ий]\s*хуитха\s*япэ\s*тхылъ|Тим\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол(?:\.\s*(?:Паул\s*Тимофе[ий]\s*хуитха\s*етӀуанэ\s*тхылъ|Тим\.)|\s*(?:Паул\s*Тимофе[ий]\s*хуитха\s*етӀуанэ\s*тхылъ|Тим\.))|2(?:\.\s*(?:Паул\s*Тимофе[ий]\s*хуитха\s*етӀуанэ\s*тхылъ|Тим\.)|\s*(?:Паул\s*Тимофе[ий]\s*хуитха\s*етӀуанэ\s*тхылъ|Тим\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Апостол\s*Паул\s*Тит\s*хуитха\s*тхылъ|Тит))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Апостол\s*Паул\s*Филимон\s*хуитха\s*тхылъ|Флм\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Евр(?:е[ий]хэм\s*яхуэгъэза\s*тхылъ|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Апостол\s*Екъуб\s*и\s*тхылъ|Ек\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол(?:\.\s*Пет[.р]|\s*Пет[.р])|1(?:\.\s*Пет[.р]|\s*Пет[.р])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Апостол(?:\.\s*Пет[.р]|\s*Пет[.р])|2(?:\.\s*Пет[.р]|\s*Пет[.р])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Иуд[.э])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
