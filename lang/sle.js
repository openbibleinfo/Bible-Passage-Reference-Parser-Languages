var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["sle"];
    this.translations = [/NTSRR23\b/gi];
    this.first = /1\.?\s*/;
    this.second = /2\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಪ(?:್ರಕಟನೆ?|ರಕಟನೆ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಮತ(?:್ತಾ?ಯ|ತಾ?ಯ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಮ(?:ಾರ್?ಕ|ರ್?ಕ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಲು?ಕ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ಯ(?:ೊಹಾ?ನ|ಹಾ?ನ)|\s*ಯ(?:ೊಹಾ?ನ|ಹಾ?ನ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ಯ(?:ೊಹಾ?ನ|ಹಾ?ನ)|\s*ಯ(?:ೊಹಾ?ನ|ಹಾ?ನ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*ಯ(?:ೊಹಾ?ನ|ಹಾ?ನ)|\s*ಯ(?:ೊಹಾ?ನ|ಹಾ?ನ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಯ(?:ೊಹಾ?ನ|ಹಾ?ನ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಅಪ(?:ೊಸ(?:್ತಲೊ?|ತಲೊ?)|ಸ(?:್ತಲೊ?|ತಲೊ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ರ(?:ೊಮ(?:ಾಪೂ?ರ|ಪೂ?ರ)?|ಮ(?:ಾಪೂ?ರ|ಪೂ?ರ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ಕ(?:ೊರ(?:ಿ(?:ಂಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?|ಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?)|ಂಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?|ಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?)|ರ(?:ಿ(?:ಂಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?|ಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?)|ಂಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?|ಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?))|\s*ಕ(?:ೊರ(?:ಿ(?:ಂಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?|ಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?)|ಂಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?|ಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?)|ರ(?:ಿ(?:ಂಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?|ಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?)|ಂಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?|ಥ(?:ವ(?:ಾಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))|ಲ(?:ಾವ(?:ೊನೆ?|ನೆ?)|ವ(?:ೊನೆ?|ನೆ?))))?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ಕ(?:ೊರ(?:ಿಂ?ಥ|ಂ?ಥ)|ರ(?:ಿಂ?ಥ|ಂ?ಥ))|\s*ಕ(?:ೊರ(?:ಿಂ?ಥ|ಂ?ಥ)|ರ(?:ಿಂ?ಥ|ಂ?ಥ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಕ(?:ೊಲ(?:ೆಸ(?:್ಸೆ?|ಸೆ?)|ಸ(?:್ಸೆ?|ಸೆ?))|ಲ(?:ೆಸ(?:್ಸೆ?|ಸೆ?)|ಸ(?:್ಸೆ?|ಸೆ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಗಲ(?:ಾತ್?ಯ|ತ್?ಯ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಎಫೆ?ಸ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಫ(?:ಿಲ(?:ಿಪ(?:್ಪಿ?|ಪಿ?)|ಪ(?:್ಪಿ?|ಪಿ?))|ಲ(?:ಿಪ(?:್ಪಿ?|ಪಿ?)|ಪ(?:್ಪಿ?|ಪಿ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ಥ(?:ೆಸಲ(?:ೊನಿ?ಕ|ನಿ?ಕ)|ಸಲ(?:ೊನಿ?ಕ|ನಿ?ಕ))|\s*ಥ(?:ೆಸಲ(?:ೊನಿ?ಕ|ನಿ?ಕ)|ಸಲ(?:ೊನಿ?ಕ|ನಿ?ಕ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ಥ(?:ೆಸಲ(?:ೊನಿ?ಕ|ನಿ?ಕ)|ಸಲ(?:ೊನಿ?ಕ|ನಿ?ಕ))|\s*ಥ(?:ೆಸಲ(?:ೊನಿ?ಕ|ನಿ?ಕ)|ಸಲ(?:ೊನಿ?ಕ|ನಿ?ಕ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ತ(?:ಿಮ(?:ೊತ(?:ಿ(?:ನೆ?)?|ನೆ?)?|ತ(?:ಿ(?:ನೆ?)?|ನೆ?)?)|ಮ(?:ೊತ(?:ಿ(?:ನೆ?)?|ನೆ?)?|ತ(?:ಿ(?:ನೆ?)?|ನೆ?)?))|\s*ತ(?:ಿಮ(?:ೊತ(?:ಿ(?:ನೆ?)?|ನೆ?)?|ತ(?:ಿ(?:ನೆ?)?|ನೆ?)?)|ಮ(?:ೊತ(?:ಿ(?:ನೆ?)?|ನೆ?)?|ತ(?:ಿ(?:ನೆ?)?|ನೆ?)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ತ(?:ಿಮ(?:ೊತಿ?|ತಿ?)|ಮ(?:ೊತಿ?|ತಿ?))|\s*ತ(?:ಿಮ(?:ೊತಿ?|ತಿ?)|ಮ(?:ೊತಿ?|ತಿ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ತ(?:ಿತನೆ?|ತನೆ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಫ(?:ಿಲ(?:ೊಮನ(?:ನೆ?)?|ಮನ(?:ನೆ?)?)|ಲ(?:ೊಮನ(?:ನೆ?)?|ಮನ(?:ನೆ?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಇಬ(?:್ರಿ?ಯ|ರಿ?ಯ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಯ(?:ಾಕೊ?ಬ|ಕೊ?ಬ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ಪ(?:ೆತ(?:್ರಾ?|ರಾ?)|ತ(?:್ರಾ?|ರಾ?))|\s*ಪ(?:ೆತ(?:್ರಾ?|ರಾ?)|ತ(?:್ರಾ?|ರಾ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ಪ(?:ೆತ(?:್ರಾ?|ರಾ?)|ತ(?:್ರಾ?|ರಾ?))|\s*ಪ(?:ೆತ(?:್ರಾ?|ರಾ?)|ತ(?:್ರಾ?|ರಾ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಯು?ದ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
