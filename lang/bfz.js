var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["bfz"];
    this.translations = [/B(?:FZ-|GH)NT\b/gi];
    this.first = /1\.?\s*/;
    this.second = /2\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*य(?:हुन्?ना?|ूहन(?:्(?:ना?)?|ना?)?|हन(?:्(?:ना?)?|ना?)?)|\s*य(?:हुन्?ना?|ूहन(?:्(?:ना?)?|ना?)?|हन(?:्(?:ना?)?|ना?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*य(?:हुन्?ना?|ूहन(?:्(?:ना?)?|ना?)?|हन(?:्(?:ना?)?|ना?)?)|\s*य(?:हुन्?ना?|ूहन(?:्(?:ना?)?|ना?)?|हन(?:्(?:ना?)?|ना?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*य(?:हुन्?ना?|ूहन(?:्(?:ना?)?|ना?)?|हन(?:्(?:ना?)?|ना?)?)|\s*य(?:हुन्?ना?|ूहन(?:्(?:ना?)?|ना?)?|हन(?:्(?:ना?)?|ना?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:हुन्?ना?|ूहन(?:्(?:ना?)?|ना?)?|हन(?:्(?:ना?)?|ना?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुर(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?)|ि?\.|ि)?|र(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?)|ि?\.|ि)?)|\s*क(?:ुर(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?)|ि?\.|ि)?|र(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?)|ि?\.|ि)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुर(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?)|ि?\.|ि)?|र(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?)|ि?\.|ि)?)|\s*क(?:ुर(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?)|ि?\.|ि)?|र(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)?)|ि?\.|ि)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ु(?:स(?:्?स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|्)?|\.)?|स(?:्?स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|्)?|\.)?|ल(?:ु(?:स(?:्?स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|्)?|\.)?|स(?:्?स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|्)?|\.)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(गल(?:ा(?:त(?:ि(?:य(?:ों?|ं)?)?|य(?:ों?|ं)?)?|\.)|त(?:ि(?:य(?:ों?|ं)?)?|य(?:ों?|ं)?)?|\.)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
          ...
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ि(?:प(?:्?प(?:ियो?|यो?)|्)?|\.)?|प(?:्?प(?:ियो?|यो?)|्)?|\.)?|ल(?:ि(?:प(?:्?प(?:ियो?|यो?)|्)?|\.)?|प(?:्?प(?:ियो?|यो?)|्)?|\.)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
          ...
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:[िी]तु?स|तु?स))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:े?मो?न|े?\.|े)?|ल(?:े?मो?न|े?\.|े)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
          ...
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यह(?:[ुू]दा?|दा?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
