var bcv_regexps = class {
  constructor() {
    ...
    this.first = /(?:Αʹ\.?\s*|Α\x27\.?\s*|Α’\.?\s*|Α΄\.?\s*|Αʹ\.?\s*|Αʹ\.?\s*)/;
    this.second = /(?:Βʹ\.?\s*|Β\x27\.?\s*|Β’\.?\s*|Β΄\.?\s*|Βʹ\.?\s*|Βʹ\.?\s*)/;
    this.third = /(?:Γʹ\.?\s*|Γ\x27\.?\s*|Γ’\.?\s*|Γ΄\.?\s*|Γʹ\.?\s*|Γʹ\.?\s*)/;
    this.range_and = /(?:[&\u2013\u2014-]|και\.?\s*|(?:\x2d\.?\s*|–\.?\s*|—\.?\s*))/;
    this.range_only = /(?:[\u2013\u2014-]|(?:\x2d\.?\s*|–\.?\s*|—\.?\s*))/;
    this.match_end_split = /\d\W*(?:(?:ο\s*τ[ίι]τλο[ςσ]|τ[ίι]τλο[ςσ]))|\d\W*(?:(?:και\s*μετά|και\s*μετα))(?:[\s*]*\.)?|\d[\s*]*(?:)|\x1e(?:[\s*]*[)\]\uff09])?|[\d\x1f]/gi;
    this.control = /[\x1e\x1f]/g;
    this.escaped_passage = /(?:^|[^\x1e\x1f\p{L}\p{N}])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—]|(?:ο\s*τίτλος\.?\s*|ο\s*τιτλος\.?\s*|ο\s*τίτλοσ\.?\s*|ο\s*τιτλοσ\.?\s*|τίτλος\.?\s*|τιτλος\.?\s*|τίτλοσ\.?\s*|τιτλοσ\.?\s*)(?![a-z])|(?:(?:κεφ(?:[άα]λαι(?:ον?|α))?\.?\s*)|(?:στ[ίι]χο[ιςσ]\.?\s*)|(?:και\s*μετ[άα]\.?\s*)|(?:και\.?\s*)|(?:[\-–—]\.?\s*))|(?!\w)|$)+)/giu;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["1Esd"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*[ΈΕ]σδρ?|\s*[ΈΕ]σδρ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Esd"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*[ΈΕ]σδρ?|\s*[ΈΕ]σδρ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Esd"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[ΈΕ]σδρας\s*Α['ʹʹ΄’]|Α['ʹʹ΄’]\s*[ΈΕ]σδ|1Esd))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Esd"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:[ΈΕ]σδρας\s*Β['ʹʹ΄’]|Β['ʹʹ΄’]\s*[ΈΕ]σδ|2Esd))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Esd"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*[ΈΕ]σδρας|\s*[ΈΕ]σδρας))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Esd"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*[ΈΕ]σδρας|\s*[ΈΕ]σδρας))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ezra"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))([ΈΕ]σδρας)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Isa"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Η(?:ΣΑ(?:[ΙΪ]́?ΑΣ|ΊΑΣ)|σα[ΐι]ας)|Isa|Ησ|Ἠσ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Sam"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*Σαμ(?:ου[ήη]λ)?|\s*Σαμ(?:ου[ήη]λ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Sam"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*Σαμ(?:ου[ήη]λ)?|\s*Σαμ(?:ου[ήη]λ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Sam"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:δυτικ[οό]ς\s*Σαμου[ήη]λ\s*Β['ʹʹ΄’]|Βασιλει[ωώ]ν\s*Β['ʹʹ΄’]|2Sam))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Sam"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:δυτικ[οό]ς\s*Σαμου[ήη]λ\s*Α['ʹʹ΄’]|Βασιλει[ωώ]ν\s*Α['ʹʹ΄’]|1Sam))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*Βα(?:σ(?:ιλ[έε]ων)?)?|\s*Βα(?:σ(?:ιλ[έε]ων)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*Βα(?:σ(?:ιλ[έε]ων)?)?|\s*Βα(?:σ(?:ιλ[έε]ων)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:δυτικ[οό]ς\s*Βασιλ[έε]ων\s*Β['ʹʹ΄’]|Βασιλει[ωώ]ν\s*Δ['ʹʹ΄’]|Β['ʹʹ΄’]\s*Βα|2Kgs))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Kgs"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:δυτικ[οό]ς\s*Βασιλ[έε]ων\s*Α['ʹʹ΄’]|Βασιλει[ωώ]ν\s*Γ['ʹʹ΄’]|Α['ʹʹ΄’]\s*Βα|1Kgs))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Chr"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*(?:Χρ(?:ον(?:ικ[ωώ]ν)?)?|Παρ?)|\s*(?:Χρ(?:ον(?:ικ[ωώ]ν)?)?|Παρ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Chr"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*(?:Χρ(?:ον(?:ικ[ωώ]ν)?)?|Παρ?)|\s*(?:Χρ(?:ον(?:ικ[ωώ]ν)?)?|Παρ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Chr"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:δυτικ[οό]ς\s*Χρονικ[ωώ]ν\s*Β['ʹʹ΄’]|Παραλειπομ[έε]νων\s*Β['ʹʹ΄’]|Χρονικ[ωώ]ν\s*Β['ʹʹ΄’]|Β['ʹʹ΄’]\s*Πα|2Chr))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Chr"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:δυτικ[οό]ς\s*Χρονικ[ωώ]ν\s*Α['ʹʹ΄’]|Παραλειπομ[έε]νων\s*Α['ʹʹ΄’]|Χρονικ[ωώ]ν\s*Α['ʹʹ΄’]|Α['ʹʹ΄’]\s*Πα|1Chr))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ezra"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ezra|[ΕἜ]σ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Neh"],
            testament: "o",
          ...
          },
          {
            osis: ["Mic"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Μ(?:ΙΧΑ(?:[ΙΪ]́?ΑΣ|ΊΑΣ)|ιχα[ΐίι]ας|χ)|Mic))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Song"],
            testament: "o",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*(?:Ιω(?:[άα]ννη)?|᾿Ιω)|\s*(?:Ιω(?:[άα]ννη)?|᾿Ιω)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*(?:Ιω(?:[άα]ννη)?|᾿Ιω)|\s*(?:Ιω(?:[άα]ννη)?|᾿Ιω)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Γ['ʹʹ΄’](?:\.\s*(?:Ιω(?:[άα]ννη)?|᾿Ιω)|\s*(?:Ιω(?:[άα]ννη)?|᾿Ιω)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ιω(?:αννου\s*(?:(?:Επιστολη\s*Α|Α['ʹʹ΄’])|Α)|άννου\s*Α['ʹʹ΄’])|Α['ʹʹ΄’]\s*(?:Ιω[άα]ννη|᾿Ιω)|1John))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ιω(?:αννου\s*(?:(?:Επιστολη\s*Β|Β['ʹʹ΄’])|Β)|άννου\s*Β['ʹʹ΄’])|Β['ʹʹ΄’]\s*(?:Ιω[άα]ννη|᾿Ιω)|2John))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ιω(?:αννου\s*(?:(?:Επιστολη\s*Γ|Γ['ʹʹ΄’])|Γ)|άννου\s*Γ['ʹʹ΄’])|Γ['ʹʹ΄’]\s*(?:Ιω[άα]ννη|᾿Ιω)|3John))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*Κο(?:ρ(?:ινθ[ίι]ους)?)?|\s*Κο(?:ρ(?:ινθ[ίι]ους)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*Κο(?:ρ(?:ινθ[ίι]ους)?)?|\s*Κο(?:ρ(?:ινθ[ίι]ους)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Προς\s*Κορινθ(?:ιους\s*Β(?:['ʹʹ΄’])?|ίους\s*Β['ʹʹ΄’])|Β['ʹʹ΄’]\s*Κορινθ[ίι]ους|Β['ʹʹ΄’]\s*Κο|2Cor))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Προς\s*Κορινθ(?:ιους\s*Α(?:['ʹʹ΄’])?|ίους\s*Α['ʹʹ΄’])|Α['ʹʹ΄’]\s*Κορινθ[ίι]ους|Α['ʹʹ΄’]\s*Κο|1Cor))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*Θε(?:σ(?:σαλονικε[ίι]ς)?)?|\s*Θε(?:σ(?:σαλονικε[ίι]ς)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*Θε(?:σ(?:σαλονικε[ίι]ς)?)?|\s*Θε(?:σ(?:σαλονικε[ίι]ς)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Προς\s*Θεσσαλονικε(?:ις\s*Β(?:['ʹʹ΄’])?|ίς\s*Β['ʹʹ΄’])|Β['ʹʹ΄’]\s*Θεσσαλονικε[ίι]ς|2Thess|Β['ʹʹ΄’]\s*Θε))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Προς\s*Θεσσαλονικε(?:ις\s*Α(?:['ʹʹ΄’])?|ίς\s*Α['ʹʹ΄’])|Α['ʹʹ΄’]\s*Θεσσαλονικε[ίι]ς|1Thess|Α['ʹʹ΄’]\s*Θε))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*Τι(?:μ(?:[οό]θεο)?)?|\s*Τι(?:μ(?:[οό]θεο)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*Τι(?:μ(?:[οό]θεο)?)?|\s*Τι(?:μ(?:[οό]θεο)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Προς\s*Τιμ(?:οθεον\s*Β(?:['ʹʹ΄’])?|όθεον\s*Β['ʹʹ΄’])|Β['ʹʹ΄’]\s*Τιμ[οό]θεο|Β['ʹʹ΄’]\s*Τι|2Tim))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Προς\s*Τιμ(?:οθεον\s*Α(?:['ʹʹ΄’])?|όθεον\s*Α['ʹʹ΄’])|Α['ʹʹ΄’]\s*Τιμ[οό]θεο|Α['ʹʹ΄’]\s*Τι|1Tim))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*Π[έε](?:τ(?:ρ(?:ου)?)?)?|\s*Π[έε](?:τ(?:ρ(?:ου)?)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*Π[έε](?:τ(?:ρ(?:ου)?)?)?|\s*Π[έε](?:τ(?:ρ(?:ου)?)?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Π(?:ετρου\s*(?:(?:Επιστολη\s*Β|Β['ʹʹ΄’])|Β)|έτρου\s*Β['ʹʹ΄’])|Β['ʹʹ΄’]\s*Π[έε]τρου|Β['ʹʹ΄’]\s*Πε|2Pet))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Π(?:ετρου\s*(?:(?:Επιστολη\s*Α|Α['ʹʹ΄’])|Α)|έτρου\s*Α['ʹʹ΄’])|Α['ʹʹ΄’]\s*Π[έε]τρου|Α['ʹʹ΄’]\s*Πε|1Pet))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
          ...
          },
          {
            osis: ["1Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Α['ʹʹ΄’](?:\.\s*Μακκ(?:αβα[ίι]ων)?|\s*Μακκ(?:αβα[ίι]ων)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Β['ʹʹ΄’](?:\.\s*Μακκ(?:αβα[ίι]ων)?|\s*Μακκ(?:αβα[ίι]ων)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Γ['ʹʹ΄’](?:\.\s*Μακκ(?:αβα[ίι]ων)?|\s*Μακκ(?:αβα[ίι]ων)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["4Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Δ['ʹʹ΄’](?:\.\s*Μακκ(?:αβα[ίι]ων)?|\s*Μακκ(?:αβα[ίι]ων)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Μακκαβα[ίι]ων\s*Β['ʹʹ΄’]|Β['ʹʹ΄’]\s*Μακκ|2Macc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Μακκαβα[ίι]ων\s*Γ['ʹʹ΄’]|Γ['ʹʹ΄’]\s*Μακκ|3Macc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["4Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Μακκαβα[ίι]ων\s*Δ['ʹʹ΄’]|Δ['ʹʹ΄’]\s*Μακκ|4Macc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Macc"],
            testament: "a",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Μακκαβα[ίι]ων\s*Α['ʹʹ΄’]|Α['ʹʹ΄’]\s*Μακκ|1Macc))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
...
var bcv_grammar_options_default = {
  ab: /^(?:[a-e])(?!\p{L})/iu,
  and: /^(?:(?:(?:και\.?\s*)|&))/i,
  c_explicit: /^[\s*]*(?:(?:κεφ(?:[άα]λαι(?:ον?|α))?\.?\s*))[\s*]*/i,
  c_sep_eu: /^\x1f\x1f\x1f/i,
  c_sep_us: /^\x1f\x1f\x1f/i,
  cv_sep_weak: /^(?:[\s*]*["'][\s*]*|[\s*])+/i,
  cv_sep_eu: /^[\s*]*,+[\s*]*/i,
  cv_sep_us: /^[\s*]*(?::+|\.(?!\s*\.\s*\.))[\s*]*/i,
  ff: /^[\s*]*(?:(?:και\s+μετ[άα]\.?\s*))(?![\p{L}\p{N}])(?:\.(?!\s*\.))?/iu,
  in_book_of: /^[\s*]*(?:from|of|in)[\s*]*(?:the[\s*]*book[\s*]*of[\s*]*)?/i,
  next: /^(?:\x1f\x1f\x1f)/i,
  ordinal: /^(?:th|st|nd|rd)/i,
  range: /^[\s*]*(?:[\-–—]|(?:[\-–—]\.?\s*))+[\s*]*/i,
  sequence_eu: /^(?:[;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|(?:και\.?\s*))+/i,
  sequence_us: /^(?:[,;/:&\-–—~\s*]|\.(?!\s*\.\s*\.)|(?:και\.?\s*))+/i,
  space: /^[\s*]+/,
  title: /^[\s*]*(?:(?:(?:ο\s+τ[ίι]τλο[ςσ]|τ[ίι]τλο[ςσ])\.?\s*))(?!\p{L})[\s*]*/iu,
  v_explicit: /^[\s*]*(?:(?:στ[ίι]χο[ιςσ]\.?\s*))[\s*]*(?!\p{L})/iu
};
