  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ល(?:ោក(?:ុប(?:្បត(?:្តិ?|តិ?)|បត(?:្តិ?|តិ?))|ប(?:្បត(?:្តិ?|តិ?)|បត(?:្តិ?|តិ?)))|ក(?:ុប(?:្បត(?:្តិ?|តិ?)|បត(?:្តិ?|តិ?))|ប(?:្បត(?:្តិ?|តិ?)|បត(?:្តិ?|តិ?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(វ(?:ិវរណៈ?|វរណៈ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ruth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ន(?:ាងរស់?|ងរស់?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jonah"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:៉(?:ូណា?ស|ណា?ស)|ូណា?ស|ណា?ស))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ម(?:៉(?:ាកុ?ស|កុ?ស)|ាកុ?ស|កុ?ស))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(៣យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:៉(?:ូហា?ន|ហា?ន)|ូហា?ន|ហា?ន))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ក(?:ិច(?:្ចកា?រ|ចកា?រ)|ច(?:្ចកា?រ|ចកា?រ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១ក(?:ូរ(?:ិនថូ?ស|នថូ?ស)|រ(?:ិនថូ?ស|នថូ?ស)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ក(?:ូរ(?:ិនថូ?ស|នថូ?ស)|រ(?:ិនថូ?ស|នថូ?ស)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ក(?:ូឡូ?ស|ឡូ?ស))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(អ(?:េភ(?:េស(?:ូរ៍?|រ៍?)|ស(?:ូរ៍?|រ៍?))|ភ(?:េស(?:ូរ៍?|រ៍?)|ស(?:ូរ៍?|រ៍?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ភ(?:ីលី?ព|លី?ព))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១ថ(?:ែស(?:្ស(?:ាឡ(?:ូនី?ច|នី?ច)|ឡ(?:ូនី?ច|នី?ច))|ស(?:ាឡ(?:ូនី?ច|នី?ច)|ឡ(?:ូនី?ច|នី?ច)))|ស(?:្ស(?:ាឡ(?:ូនី?ច|នី?ច)|ឡ(?:ូនី?ច|នី?ច))|ស(?:ាឡ(?:ូនី?ច|នី?ច)|ឡ(?:ូនី?ច|នី?ច)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ថ(?:ែស(?:្ស(?:ាឡ(?:ូនី?ច|នី?ច)|ឡ(?:ូនី?ច|នី?ច))|ស(?:ាឡ(?:ូនី?ច|នី?ច)|ឡ(?:ូនី?ច|នី?ច)))|ស(?:្ស(?:ាឡ(?:ូនី?ច|នី?ច)|ឡ(?:ូនី?ច|នី?ច))|ស(?:ាឡ(?:ូនី?ច|នី?ច)|ឡ(?:ូនី?ច|នី?ច)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១ធ(?:ីម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?)|ម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ធ(?:ីម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?)|ម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ទ(?:ីតុ?ស|តុ?ស))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ហ(?:េព(?:្រ(?:ើរ៍?|រ៍?)|រ(?:ើរ៍?|រ៍?))|ព(?:្រ(?:ើរ៍?|រ៍?)|រ(?:ើរ៍?|រ៍?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១ព(?:េត(?:្រុ?ស|រុ?ស)|ត(?:្រុ?ស|រុ?ស)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ព(?:េត(?:្រុ?ស|រុ?ស)|ត(?:្រុ?ស|រុ?ស)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:ូដា?ស|ដា?ស))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
