var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["thl"];
    this.translations = [/(?:DVGNT|THL)\b/gi];
    this.first = /१\.?\s*/;
    this.second = /२\.?\s*/;
    this.third = /३\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्रक(?:ा[.श]?|[.श])?|रक(?:ा[.श]?|[.श])?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मर(?:्क(?:ू[.स]|[.स])?|क(?:ू[.स]|[.स])?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*य(?:ूह(?:न(?:्?‍ना?|्?ना?)|\.)?|ह(?:न(?:्?‍ना?|्?ना?)|\.)?)|\s*य(?:ूह(?:न(?:्?‍ना?|्?ना?)|\.)?|ह(?:न(?:्?‍ना?|्?ना?)|\.)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*य(?:ूह(?:न(?:्?‍ना?|्?ना?)|\.)?|ह(?:न(?:्?‍ना?|्?ना?)|\.)?)|\s*य(?:ूह(?:न(?:्?‍ना?|्?ना?)|\.)?|ह(?:न(?:्?‍ना?|्?ना?)|\.)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(३(?:\.\s*य(?:ूह(?:न(?:्?‍ना?|्?ना?)|\.)?|ह(?:न(?:्?‍ना?|्?ना?)|\.)?)|\s*य(?:ूह(?:न(?:्?‍ना?|्?ना?)|\.)?|ह(?:न(?:्?‍ना?|्?ना?)|\.)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ूह(?:न(?:्?‍ना?|्?ना?)|\.)?|ह(?:न(?:्?‍ना?|्?ना?)|\.)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:न(?:िउत(?:\.\s*का?\.|रह(?:्या?|या?))|उत(?:\.\s*का?\.|रह(?:्या?|या?)))|प(?:(?:्रे?रि?त|रे?रि?त)|(?:्रे?|रे?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ि?प(?:्पी?|पी?)|ि?\.|ि)?|ल(?:ि?प(?:्पी?|पी?)|ि?\.|ि)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
          ...
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ीत[.स]?|त[.स]?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*पत(?:्र(?:ु[.स]|[.स])?|र(?:ु[.स]|[.स])?)|\s*पत(?:्र(?:ु[.स]|[.स])?|र(?:ु[.स]|[.स])?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*पत(?:्र(?:ु[.स]|[.स])?|र(?:ु[.स]|[.स])?)|\s*पत(?:्र(?:ु[.स]|[.स])?|र(?:ु[.स]|[.स])?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
