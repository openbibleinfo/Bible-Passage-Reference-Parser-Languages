  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(வ(?:ெள(?:ி?\.\s*க(?:ார(?:ியக(?:ோளு?|ளு?)|யக(?:ோளு?|ளு?))|ர(?:ியக(?:ோளு?|ளு?)|யக(?:ோளு?|ளு?)))|ி)?|ள(?:ி?\.\s*க(?:ார(?:ியக(?:ோளு?|ளு?)|யக(?:ோளு?|ளு?))|ர(?:ியக(?:ோளு?|ளு?)|யக(?:ோளு?|ளு?)))|ி)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(மத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ல(?:ூக(?:்கா?|கா?)|க(?:்கா?|கா?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ய(?:ோவ(?:ானு?|னு?)|வ(?:ானு?|னு?))|\s*ய(?:ோவ(?:ானு?|னு?)|வ(?:ானு?|னு?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ய(?:ோவ(?:ானு?|னு?)|வ(?:ானு?|னு?))|\s*ய(?:ோவ(?:ானு?|னு?)|வ(?:ானு?|னு?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*ய(?:ோவ(?:ானு?|னு?)|வ(?:ானு?|னு?))|\s*ய(?:ோவ(?:ானு?|னு?)|வ(?:ானு?|னு?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ய(?:ோவ(?:ானு?|னு?)|வ(?:ானு?|னு?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(வ(?:ி\.த(?:ூ\.(?:\s*க(?:ெலசக(?:ோளு?|ளு?)|லசக(?:ோளு?|ளு?))|க(?:ெலசக(?:ோளு?|ளு?)|லசக(?:ோளு?|ளு?)))|\.(?:\s*க(?:ெலசக(?:ோளு?|ளு?)|லசக(?:ோளு?|ளு?))|க(?:ெலசக(?:ோளு?|ளு?)|லசக(?:ோளு?|ளு?))))|\.த(?:ூ\.(?:\s*க(?:ெலசக(?:ோளு?|ளு?)|லசக(?:ோளு?|ளு?))|க(?:ெலசக(?:ோளு?|ளு?)|லசக(?:ோளு?|ளு?)))|\.(?:\s*க(?:ெலசக(?:ோளு?|ளு?)|லசக(?:ோளு?|ளு?))|க(?:ெலசக(?:ோளு?|ளு?)|லசக(?:ோளு?|ளு?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ர(?:ோமரு?|மரு?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*க(?:ொர(?:ி?ந(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|ி)?|ர(?:ி?ந(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|ி)?)|\s*க(?:ொர(?:ி?ந(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|ி)?|ர(?:ி?ந(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|ி)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*க(?:ொர(?:ி?ந(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|ி)?|ர(?:ி?ந(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|ி)?)|\s*க(?:ொர(?:ி?ந(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|ி)?|ர(?:ி?ந(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|ி)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(க(?:ொல(?:ோச(?:ெயரு?|யரு?)|ச(?:ெயரு?|யரு?))|ல(?:ோச(?:ெயரு?|யரு?)|ச(?:ெயரு?|யரு?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(கல(?:ாத(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))|த(?:்த(?:ியரு?|யரு?)|த(?:ியரு?|யரு?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(எப(?:ேச(?:ியரு?|யரு?)|ச(?:ியரு?|யரு?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ப(?:ில(?:ிப(?:்ப(?:ியரு?|யரு?)|ப(?:ியரு?|யரு?))|ப(?:்ப(?:ியரு?|யரு?)|ப(?:ியரு?|யரு?)))|ல(?:ிப(?:்ப(?:ியரு?|யரு?)|ப(?:ியரு?|யரு?))|ப(?:்ப(?:ியரு?|யரு?)|ப(?:ியரு?|யரு?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*த(?:ெசல(?:ோன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))|ன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)))|சல(?:ோன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))|ன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))))|\s*த(?:ெசல(?:ோன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))|ன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)))|சல(?:ோன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))|ன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*த(?:ெசல(?:ோன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))|ன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)))|சல(?:ோன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))|ன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))))|\s*த(?:ெசல(?:ோன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))|ன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)))|சல(?:ோன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))|ன(?:ிக(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர)|க(?:்க(?:ேயா?|யா?)|ே?யரு|க(?:ேயா?|யா?)|ே?யர))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*த(?:ீம(?:ோத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))|த(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?)))|ம(?:ோத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))|த(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))))|\s*த(?:ீம(?:ோத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))|த(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?)))|ம(?:ோத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))|த(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*த(?:ீம(?:ோத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))|த(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?)))|ம(?:ோத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))|த(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))))|\s*த(?:ீம(?:ோத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))|த(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?)))|ம(?:ோத(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))|த(?:்த(?:ேயு?|யு?)|த(?:ேயு?|யு?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(த(?:ீத(?:்து?|து?)|த(?:்து?|து?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ப(?:ில(?:ேம(?:ோனு?|னு?)|ம(?:ோனு?|னு?))|ல(?:ேம(?:ோனு?|னு?)|ம(?:ோனு?|னு?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(எப(?:ிர(?:ெயரு?|யரு?)|ர(?:ெயரு?|யரு?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ய(?:ாக(?:்க(?:ோபு?|பு?)|க(?:ோபு?|பு?))|க(?:்க(?:ோபு?|பு?)|க(?:ோபு?|பு?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
