var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["mev"];
    this.translations = [/M(?:HB|NT)\b/gi];
    this.first = /1\.?\s*/;
    this.second = /2\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Wɛ(?:̀lɛ(?:̀v[eè]l[eé]sɔ(?:̃̀?|̀)?|v[eè]l[eé]sɔ(?:̃̀?|̀)?)|lɛ(?:̀v[eè]l[eé]sɔ(?:̃̀?|̀)?|v[eè]l[eé]sɔ(?:̃̀?|̀)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ruth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(W[uú]l[uú](?:f[eè])?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jonah"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Z[oó](?:n[aà])?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(M[aá]f[iì][uù])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(L[uú][uù])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*Zɔ(?:̃(?:̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|\s*Zɔ(?:̃(?:̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*Zɔ(?:̃(?:̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|\s*Zɔ(?:̃(?:̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*Zɔ(?:̃(?:̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|\s*Zɔ(?:̃(?:̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Zɔ(?:̃(?:̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?)|̀ɔ(?:̃́?|́)?|ɔ(?:̃́?|́)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([AÀ]pɔ(?:́sɔ(?:̀lɔ̀?|lɔ̀?)|sɔ(?:̀lɔ̀?|lɔ̀?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(W[oó]l[oó]m[aà])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*Kɔ(?:̀l[eé][iĩ](?:́t[iĩ](?:̀[aã]̀?|[aã]̀?)|t[iĩ](?:̀[aã]̀?|[aã]̀?))|l[eé][iĩ](?:́t[iĩ](?:̀[aã]̀?|[aã]̀?)|t[iĩ](?:̀[aã]̀?|[aã]̀?)))|\s*Kɔ(?:̀l[eé][iĩ](?:́t[iĩ](?:̀[aã]̀?|[aã]̀?)|t[iĩ](?:̀[aã]̀?|[aã]̀?))|l[eé][iĩ](?:́t[iĩ](?:̀[aã]̀?|[aã]̀?)|t[iĩ](?:̀[aã]̀?|[aã]̀?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*Kɔ(?:̀l[eé][iĩ](?:́t[iĩ](?:̀[aã]̀?|[aã]̀?)|t[iĩ](?:̀[aã]̀?|[aã]̀?))|l[eé][iĩ](?:́t[iĩ](?:̀[aã]̀?|[aã]̀?)|t[iĩ](?:̀[aã]̀?|[aã]̀?)))|\s*Kɔ(?:̀l[eé][iĩ](?:́t[iĩ](?:̀[aã]̀?|[aã]̀?)|t[iĩ](?:̀[aã]̀?|[aã]̀?))|l[eé][iĩ](?:́t[iĩ](?:̀[aã]̀?|[aã]̀?)|t[iĩ](?:̀[aã]̀?|[aã]̀?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Kɔ(?:̀lɔ(?:́s[iĩ][aã]̀?|s[iĩ][aã]̀?)|lɔ(?:́s[iĩ][aã]̀?|s[iĩ][aã]̀?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Gɛ(?:̀l[eé]s[iì][aà]|l[eé]s[iì][aà]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([IÌ]f[ií]sɔ(?:̃̀?|̀)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F[eè]l[eé]p[iĩ](?:̀[aã]̀?|[aã]̀?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*Tɛs[aà]l[oó]n[iì][aà]|\s*Tɛs[aà]l[oó]n[iì][aà]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*Tɛs[aà]l[oó]n[iì][aà]|\s*Tɛs[aà]l[oó]n[iì][aà]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*T[eé]mɔ(?:́t[eè]|t[eè])|\s*T[eé]mɔ(?:́t[eè]|t[eè])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*T[eé]mɔ(?:́t[eè]|t[eè])|\s*T[eé]mɔ(?:́t[eè]|t[eè])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F[aà]l[ií]m[aà])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(H[ií][ií]b[uú]l[uù])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Z[iĩ](?:́[iĩ]̀?|[iĩ]̀?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*P[ií]lɛ̀?|\s*P[ií]lɛ̀?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*P[ií]lɛ̀?|\s*P[ií]lɛ̀?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Z[uú]d[eè])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
