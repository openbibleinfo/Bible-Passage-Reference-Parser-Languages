var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["aoj"];
    this.translations = [/AOJ[FM]\b/gi];
    this.first = /(?:1\.?\s*|Faliꞌ\.?\s*)/;
    this.second = /(?:2\.?\s*|Fagiꞌ\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Kamapim\s*Tok\s*Hait|Re(?:velesen)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(M(?:atyu(?:\s*Nandaꞌafi)?|t))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(M(?:ak(?:\s*Nandaꞌafi)?|k))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Lu(?:k(?:\s*Nandaꞌafi)?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Jo(?:n(?:\s*Nandaꞌafi)?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Faliꞌ(?:\.\s*Jon?|\s*Jon?)|1(?:\.\s*Jon?|\s*Jon?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fagiꞌ(?:\.\s*Jon?|\s*Jon?)|2(?:\.\s*Jon?|\s*Jon?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*Jon?|\s*Jon?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Maol\s*Amom\s*Aposeli|Ap(?:osel)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Fagafeꞌma\s*Esis\s*Romi|Rom?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Faliꞌ(?:\.\s*(?:Fagafeꞌma\s*Esis\s*Korini|Ko(?:rin)?)|\s*(?:Fagafeꞌma\s*Esis\s*Korini|Ko(?:rin)?))|1(?:\.\s*(?:Fagafeꞌma\s*Esis\s*Korini|Ko(?:rin)?)|\s*(?:Fagafeꞌma\s*Esis\s*Korini|Ko(?:rin)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fagiꞌ(?:\.\s*(?:Fagafeꞌma\s*Esis\s*Korini|Ko(?:rin)?)|\s*(?:Fagafeꞌma\s*Esis\s*Korini|Ko(?:rin)?))|2(?:\.\s*(?:Fagafeꞌma\s*Esis\s*Korini|Ko(?:rin)?)|\s*(?:Fagafeꞌma\s*Esis\s*Korini|Ko(?:rin)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Fagafeꞌma\s*Esis\s*Kolosi|K(?:olosi|l)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Fagafeꞌma\s*Esis\s*Galesiai|Ga(?:lesia)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Fagafeꞌma\s*Esis\s*Efesusi|Ef(?:esus)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F(?:agafeꞌma\s*Esis\s*Filipaii|ilipai|l))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Faliꞌ(?:\.\s*(?:Fagafeꞌma\s*Tesalonaikai|Te(?:salonaika)?)|\s*(?:Fagafeꞌma\s*Tesalonaikai|Te(?:salonaika)?))|1(?:\.\s*(?:Fagafeꞌma\s*Tesalonaikai|Te(?:salonaika)?)|\s*(?:Fagafeꞌma\s*Tesalonaikai|Te(?:salonaika)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fagiꞌ(?:\.\s*(?:Fagafeꞌma\s*Tesalonaikai|Te(?:salonaika)?)|\s*(?:Fagafeꞌma\s*Tesalonaikai|Te(?:salonaika)?))|2(?:\.\s*(?:Fagafeꞌma\s*Tesalonaikai|Te(?:salonaika)?)|\s*(?:Fagafeꞌma\s*Tesalonaikai|Te(?:salonaika)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Faliꞌ(?:\.\s*(?:Fagafeꞌma\s*Timotii|Ti(?:moti)?)|\s*(?:Fagafeꞌma\s*Timotii|Ti(?:moti)?))|1(?:\.\s*(?:Fagafeꞌma\s*Timotii|Ti(?:moti)?)|\s*(?:Fagafeꞌma\s*Timotii|Ti(?:moti)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fagiꞌ(?:\.\s*(?:Fagafeꞌma\s*Timotii|Ti(?:moti)?)|\s*(?:Fagafeꞌma\s*Timotii|Ti(?:moti)?))|2(?:\.\s*(?:Fagafeꞌma\s*Timotii|Ti(?:moti)?)|\s*(?:Fagafeꞌma\s*Timotii|Ti(?:moti)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Fagafeꞌma\s*Taitusi|Ta(?:itus)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F(?:agafeꞌma\s*Filemoni|ilemon|m))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Hi(?:brui?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Faliꞌ(?:\.\s*Pi(?:ta)?|\s*Pi(?:ta)?)|1(?:\.\s*Pi(?:ta)?|\s*Pi(?:ta)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Fagiꞌ(?:\.\s*Pi(?:ta)?|\s*Pi(?:ta)?)|2(?:\.\s*Pi(?:ta)?|\s*Pi(?:ta)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
