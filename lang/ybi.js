  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(परक(?:ास?|स)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मत(?:्‍ति?|‍ति?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ए(?:प(?:्‍प(?:ा\s*च(?:ोङ(?:्‌सा?|‌सा?)|ङ(?:्‌सा?|‌सा?))|\s*च(?:ोङ(?:्‌सा?|‌सा?)|ङ(?:्‌सा?|‌सा?)))|‍प(?:ा\s*च(?:ोङ(?:्‌सा?|‌सा?)|ङ(?:्‌सा?|‌सा?))|\s*च(?:ोङ(?:्‌सा?|‌सा?)|ङ(?:्‌सा?|‌सा?))))|\.चो?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*क(?:ोर(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))?|र(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))?)|\s*क(?:ोर(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))?|र(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ोर(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))?|र(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))?)|\s*क(?:ोर(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))?|र(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(कल(?:स(?:्‍सि?|‍सि?))?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*पत(?:्‍र(?:ुस?|स)?|‍र(?:ुस?|स)?)|\s*पत(?:्‍र(?:ुस?|स)?|‍र(?:ुस?|स)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*पत(?:्‍र(?:ुस?|स)?|‍र(?:ुस?|स)?)|\s*पत(?:्‍र(?:ुस?|स)?|‍र(?:ुस?|स)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
