  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(दरस(?:ाव?|व)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*यह(?:ून(?:्ना?|ना?)|न(?:्ना?|ना?))?|\s*यह(?:ून(?:्ना?|ना?)|न(?:्ना?|ना?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*यह(?:ून(?:्ना?|ना?)|न(?:्ना?|ना?))?|\s*यह(?:ून(?:्ना?|ना?)|न(?:्ना?|ना?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*यह(?:ून(?:्ना?|ना?)|न(?:्ना?|ना?))?|\s*यह(?:ून(?:्ना?|ना?)|न(?:्ना?|ना?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(का?म)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(रो?म)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुरन(?:्थ(?:ी(?:यो?)?|यो?)?|थ(?:ी(?:यो?)?|यो?)?)|रन(?:्थ(?:ी(?:यो?)?|यो?)?|थ(?:ी(?:यो?)?|यो?)?))|\s*क(?:ुरन(?:्थ(?:ी(?:यो?)?|यो?)?|थ(?:ी(?:यो?)?|यो?)?)|रन(?:्थ(?:ी(?:यो?)?|यो?)?|थ(?:ी(?:यो?)?|यो?)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुरन(?:्थ(?:ी(?:यो?)?|यो?)?|थ(?:ी(?:यो?)?|यो?)?)|रन(?:्थ(?:ी(?:यो?)?|यो?)?|थ(?:ी(?:यो?)?|यो?)?))|\s*क(?:ुरन(?:्थ(?:ी(?:यो?)?|यो?)?|थ(?:ी(?:यो?)?|यो?)?)|रन(?:्थ(?:ी(?:यो?)?|यो?)?|थ(?:ी(?:यो?)?|यो?)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(कल(?:ु?स(?:ीयो?|यो?)|ु)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(गल(?:ात(?:ि(?:यो?)?|यो?)?|त(?:ि(?:यो?)?|यो?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
          ...
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फल(?:ि(?:पी?)?|पी?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:िसल(?:ू?न(?:िकी?|की?)|ू)?|सल(?:ू?न(?:िकी?|की?)|ू)?)|\s*थ(?:िसल(?:ू?न(?:िकी?|की?)|ू)?|सल(?:ू?न(?:िकी?|की?)|ू)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:िसल(?:ू?न(?:िकी?|की?)|ू)?|सल(?:ू?न(?:िकी?|की?)|ू)?)|\s*थ(?:िसल(?:ू?न(?:िकी?|की?)|ू)?|सल(?:ू?न(?:िकी?|की?)|ू)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:िम(?:ू?त(?:ियू?स|यू?स)|ू)?|म(?:ू?त(?:ियू?स|यू?स)|ू)?)|\s*त(?:िम(?:ू?त(?:ियू?स|यू?स)|ू)?|म(?:ू?त(?:ियू?स|यू?स)|ू)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:िम(?:ू?त(?:ियू?स|यू?स)|ू)?|म(?:ू?त(?:ियू?स|यू?स)|ू)?)|\s*त(?:िम(?:ू?त(?:ियू?स|यू?स)|ू)?|म(?:ू?त(?:ियू?स|यू?स)|ू)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इबर(?:ा?नी?आ|ा)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
