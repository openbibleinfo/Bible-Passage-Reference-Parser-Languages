  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(T[aã]\s*[AÂ]ꞌd[aâ])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(M[aã]t[aá]y[oõ])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(M[aá]r[aã]k[oõ])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(L[uú]k[aạ]̃?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*Y[oõ]w[aá]n[iĩ]|\s*Y[oõ]w[aá]n[iĩ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*Y[oõ]w[aá]n[iĩ]|\s*Y[oõ]w[aá]n[iĩ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*Y[oõ]w[aá]n[iĩ]|\s*Y[oõ]w[aá]n[iĩ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Y[oõ]w[aá]n[iĩ])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(T[aã]\s*ꞌ[EẼ]ꞌ[eẽ])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(R[oó]m[aã]\s*l[eé]\s*ꞌb[aá])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*K[oõ]r[ií]n[iĩ]t[oõ]\s*l[eé]\s*ꞌb[aá]|\s*K[oõ]r[ií]n[iĩ]t[oõ]\s*l[eé]\s*ꞌb[aá]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*K[oõ]r[ií]n[iĩ]t[oõ]\s*l[eé]\s*ꞌb[aá]|\s*K[oõ]r[ií]n[iĩ]t[oõ]\s*l[eé]\s*ꞌb[aá]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(K[oõ]l[oó]s[iĩ]\s*l[eé]\s*ꞌb[aá])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(G[aã]l[aã]t[ií]y[aã]\s*l[eé]\s*ꞌb[aá])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([EẼ]f[eé]s[oõ]\s*l[eé]\s*ꞌb[aá])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Fı(?:ٜ(?:̃lı(?:ٜ(?:́pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá]))|́pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá]))|lı(?:ٜ(?:́pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá]))|́pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])))|̃lı(?:ٜ(?:́pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá]))|́pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá]))|lı(?:ٜ(?:́pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá]))|́pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|pı(?:ٜ(?:̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá])|̃\s*l[eé]\s*ꞌb[aá]|\s*l[eé]\s*ꞌb[aá]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*T[eẽ]s[aã]l[oõ]n[ií]k[aã]\s*l[eé]\s*ꞌb[aá]|\s*T[eẽ]s[aã]l[oõ]n[ií]k[aã]\s*l[eé]\s*ꞌb[aá]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*T[eẽ]s[aã]l[oõ]n[ií]k[aã]\s*l[eé]\s*ꞌb[aá]|\s*T[eẽ]s[aã]l[oõ]n[ií]k[aã]\s*l[eé]\s*ꞌb[aá]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*T[iĩ]m[aá]t[iĩ]y[aã]|\s*T[iĩ]m[aá]t[iĩ]y[aã]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*T[iĩ]m[aá]t[iĩ]y[aã]|\s*T[iĩ]m[aá]t[iĩ]y[aã]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(T[ií]t[oõ])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F[iĩ]l[eẽ]m[oó]n[aã])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([IỊ](?:́b[uũ]r[uũ]|b[uũ]r[uũ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Y[aã]k[oó]b[aã])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
          ...
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Y[uú]dı(?:ٜ̃?|̃)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
