  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:ª\s*de\s*Juan|\s*Jn\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*(?:de\s*Juan|Jn\.)|\s*(?:de\s*Juan|Jn\.))|\.\s*(?:de\s*Juan|Jn\.)|\s*(?:de\s*Juan|Jn\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*(?:de\s*Juan|Jn\.)|\s*(?:de\s*Juan|Jn\.))|\.\s*(?:de\s*Juan|Jn\.)|\s*(?:de\s*Juan|Jn\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*(?:de\s*Corintios|Co\.)|\s*(?:de\s*Corintios|Co\.))|\.\s*(?:de\s*Corintios|Co\.)|\s*(?:de\s*Corintios|Co\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*(?:de\s*Corintios|Co\.)|\s*(?:de\s*Corintios|Co\.))|\.\s*(?:de\s*Corintios|Co\.)|\s*(?:de\s*Corintios|Co\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*(?:de\s*Tesalonicenses|Ts\.)|\s*(?:de\s*Tesalonicenses|Ts\.))|\.\s*(?:de\s*Tesalonicenses|Ts\.)|\s*(?:de\s*Tesalonicenses|Ts\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*(?:de\s*Tesalonicenses|Ts\.)|\s*(?:de\s*Tesalonicenses|Ts\.))|\.\s*(?:de\s*Tesalonicenses|Ts\.)|\s*(?:de\s*Tesalonicenses|Ts\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*(?:de\s*Timoteo|Ti\.)|\s*(?:de\s*Timoteo|Ti\.))|\.\s*(?:de\s*Timoteo|Ti\.)|\s*(?:de\s*Timoteo|Ti\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*(?:de\s*Timoteo|Ti\.)|\s*(?:de\s*Timoteo|Ti\.))|\.\s*(?:de\s*Timoteo|Ti\.)|\s*(?:de\s*Timoteo|Ti\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:ª(?:\.\s*(?:de\s*Pedro|P\.)|\s*(?:de\s*Pedro|P\.))|\.\s*(?:de\s*Pedro|P\.)|\s*(?:de\s*Pedro|P\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:ª(?:\.\s*(?:de\s*Pedro|P\.)|\s*(?:de\s*Pedro|P\.))|\.\s*(?:de\s*Pedro|P\.)|\s*(?:de\s*Pedro|P\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
