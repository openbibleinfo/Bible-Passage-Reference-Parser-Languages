var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["bni"];
    this.translations = [/BANGI\b/gi];
    this.first = /(?:1\.?\s*|Limbe\.?\s*|Ombe\.?\s*)/;
    this.second = /(?:2\.?\s*|Limbe\.?\s*|Ombe\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Mab(?:andela)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ma\s*)?Bokusoli)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Isa"],
            testament: "o",
          ...
          },
          {
            ...
            regexp: /(?:^|(?<=[^\p{L}]))(Nzembo)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Dan"],
            testament: "o",
          ...
          },
          {
            osis: ["Joel"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Yeole)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Amos"],
            testament: "o",
          ...
          },
          {
            osis: ["Nah"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Nauma)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Hab"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Abak(?:uka)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Zeph"],
            testament: "o",
          ...
          },
          {
            osis: ["Zech"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(Zek(?:alaya)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mal"],
            testament: "o",
          ...
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Na\s*)?Matayo)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Na\s*)?Malako)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Na\s*)?Luka)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe\s*Yoane\s*3|3\s*Yoane))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Yoane(?:\s*1)?|\s*Yoane(?:\s*1)?)|Ombe(?:\.\s*Yoane(?:\s*1)?|\s*Yoane(?:\s*1)?)|1(?:\.\s*Yoane(?:\s*1)?|\s*Yoane(?:\s*1)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Yoane(?:\s*2)?|\s*Yoane(?:\s*2)?)|Ombe(?:\.\s*Yoane(?:\s*2)?|\s*Yoane(?:\s*2)?)|2(?:\.\s*Yoane(?:\s*2)?|\s*Yoane(?:\s*2)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Na\s*)?Yoane)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ma\s*)?Ntoma)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ombe\s*Ba‐|Ba-)Loma)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Ba(?:‐Kolinto\s*1|-Kolinto)|\s*Ba(?:‐Kolinto\s*1|-Kolinto))|Ombe(?:\.\s*Ba(?:‐Kolinto\s*1|-Kolinto)|\s*Ba(?:‐Kolinto\s*1|-Kolinto))|1(?:\.\s*Ba(?:‐Kolinto\s*1|-Kolinto)|\s*Ba(?:‐Kolinto\s*1|-Kolinto))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Ba(?:‐Kolinto\s*2|-Kolinto)|\s*Ba(?:‐Kolinto\s*2|-Kolinto))|Ombe(?:\.\s*Ba(?:‐Kolinto\s*2|-Kolinto)|\s*Ba(?:‐Kolinto\s*2|-Kolinto))|2(?:\.\s*Ba(?:‐Kolinto\s*2|-Kolinto)|\s*Ba(?:‐Kolinto\s*2|-Kolinto))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ba‐)?Kolosai)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ombe\s*B’)?Epeso)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ba‐)?Pilipoi)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Ba(?:‐Tesalonike\s*1|-Tesalonike)|\s*Ba(?:‐Tesalonike\s*1|-Tesalonike))|Ombe(?:\.\s*Ba(?:‐Tesalonike\s*1|-Tesalonike)|\s*Ba(?:‐Tesalonike\s*1|-Tesalonike))|1(?:\.\s*Ba(?:‐Tesalonike\s*1|-Tesalonike)|\s*Ba(?:‐Tesalonike\s*1|-Tesalonike))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Ba(?:‐Tesalonike\s*2|-Tesalonike)|\s*Ba(?:‐Tesalonike\s*2|-Tesalonike))|Ombe(?:\.\s*Ba(?:‐Tesalonike\s*2|-Tesalonike)|\s*Ba(?:‐Tesalonike\s*2|-Tesalonike))|2(?:\.\s*Ba(?:‐Tesalonike\s*2|-Tesalonike)|\s*Ba(?:‐Tesalonike\s*2|-Tesalonike))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe\.?\s*Tim|Ombe\.?\s*Tim|1\.?\s*Tim))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Timoteo\s*1)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Tim(?:oteo\s*2)?|\s*Tim(?:oteo\s*2)?)|Ombe(?:\.\s*Tim(?:oteo\s*2)?|\s*Tim(?:oteo\s*2)?)|2(?:\.\s*Tim(?:oteo\s*2)?|\s*Tim(?:oteo\s*2)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ombe\s*)?Tito)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ombe\s*Pilemono|Pilem))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ombe\s*)?B’Ebele)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Limbe\s*)?Yakobo)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Pet(?:elo\s*1)?|\s*Pet(?:elo\s*1)?)|Ombe(?:\.\s*Pet(?:elo\s*1)?|\s*Pet(?:elo\s*1)?)|1(?:\.\s*Pet(?:elo\s*1)?|\s*Pet(?:elo\s*1)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Limbe(?:\.\s*Pet(?:elo\s*2)?|\s*Pet(?:elo\s*2)?)|Ombe(?:\.\s*Pet(?:elo\s*2)?|\s*Pet(?:elo\s*2)?)|2(?:\.\s*Pet(?:elo\s*2)?|\s*Pet(?:elo\s*2)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Limbe\s*)?Yuda)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
