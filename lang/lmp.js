var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["lmp"];
    this.translations = [/LNT\b/gi];
    this.first = /(?:Ñwaè\x27\.?\s*|Nwae\x27\.?\s*|Ñwae\x27\.?\s*|Nwaè\x27\.?\s*|Ñwaè’\.?\s*|Nwae’\.?\s*|Ñwae’\.?\s*|Nwaè’\.?\s*)/;
    this.second = /(?:Ñwaè\x27\.?\s*|Nwae\x27\.?\s*|Ñwae\x27\.?\s*|Nwaè\x27\.?\s*|Ñwaè’\.?\s*|Nwae’\.?\s*|Ñwae’\.?\s*|Nwaè’\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Kuu\s*Buu\s*Ce\s*Vi\s*Be\s*Ke[eè]\s*Koni)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Mat[iï][iì]yo[eè])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Ma[eê]k)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Lu[eê]k)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*Jo[aâ]n\s*Ce\s*Entomb[iï][iì]|\s*Jo[aâ]n\s*Ce\s*Entomb[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*Jo[aâ]n\s*Ce\s*Embenj[iï][iì]|\s*Jo[aâ]n\s*Ce\s*Embenj[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’]\s*Jo[aâ]n\s*Ce\s*El[uú][eè]simbu[eè]u)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Jo[aâ]n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Mfa[eè]['’]\s*[NÑ]ga[aâ]a\s*Ntuu\s*Jiso[eè]s)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Ru[eê]m)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*Be[aâ]e\s*Kore[eè]n\s*Ce\s*Entomb[iï][iì]|\s*Be[aâ]e\s*Kore[eè]n\s*Ce\s*Entomb[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*Be[aâ]e\s*Kore[eè]n\s*Ce\s*Embenj[iï][iì]|\s*Be[aâ]e\s*Kore[eè]n\s*Ce\s*Embenj[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Ko[eè]los[iï][iì])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Ga[eè]l[aá]sha[eè])(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*[AÁ]f[aá]so[eè]s)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*File[eè]pa[eê]i)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*T[aá][eè]sa[eè]lonika[eè]\s*Ce\s*Entomb[iï][iì]|\s*T[aá][eè]sa[eè]lonika[eè]\s*Ce\s*Entomb[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*T[aá][eè]sa[eè]lonika[eè]\s*Ce\s*Embenj[iï][iì]|\s*T[aá][eè]sa[eè]lonika[eè]\s*Ce\s*Embenj[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*Timot[iï][iì]\s*Ce\s*Entomb[iï][iì]|\s*Timot[iï][iì]\s*Ce\s*Entomb[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*Timot[iï][iì]\s*Ce\s*Embenj[iï][iì]|\s*Timot[iï][iì]\s*Ce\s*Embenj[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Taito[eè]s)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*F[iï][iì]lem[uú][eè]n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Hibru[eè]s)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*J[aá][eê]ms)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*Pita[eè]\s*Ce\s*Ento[eè]mb[iï][iì]|\s*Pita[eè]\s*Ce\s*Ento[eè]mb[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([NÑ]wa[eè]['’](?:\.\s*Pita[eè]\s*Ce\s*Embenj[iï][iì]|\s*Pita[eè]\s*Ce\s*Embenj[iï][iì]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))([NÑ]wa[eè]['’]\s*Ju[eê]d)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
