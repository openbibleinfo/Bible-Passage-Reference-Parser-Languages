var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["goj"];
    this.translations = [/NTGNN24\b/gi];
    this.first = /1\.?\s*/;
    this.second = /2\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्रका?शन|रका?शन))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यह(?:ून(?:्ना?|ना?)|न(?:्ना?|ना?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र(?:ेर(?:ित(?:हो?न)?|त(?:हो?न)?)|र(?:ित(?:हो?न)?|त(?:हो?न)?))|र(?:ेर(?:ित(?:हो?न)?|त(?:हो?न)?)|र(?:ित(?:हो?न)?|त(?:हो?न)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(र(?:ोम(?:ीयो?|यो?)|म(?:ीयो?|यो?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुर(?:िन(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))|न(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न)))|र(?:िन(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))|न(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))))|\s*क(?:ुर(?:िन(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))|न(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न)))|र(?:िन(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))|न(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुर(?:िन(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))|न(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न)))|र(?:िन(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))|न(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))))|\s*क(?:ुर(?:िन(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))|न(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न)))|र(?:िन(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))|न(?:्थ(?:िहो?न|हो?न)|थ(?:िहो?न|हो?न))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ुस(?:्स(?:ियो?|यो?)|स(?:ियो?|यो?))|स(?:्स(?:ियो?|यो?)|स(?:ियो?|यो?)))|ल(?:ुस(?:्स(?:ियो?|यो?)|स(?:ियो?|यो?))|स(?:्स(?:ियो?|यो?)|स(?:ियो?|यो?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(गलत(?:िया?|या?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इप(?:िस(?:ियो?|यो?)|स(?:ियो?|यो?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ीप(?:ियो?|यो?)|प(?:ियो?|यो?))|ल(?:ीप(?:ियो?|यो?)|प(?:ियो?|यो?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इब(?:्र(?:ान(?:ीहो?न|हो?न)|न(?:ीहो?न|हो?न))|र(?:ान(?:ीहो?न|हो?न)|न(?:ीहो?न|हो?न))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
