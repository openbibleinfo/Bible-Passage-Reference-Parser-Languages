var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["rwk"];
    this.translations = [/RWK72\b/gi];
    this.first = /(?:1\.?\s*|Barua\.?\s*)/;
    this.second = /(?:2\.?\s*|Barua\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ura(?:mbuyo\s*lwa\s*Yohane|\s*Yoh))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua\s*ya\s*Yohane\s*ya\s*kararu|3\s*Yoh))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua(?:\.\s*(?:ya\s*Yohane\s*ya\s*mbele|Yoh)|\s*(?:ya\s*Yohane\s*ya\s*mbele|Yoh))|1(?:\.\s*(?:ya\s*Yohane\s*ya\s*mbele|Yoh)|\s*(?:ya\s*Yohane\s*ya\s*mbele|Yoh))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua(?:\.\s*(?:ya\s*Yohane\s*ya\s*kavili|Yoh)|\s*(?:ya\s*Yohane\s*ya\s*kavili|Yoh))|2(?:\.\s*(?:ya\s*Yohane\s*ya\s*kavili|Yoh)|\s*(?:ya\s*Yohane\s*ya\s*kavili|Yoh))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Mitanie\s*ya\s*varumi|Var))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Varome|VaRo))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua(?:\.\s*(?:ya\s*Vakorinto\s*ya\s*mbele|Vakor)|\s*(?:ya\s*Vakorinto\s*ya\s*mbele|Vakor))|1(?:\.\s*(?:ya\s*Vakorinto\s*ya\s*mbele|Vakor)|\s*(?:ya\s*Vakorinto\s*ya\s*mbele|Vakor))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua(?:\.\s*(?:ya\s*Vakorinto\s*ya\s*kavili|Vakor)|\s*(?:ya\s*Vakorinto\s*ya\s*kavili|Vakor))|2(?:\.\s*(?:ya\s*Vakorinto\s*ya\s*kavili|Vakor)|\s*(?:ya\s*Vakorinto\s*ya\s*kavili|Vakor))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Vakolosai|Vako))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Vagalatia|Vag))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Vaefeso|Vae))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Vafilipi|Vaf))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua(?:\.\s*(?:ya\s*Vatesalonike\s*ya\s*mbele|Vat)|\s*(?:ya\s*Vatesalonike\s*ya\s*mbele|Vat))|1(?:\.\s*(?:ya\s*Vatesalonike\s*ya\s*mbele|Vat)|\s*(?:ya\s*Vatesalonike\s*ya\s*mbele|Vat))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua(?:\.\s*(?:ya\s*Vatesalonike\s*ya\s*kavili|Vat)|\s*(?:ya\s*Vatesalonike\s*ya\s*kavili|Vat))|2(?:\.\s*(?:ya\s*Vatesalonike\s*ya\s*kavili|Vat)|\s*(?:ya\s*Vatesalonike\s*ya\s*kavili|Vat))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua\.?\s*ya\s*Timoteo\s*ya\s*mbele|1\.?\s*ya\s*Timoteo\s*ya\s*mbele))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
          ...
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua(?:\.\s*(?:ya\s*Timoteo\s*ya\s*kavili|Tim)|\s*(?:ya\s*Timoteo\s*ya\s*kavili|Tim))|2(?:\.\s*(?:ya\s*Timoteo\s*ya\s*kavili|Tim)|\s*(?:ya\s*Timoteo\s*ya\s*kavili|Tim))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Tito|Tit))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Filemon|Fil))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Vaebrania|Vaeb))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Yakobo|Yak))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua\.?\s*ya\s*Petiro\s*ya\s*mbele|1\.?\s*ya\s*Petiro\s*ya\s*mbele))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
          ...
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Barua(?:\.\s*(?:ya\s*Petiro\s*ya\s*kavili|Pet)|\s*(?:ya\s*Petiro\s*ya\s*kavili|Pet))|2(?:\.\s*(?:ya\s*Petiro\s*ya\s*kavili|Pet)|\s*(?:ya\s*Petiro\s*ya\s*kavili|Pet))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Barua\s*ya\s*Yuda|Yud))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
