  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(परक(?:ा?सन|ा)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*यह(?:ून(?:्‍ना?|‍ना?)?|न(?:्‍ना?|‍ना?)?)|\s*यह(?:ून(?:्‍ना?|‍ना?)?|न(?:्‍ना?|‍ना?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*यह(?:ून(?:्‍ना?|‍ना?)?|न(?:्‍ना?|‍ना?)?)|\s*यह(?:ून(?:्‍ना?|‍ना?)?|न(?:्‍ना?|‍ना?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*यह(?:ून(?:्‍ना?|‍ना?)?|न(?:्‍ना?|‍ना?)?)|\s*यह(?:ून(?:्‍ना?|‍ना?)?|न(?:्‍ना?|‍ना?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यह(?:ून(?:्‍ना?|‍ना?)?|न(?:्‍ना?|‍ना?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(च(?:ेल(?:ौ?\s*क(?:े\s*का?म|\s*का?म)|ौ)?|ल(?:ौ?\s*क(?:े\s*का?म|\s*का?म)|ौ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुर(?:न(?:्‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))?|र(?:न(?:्‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))?)|\s*क(?:ुर(?:न(?:्‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))?|र(?:न(?:्‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुर(?:न(?:्‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))?|र(?:न(?:्‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))?)|\s*क(?:ुर(?:न(?:्‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))?|र(?:न(?:्‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|‍थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ु?स(?:िऔं?|औं?)|ु)?|ल(?:ु?स(?:िऔं?|औं?)|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(गल(?:ा?ति?औ|ा)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इफ(?:ि?सि?औ|ि)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ि?प(?:्‍पी?औ|‍पी?औ)|ि)?|ल(?:ि?प(?:्‍पी?औ|‍पी?औ)|ि)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:िस(?:ल(?:ुन(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))|न(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))))?|स(?:ल(?:ुन(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))|न(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))))?)|\s*थ(?:िस(?:ल(?:ुन(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))|न(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))))?|स(?:ल(?:ुन(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))|न(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:िस(?:ल(?:ुन(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))|न(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))))?|स(?:ल(?:ुन(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))|न(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))))?)|\s*थ(?:िस(?:ल(?:ुन(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))|न(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))))?|स(?:ल(?:ुन(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))|न(?:ीक(?:ियौ?|यौ?)|क(?:ियौ?|यौ?))))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
          ...
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:े?मौ?न|े)?|ल(?:े?मौ?न|े)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इबर(?:ा?नि?ओ|ा)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*पतरस?|\s*पतरस?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*पतरस?|\s*पतरस?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
