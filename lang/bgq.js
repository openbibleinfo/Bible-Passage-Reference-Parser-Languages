  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(दरसण)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*य(?:ूहना?|हना?)|\s*य(?:ूहना?|हना?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*य(?:ूहना?|हना?)|\s*य(?:ूहना?|हना?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*य(?:ूहना?|हना?)|\s*य(?:ूहना?|हना?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ूहना?|हना?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ख(?:ास\s*च(?:ेला?|ला?)|स\s*च(?:ेला?|ला?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुर(?:ुन(?:्थी?|थी?)|न(?:्थी?|थी?))|र(?:ुन(?:्थी?|थी?)|न(?:्थी?|थी?)))|\s*क(?:ुर(?:ुन(?:्थी?|थी?)|न(?:्थी?|थी?))|र(?:ुन(?:्थी?|थी?)|न(?:्थी?|थी?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुर(?:ुन(?:्थी?|थी?)|न(?:्थी?|थी?))|र(?:ुन(?:्थी?|थी?)|न(?:्थी?|थी?)))|\s*क(?:ुर(?:ुन(?:्थी?|थी?)|न(?:्थी?|थी?))|र(?:ुन(?:्थी?|थी?)|न(?:्थी?|थी?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ुसी?|सी?)|ल(?:ुसी?|सी?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इफ(?:िसु?स|सु?स))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:िस(?:्सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))|सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))|स(?:्सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))|सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))))|\s*थ(?:िस(?:्सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))|सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))|स(?:्सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))|सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:िस(?:्सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))|सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))|स(?:्सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))|सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))))|\s*थ(?:िस(?:्सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))|सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))|स(?:्सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))|सल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
