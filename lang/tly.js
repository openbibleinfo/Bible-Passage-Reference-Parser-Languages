  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(یوحنا\s*موکاشیفَ?ه)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(انجیل\s*لوقا)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(یوحنا\s*او(?:ّلین\s*نامَ?ه|لین\s*نامَ?ه))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(یوحنا\s*دو(?:ّمین\s*نامَ?ه|مین\s*نامَ?ه))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(یوحنا\s*سو(?:ّمین\s*نامَ?ه|مین\s*نامَ?ه))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ر(?:َسولون\s*اَ?عمال|سولون\s*اَ?عمال))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(رومی\s*کلیسارا\s*نامه)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(او(?:ّلین(?:\.\s*نام(?:َه\s*قورَ?نتیانیرا|ه\s*قورَ?نتیانیرا)|\s*نام(?:َه\s*قورَ?نتیانیرا|ه\s*قورَ?نتیانیرا))|لین(?:\.\s*نام(?:َه\s*قورَ?نتیانیرا|ه\s*قورَ?نتیانیرا)|\s*نام(?:َه\s*قورَ?نتیانیرا|ه\s*قورَ?نتیانیرا))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(دوومین\s*نامه\s*قرنتیانیرا)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(نام(?:َه\s*ک(?:ُولُ?سی\s*کلیسا\s*را|ولُ?سی\s*کلیسا\s*را)|ه\s*ک(?:ُولُ?سی\s*کلیسا\s*را|ولُ?سی\s*کلیسا\s*را)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(نامه\s*غلاطیَ?ه\s*کلیسارا)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(نام(?:َه\s*اَ?فسوسی\s*کلیسارا|ه\s*اَ?فسوسی\s*کلیسارا))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(نامَ?ه\s*فیلیپی\s*کلیسا\s*را)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(دو(?:ّمین\s*نام(?:َه\s*تَ?سالونیکی\s*کلیسا\s*را|ه\s*تَ?سالونیکی\s*کلیسا\s*را)|مین\s*نام(?:َه\s*تَ?سالونیکی\s*کلیسا\s*را|ه\s*تَ?سالونیکی\s*کلیسا\s*را)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(او(?:ّلین(?:\.\s*نام(?:َه\s*تَ?سالونیکی\s*کلیسا\s*را|ه\s*تَ?سالونیکی\s*کلیسا\s*را)|\s*نام(?:َه\s*تَ?سالونیکی\s*کلیسا\s*را|ه\s*تَ?سالونیکی\s*کلیسا\s*را))|لین(?:\.\s*نام(?:َه\s*تَ?سالونیکی\s*کلیسا\s*را|ه\s*تَ?سالونیکی\s*کلیسا\s*را)|\s*نام(?:َه\s*تَ?سالونیکی\s*کلیسا\s*را|ه\s*تَ?سالونیکی\s*کلیسا\s*را))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(د(?:ِو(?:ُ?ّمین\s*نام(?:َه\s*تیموتا[ئي]وسیرا|ه\s*تیموتا[ئي]وسیرا)|ُ?مین\s*نام(?:َه\s*تیموتا[ئي]وسیرا|ه\s*تیموتا[ئي]وسیرا))|و(?:ُ?ّمین\s*نام(?:َه\s*تیموتا[ئي]وسیرا|ه\s*تیموتا[ئي]وسیرا)|ُ?مین\s*نام(?:َه\s*تیموتا[ئي]وسیرا|ه\s*تیموتا[ئي]وسیرا))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(او(?:ّلین(?:\.\s*نام(?:َه\s*تیموتا[ئي]وسیرا|ه\s*تیموتا[ئي]وسیرا)|\s*نام(?:َه\s*تیموتا[ئي]وسیرا|ه\s*تیموتا[ئي]وسیرا))|لین(?:\.\s*نام(?:َه\s*تیموتا[ئي]وسیرا|ه\s*تیموتا[ئي]وسیرا)|\s*نام(?:َه\s*تیموتا[ئي]وسیرا|ه\s*تیموتا[ئي]وسیرا))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(نامَ?ه\s*تیتوسیرا)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(نامَ?ه\s*فیلیمونیرا)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(نام(?:َه،\s*ع(?:ِبرانیه\s*ن(?:َتاجَ?ه\s*مسیحیونرا|تاجَ?ه\s*مسیحیونرا)|برانیه\s*ن(?:َتاجَ?ه\s*مسیحیونرا|تاجَ?ه\s*مسیحیونرا))|ه،\s*ع(?:ِبرانیه\s*ن(?:َتاجَ?ه\s*مسیحیونرا|تاجَ?ه\s*مسیحیونرا)|برانیه\s*ن(?:َتاجَ?ه\s*مسیحیونرا|تاجَ?ه\s*مسیحیونرا))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(یعقوبی\s*نامَ?ه)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(پطروسی\s*او(?:ّلین\s*نامَ?ه|لین\s*نامَ?ه))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(پطروسی\s*دومین\s*نامه)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(یهودا\s*نامه)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
