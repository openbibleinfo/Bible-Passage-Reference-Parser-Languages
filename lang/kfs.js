  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र(?:ेर(?:ि(?:त(?:ां?|ं)?|\.)|त(?:ां?|ं)?|\.)|र(?:ि(?:त(?:ां?|ं)?|\.)|त(?:ां?|ं)?|\.))|र(?:ेर(?:ि(?:त(?:ां?|ं)?|\.)|त(?:ां?|ं)?|\.)|र(?:ि(?:त(?:ां?|ं)?|\.)|त(?:ां?|ं)?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:िम(?:ु?थ(?:ियु?स|यु?स)|ु?\.)|म(?:ु?थ(?:ियु?स|यु?स)|ु?\.))|\s*त(?:िम(?:ु?थ(?:ियु?स|यु?स)|ु?\.)|म(?:ु?थ(?:ियु?स|यु?स)|ु?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:िम(?:ु?थ(?:ियु?स|यु?स)|ु?\.)|म(?:ु?थ(?:ियु?स|यु?स)|ु?\.))|\s*त(?:िम(?:ु?थ(?:ियु?स|यु?स)|ु?\.)|म(?:ु?थ(?:ियु?स|यु?स)|ु?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
