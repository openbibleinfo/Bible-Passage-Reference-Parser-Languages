  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(परक(?:ा?स(?:ितव(?:ाक्?य|क्?य)|तव(?:ाक्?य|क्?य))|ा)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*यह(?:ु?न(?:्ना?|ना?)|ु)?|\s*यह(?:ु?न(?:्ना?|ना?)|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*यह(?:ु?न(?:्ना?|ना?)|ु)?|\s*यह(?:ु?न(?:्ना?|ना?)|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*यह(?:ु?न(?:्ना?|ना?)|ु)?|\s*यह(?:ु?न(?:्ना?|ना?)|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यह(?:ु?न(?:्ना?|ना?)|ु)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(थर(?:प(?:्य(?:ा\s*तक(?:ा\s*क(?:ा\s*का?म|\s*का?म)|\s*क(?:ा\s*का?म|\s*का?म))|\s*तक(?:ा\s*क(?:ा\s*का?म|\s*का?म)|\s*क(?:ा\s*का?म|\s*का?म)))|य(?:ा\s*तक(?:ा\s*क(?:ा\s*का?म|\s*का?म)|\s*क(?:ा\s*का?म|\s*का?म))|\s*तक(?:ा\s*क(?:ा\s*का?म|\s*का?म)|\s*क(?:ा\s*का?म|\s*का?म)))))?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ु?स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|ु)?|ल(?:ु?स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इप(?:ि?स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|ि)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:िस(?:्स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?|स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?)|स(?:्स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?|स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?))|\s*थ(?:िस(?:्स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?|स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?)|स(?:्स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?|स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:िस(?:्स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?|स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?)|स(?:्स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?|स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?))|\s*थ(?:िस(?:्स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?|स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?)|स(?:्स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?|स(?:ु?ल(?:ुन(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:्य(?:ों?|ं)?|य(?:ों?|ं)?)))|ु)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:िम(?:ु?त(?:ियू?स|यू?स)|ु)?|म(?:ु?त(?:ियू?स|यू?स)|ु)?)|\s*त(?:िम(?:ु?त(?:ियू?स|यू?स)|ु)?|म(?:ु?त(?:ियू?स|यू?स)|ु)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:िम(?:ु?त(?:ियू?स|यू?स)|ु)?|म(?:ु?त(?:ियू?स|यू?स)|ु)?)|\s*त(?:िम(?:ु?त(?:ियू?स|यू?स)|ु)?|म(?:ु?त(?:ियू?स|यू?स)|ु)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ीत(?:ूस?|स)?|त(?:ूस?|स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
