  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:୍ରକ(?:ାଶ(?:ିତ୍?|ତ୍?)|ଶ(?:ିତ୍?|ତ୍?))|ରକ(?:ାଶ(?:ିତ୍?|ତ୍?)|ଶ(?:ିତ୍?|ତ୍?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ମ(?:ାତ(?:ିସ୍?|ସ୍?)|ତ(?:ିସ୍?|ସ୍?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ମ(?:ାର(?:୍‌କ(?:ୁସ୍?|ସ୍?)|‌କ(?:ୁସ୍?|ସ୍?))|ର(?:୍‌କ(?:ୁସ୍?|ସ୍?)|‌କ(?:ୁସ୍?|ସ୍?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଲ(?:ୁକ(?:ାସ୍?|ସ୍?)|କ(?:ାସ୍?|ସ୍?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ଯ(?:ୋହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?))|ହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?)))|\s*ଯ(?:ୋହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?))|ହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ଯ(?:ୋହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?))|ହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?)))|\s*ଯ(?:ୋହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?))|ହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୩(?:\.\s*ଯ(?:ୋହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?))|ହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?)))|\s*ଯ(?:ୋହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?))|ହ(?:ାନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଯ(?:ୋହ(?:ାନ୍?|ନ୍?)|ହ(?:ାନ୍?|ନ୍?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:୍ର(?:େର(?:ିତ୍?|ତ୍?)|ର(?:ିତ୍?|ତ୍?))|ର(?:େର(?:ିତ୍?|ତ୍?)|ର(?:ିତ୍?|ତ୍?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ର(?:ୋମୀ?|ମୀ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*କ(?:ୁର(?:ିନ(?:୍ଥୀ?|ଥୀ?)|ନ(?:୍ଥୀ?|ଥୀ?))|ର(?:ିନ(?:୍ଥୀ?|ଥୀ?)|ନ(?:୍ଥୀ?|ଥୀ?)))|\s*କ(?:ୁର(?:ିନ(?:୍ଥୀ?|ଥୀ?)|ନ(?:୍ଥୀ?|ଥୀ?))|ର(?:ିନ(?:୍ଥୀ?|ଥୀ?)|ନ(?:୍ଥୀ?|ଥୀ?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*କ(?:ୁର(?:ିନ(?:୍ଥୀ?|ଥୀ?)|ନ(?:୍ଥୀ?|ଥୀ?))|ର(?:ିନ(?:୍ଥୀ?|ଥୀ?)|ନ(?:୍ଥୀ?|ଥୀ?)))|\s*କ(?:ୁର(?:ିନ(?:୍ଥୀ?|ଥୀ?)|ନ(?:୍ଥୀ?|ଥୀ?))|ର(?:ିନ(?:୍ଥୀ?|ଥୀ?)|ନ(?:୍ଥୀ?|ଥୀ?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(କ(?:ୁଲ(?:ୁସି?|ସି?)|ଲ(?:ୁସି?|ସି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଗ(?:ାଲ(?:ାତୀ?|ତୀ?)|ଲ(?:ାତୀ?|ତୀ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଇଫ(?:ିସି?|ସି?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଫ(?:ିଲ(?:ିପ(?:୍ପୀ?|ପୀ?)|ପ(?:୍ପୀ?|ପୀ?))|ଲ(?:ିପ(?:୍ପୀ?|ପୀ?)|ପ(?:୍ପୀ?|ପୀ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1\s*ଥ(?:େସଲନ(?:ିକି?|କି?)|ସଲନ(?:ିକି?|କି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2\s*ଥ(?:େସଲନ(?:ିକି?|କି?)|ସଲନ(?:ିକି?|କି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ତ(?:ିମଥ(?:ିଉସ୍?|ଉସ୍?)|ମଥ(?:ିଉସ୍?|ଉସ୍?))|\s*ତ(?:ିମଥ(?:ିଉସ୍?|ଉସ୍?)|ମଥ(?:ିଉସ୍?|ଉସ୍?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ତ(?:ିମଥ(?:ିଉସ୍?|ଉସ୍?)|ମଥ(?:ିଉସ୍?|ଉସ୍?))|\s*ତ(?:ିମଥ(?:ିଉସ୍?|ଉସ୍?)|ମଥ(?:ିଉସ୍?|ଉସ୍?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ତ(?:ୀତ(?:ୁସ୍?|ସ୍?)|ତ(?:ୁସ୍?|ସ୍?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଫ(?:ିଲ(?:େମ(?:ୋନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?))|ମ(?:ୋନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?)))|ଲ(?:େମ(?:ୋନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?))|ମ(?:ୋନ(?:୍‌ସ୍?|‌ସ୍?)|ନ(?:୍‌ସ୍?|‌ସ୍?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଇବ(?:୍ର(?:ାନୀ?|ନୀ?)|ର(?:ାନୀ?|ନୀ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ୟ(?:ାକ(?:ୁବ(?:୍‌ସ୍?|‌ସ୍?)|ବ(?:୍‌ସ୍?|‌ସ୍?))|କ(?:ୁବ(?:୍‌ସ୍?|‌ସ୍?)|ବ(?:୍‌ସ୍?|‌ସ୍?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ପ(?:ାତ(?:୍ର(?:ାସ୍?|ସ୍?)|ର(?:ାସ୍?|ସ୍?))|ତ(?:୍ର(?:ାସ୍?|ସ୍?)|ର(?:ାସ୍?|ସ୍?)))|\s*ପ(?:ାତ(?:୍ର(?:ାସ୍?|ସ୍?)|ର(?:ାସ୍?|ସ୍?))|ତ(?:୍ର(?:ାସ୍?|ସ୍?)|ର(?:ାସ୍?|ସ୍?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ପ(?:ାତ(?:୍ର(?:ାସ୍?|ସ୍?)|ର(?:ାସ୍?|ସ୍?))|ତ(?:୍ର(?:ାସ୍?|ସ୍?)|ର(?:ାସ୍?|ସ୍?)))|\s*ପ(?:ାତ(?:୍ର(?:ାସ୍?|ସ୍?)|ର(?:ାସ୍?|ସ୍?))|ତ(?:୍ର(?:ାସ୍?|ସ୍?)|ର(?:ାସ୍?|ସ୍?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଯ(?:ୁଦ(?:ାସ୍?|ସ୍?)|ଦ(?:ାସ୍?|ସ୍?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
