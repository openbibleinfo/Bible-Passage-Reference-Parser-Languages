  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र\.\s*ब(?:ोके?|के?)|र\.\s*ब(?:ोके?|के?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्रत(?:िन(?:िधि?|धि?)|न(?:िधि?|धि?))|रत(?:िन(?:िधि?|धि?)|न(?:िधि?|धि?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुर(?:िन्?थ|न्?थ)|र(?:िन्?थ|न्?थ))|\s*क(?:ुर(?:िन्?थ|न्?थ)|र(?:िन्?थ|न्?थ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुर(?:िन्?थ|न्?थ)|र(?:िन्?थ|न्?थ))|\s*क(?:ुर(?:िन्?थ|न्?थ)|र(?:िन्?थ|न्?थ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ोसी?|सी?)|ल(?:ोसी?|सी?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:ेस(?:्सलु?|सलु?)|स(?:्सलु?|सलु?))|\s*थ(?:ेस(?:्सलु?|सलु?)|स(?:्सलु?|सलु?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:ेस(?:्सलु?|सलु?)|स(?:्सलु?|सलु?))|\s*थ(?:ेस(?:्सलु?|सलु?)|स(?:्सलु?|सलु?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:िम(?:ुथि?|थि?)|म(?:ुथि?|थि?))|\s*त(?:िम(?:ुथि?|थि?)|म(?:ुथि?|थि?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:िम(?:ुथि?|थि?)|म(?:ुथि?|थि?))|\s*त(?:िम(?:ुथि?|थि?)|म(?:ुथि?|थि?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
