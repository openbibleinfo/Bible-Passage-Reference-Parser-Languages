var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["cdm"];
    this.translations = [/C(?:DM93|HEP)\b/gi];
    this.first = /१\.?\s*/;
    this.second = /२\.?\s*/;
    this.third = /३\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मर(?:्‌क(?:स्|ुस|स)?|‌क(?:स्|ुस|स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*य(?:ुहना?|हना?)|\s*य(?:ुहना?|हना?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*य(?:ुहना?|हना?)|\s*य(?:ुहना?|हना?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(३(?:\.\s*य(?:ुहना?|हना?)|\s*य(?:ुहना?|हना?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ुहना?|हना?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:प(?:्र(?:ेर(?:ीत्?|त्?)|र(?:ीत्?|त्?))|र(?:ेर(?:ीत्?|त्?)|र(?:ीत्?|त्?)))|खबर(?:दु?त)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*क(?:ोर(?:ीन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?))|र(?:ीन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?)))|\s*क(?:ोर(?:ीन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?))|र(?:ीन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ोर(?:ीन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?))|र(?:ीन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?)))|\s*क(?:ोर(?:ीन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?))|र(?:ीन(?:्‍थी?|‍थी?)|न(?:्‍थी?|‍थी?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ोलसी?|लसी?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ग(?:ाल(?:ाती?|ती?)|ल(?:ाती?|ती?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(एफ(?:ेसस्?|सस्?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:ील(?:ीपी?|पी?)|ल(?:ीपी?|पी?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*थ(?:ेस(?:ाल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?))|ल(?:(?:ोन(?:िकि|क[ाि])|न(?:िकि|क[ाि]))|(?:ोनि?क|नि?क))|लो?नीका?)|स(?:ाल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?))|ल(?:(?:ोन(?:िकि|क[ाि])|न(?:िकि|क[ाि]))|(?:ोनि?क|नि?क))|लो?नीका?))|\s*थ(?:ेस(?:ाल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?))|ल(?:(?:ोन(?:िकि|क[ाि])|न(?:िकि|क[ाि]))|(?:ोनि?क|नि?क))|लो?नीका?)|स(?:ाल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?))|ल(?:(?:ोन(?:िकि|क[ाि])|न(?:िकि|क[ाि]))|(?:ोनि?क|नि?क))|लो?नीका?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*थ(?:ेस(?:ाल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?))|ल(?:(?:ोन(?:िकि|क[ाि])|न(?:िकि|क[ाि]))|(?:ोनि?क|नि?क))|लो?नीका?)|स(?:ाल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?))|ल(?:(?:ोन(?:िकि|क[ाि])|न(?:िकि|क[ाि]))|(?:ोनि?क|नि?क))|लो?नीका?))|\s*थ(?:ेस(?:ाल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?))|ल(?:(?:ोन(?:िकि|क[ाि])|न(?:िकि|क[ाि]))|(?:ोनि?क|नि?क))|लो?नीका?)|स(?:ाल(?:ोन(?:ीका?|का?)|न(?:ीका?|का?))|ल(?:(?:ोन(?:िकि|क[ाि])|न(?:िकि|क[ाि]))|(?:ोनि?क|नि?क))|लो?नीका?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१थे?स)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२थे?स)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*त(?:िमो?थि|ीम(?:ोथी?|थी?)|िमो?थ|म(?:ोथ[िी]|थ[िी])|मो?थ)|\s*त(?:िमो?थि|ीम(?:ोथी?|थी?)|िमो?थ|म(?:ोथ[िी]|थ[िी])|मो?थ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*त(?:िमो?थि|ीम(?:ोथी?|थी?)|िमो?थ|म(?:ोथ[िी]|थ[िी])|मो?थ)|\s*त(?:िमो?थि|ीम(?:ोथी?|थी?)|िमो?थ|म(?:ोथ[िी]|थ[िी])|मो?थ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१त(?:िमो?|मो?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२त(?:िमो?|मो?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ीतस्?|ितस|तस्?|ि?त))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:ील(?:ेम(?:ोन्?|न्?)|म(?:ोन्?|न्?))|ल(?:ेम(?:ोन्?|न्?)|म(?:ोन्?|न्?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ह(?:ेब(?:्र(?:ैनी?|नी?)|र(?:ैनी?|नी?))|ब(?:्र(?:ैनी?|नी?)|र(?:ैनी?|नी?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ाक(?:ुब्?|ब्?)|क(?:ुब्?|ब्?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*पत(?:्र(?:ुस्?|स्?)|र(?:ुस्?|स्?))|\s*पत(?:्र(?:ुस्?|स्?)|र(?:ुस्?|स्?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*पत(?:्र(?:ुस्?|स्?)|र(?:ुस्?|स्?))|\s*पत(?:्र(?:ुस्?|स्?)|र(?:ुस्?|स्?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(यह(?:ुदा?|दा?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
