  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ख(?:ाङ(?:्‌म(?:ुमा?|मा?)|‌म(?:ुमा?|मा?))?|ङ(?:्‌म(?:ुमा?|मा?)|‌म(?:ुमा?|मा?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(छ(?:ाम(?:्‍म(?:ाय़?ङ|य़?ङ)|‍म(?:ाय़?ङ|य़?ङ))?|म(?:्‍म(?:ाय़?ङ|य़?ङ)|‍म(?:ाय़?ङ|य़?ङ))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
