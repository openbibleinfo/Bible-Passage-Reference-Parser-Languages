  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ស(?:ារ\s*ត(?:ា?ំបា?ង|ា?បា?ង)|រ\s*ត(?:ា?ំបា?ង|ា?បា?ង))|វ(?:ិ?វរណៈ|ិ?វរណ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ម(?:៉(?:ាថា?យ|ថា?យ)|ាថា?យ|ថា?យ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*យ(?:ូហា?ន|ហា?ន)|\s*យ(?:ូហា?ន|ហា?ន)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*យ(?:ូហា?ន|ហា?ន)|\s*យ(?:ូហា?ន|ហា?ន)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(៣(?:\.\s*យ(?:ូហា?ន|ហា?ន)|\s*យ(?:ូហា?ន|ហា?ន)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:ូហា?ន|ហា?ន))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ង(?:៉ារ\s*មួត\s*រ៉ះ\s*ប៉ាតាង\s*យីស៊ូ|រ\s*មត\s*រ\s*បតង\s*យស)|ក(?:ិច្?ច|ច្?ច|ា?រ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ក(?:ូរ(?:ិនថ(?:ូ?ះ|ូ)?|នថ(?:ូ?ះ|ូ)?)|រ(?:ិនថ(?:ូ?ះ|ូ)?|នថ(?:ូ?ះ|ូ)?))|\s*ក(?:ូរ(?:ិនថ(?:ូ?ះ|ូ)?|នថ(?:ូ?ះ|ូ)?)|រ(?:ិនថ(?:ូ?ះ|ូ)?|នថ(?:ូ?ះ|ូ)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ក(?:ូរ(?:ិនថ(?:ូ?ះ|ូ)?|នថ(?:ូ?ះ|ូ)?)|រ(?:ិនថ(?:ូ?ះ|ូ)?|នថ(?:ូ?ះ|ូ)?))|\s*ក(?:ូរ(?:ិនថ(?:ូ?ះ|ូ)?|នថ(?:ូ?ះ|ូ)?)|រ(?:ិនថ(?:ូ?ះ|ូ)?|នថ(?:ូ?ះ|ូ)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ក(?:ូឡ(?:ូ?ះ|ូ)?|ឡ(?:ូ?ះ|ូ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ក(?:ាឡ(?:ាទី?|ទី?)|ឡ(?:ាទី?|ទី?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(អ(?:េភ(?:េសូ?|សូ?)|ភ(?:េសូ?|សូ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ភ(?:ីលី?ប|លី?ប))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ថ(?:េស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក))|ស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក)))|\s*ថ(?:េស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក))|ស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ថ(?:េស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក))|ស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក)))|\s*ថ(?:េស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក))|ស(?:ាឡ(?:ូនិ?ក|និ?ក)|ឡ(?:ូនិ?ក|និ?ក)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ធ(?:ីម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?)|ម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?))|\s*ធ(?:ីម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?)|ម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ធ(?:ីម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?)|ម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?))|\s*ធ(?:ីម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?)|ម(?:៉(?:ូថេ?|ថេ?)|ូថេ?|ថេ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ភ(?:ីល(?:េម(?:៉ូ?ន|ូ?ន)|ម(?:៉ូ?ន|ូ?ន))|ល(?:េម(?:៉ូ?ន|ូ?ន)|ម(?:៉ូ?ន|ូ?ន))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ហ(?:េព(?:្រឺ?|រឺ?)|ព(?:្រឺ?|រឺ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ព(?:េត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?))|\s*ព(?:េត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ព(?:េត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?))|\s*ព(?:េត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:ូដះ?|ដះ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
