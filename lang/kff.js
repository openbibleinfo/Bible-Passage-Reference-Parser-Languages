var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["kff"];
    this.translations = [/NTKAA20\b/gi];
    this.first = /୧\.?\s*/;
    this.second = /୨\.?\s*/;
    this.third = /୩\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:୍ରକ(?:ାଶ(?:ିତ(?:୍‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ))|ତ(?:୍‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)))|ଶ(?:ିତ(?:୍‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ))|ତ(?:୍‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ))))|ରକ(?:ାଶ(?:ିତ(?:୍‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ))|ତ(?:୍‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)))|ଶ(?:ିତ(?:୍‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ))|ତ(?:୍‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ)|‌\s*ବ(?:ାକ୍?ୟ|କ୍?ୟ))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ଯ(?:ୋହନ୍?‌‌|ହନ୍?‌‌)|\s*ଯ(?:ୋହନ୍?‌‌|ହନ୍?‌‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ଯ(?:ୋହନ୍?‌‌|ହନ୍?‌‌)|\s*ଯ(?:ୋହନ୍?‌‌|ହନ୍?‌‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୩(?:\.\s*ଯ(?:ୋହନ୍?‌‌|ହନ୍?‌‌)|\s*ଯ(?:ୋହନ୍?‌‌|ହନ୍?‌‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଯ(?:ୋହନ୍?‌‌|ହନ୍?‌‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:୍ର(?:େରି?ତ|ରି?ତ)|ର(?:େରି?ତ|ରି?ତ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ର(?:ୋମୀ?ୟ|ମୀ?ୟ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)|\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)|\s*କରନ(?:୍ତି?ୟ|ତି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(କଲସୀ?ୟ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଗ(?:ାଲ(?:ାତୀ?ୟ|ତୀ?ୟ)|ଲ(?:ାତୀ?ୟ|ତୀ?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଏଫ(?:ିସି?ୟ|ସି?ୟ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଫ(?:ିଲ(?:ିପି?ୟ|ପି?ୟ)|ଲ(?:ିପି?ୟ|ପି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ଥ(?:େସଲନି?ୟ|ସଲନି?ୟ)|\s*ଥ(?:େସଲନି?ୟ|ସଲନି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ଥ(?:େସଲନି?ୟ|ସଲନି?ୟ)|\s*ଥ(?:େସଲନି?ୟ|ସଲନି?ୟ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ତ(?:ୀମତି?|ମତି?)|\s*ତ(?:ୀମତି?|ମତି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ତ(?:ୀମତି?|ମତି?)|\s*ତ(?:ୀମତି?|ମତି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ତ(?:ୀତସ୍?‌|ତସ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଫ(?:ିଲ(?:ିମ(?:ୋନ(?:୍?‌|୍)?|ନ(?:୍?‌|୍)?)|ମ(?:ୋନ(?:୍?‌|୍)?|ନ(?:୍?‌|୍)?))|ଲ(?:ିମ(?:ୋନ(?:୍?‌|୍)?|ନ(?:୍?‌|୍)?)|ମ(?:ୋନ(?:୍?‌|୍)?|ନ(?:୍?‌|୍)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଏବ(?:୍ରୀ?|ରୀ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଯ(?:ାକୁ?ବ|କୁ?ବ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ପ(?:ିତର୍?|ତର୍?)|\s*ପ(?:ିତର୍?|ତର୍?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ପ(?:ିତର୍?‌|ତର୍?‌)|\s*ପ(?:ିତର୍?‌|ତର୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଯ(?:ିହ(?:ୁଦା?|ଦା?)|ହ(?:ୁଦା?|ଦା?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
