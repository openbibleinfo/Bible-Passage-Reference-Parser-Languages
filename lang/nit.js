  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ప్?రకటన)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(మత(?:్తయ్?|తయ్?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(మ(?:ార్?క|ర్?క))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ల(?:ూక్?|క్?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*య(?:ోహ(?:ాన్?|న్?)|హ(?:ాన్?|న్?))|\s*య(?:ోహ(?:ాన్?|న్?)|హ(?:ాన్?|న్?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*య(?:ోహ(?:ాన్?|న్?)|హ(?:ాన్?|న్?))|\s*య(?:ోహ(?:ాన్?|న్?)|హ(?:ాన్?|న్?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*య(?:ోహ(?:ాన్?|న్?)|హ(?:ాన్?|న్?))|\s*య(?:ోహ(?:ాన్?|న్?)|హ(?:ాన్?|న్?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(య(?:ోహ(?:ాన్?|న్?)|హ(?:ాన్?|న్?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(అప(?:ొస(?:్తు?|తు?)|స(?:్తు?|తు?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ర(?:ోమీ?|మీ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*క(?:ొర(?:ి(?:ంతి?|తి?)|ంతి?|తి?)|ర(?:ి(?:ంతి?|తి?)|ంతి?|తి?))|\s*క(?:ొర(?:ి(?:ంతి?|తి?)|ంతి?|తి?)|ర(?:ి(?:ంతి?|తి?)|ంతి?|తి?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*క(?:ొర(?:ి(?:ంతి?|తి?)|ంతి?|తి?)|ర(?:ి(?:ంతి?|తి?)|ంతి?|తి?))|\s*క(?:ొర(?:ి(?:ంతి?|తి?)|ంతి?|తి?)|ర(?:ి(?:ంతి?|తి?)|ంతి?|తి?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(క(?:ొలస(?:్సి?|సి?)|లస(?:్సి?|సి?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(గలతి?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ఎప(?:ెసి?|సి?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ప(?:ిల(?:ిపి?|పి?)|ల(?:ిపి?|పి?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*త(?:ెస(?:్సల(?:ోని?|ని?)|సల(?:ోని?|ని?))|స(?:్సల(?:ోని?|ని?)|సల(?:ోని?|ని?)))|\s*త(?:ెస(?:్సల(?:ోని?|ని?)|సల(?:ోని?|ని?))|స(?:్సల(?:ోని?|ని?)|సల(?:ోని?|ని?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*త(?:ెస(?:్సల(?:ోని?|ని?)|సల(?:ోని?|ని?))|స(?:్సల(?:ోని?|ని?)|సల(?:ోని?|ని?)))|\s*త(?:ెస(?:్సల(?:ోని?|ని?)|సల(?:ోని?|ని?))|స(?:్సల(?:ోని?|ని?)|సల(?:ోని?|ని?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*త(?:ిమ(?:ోతి?|తి?)|మ(?:ోతి?|తి?))|\s*త(?:ిమ(?:ోతి?|తి?)|మ(?:ోతి?|తి?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*త(?:ిమ(?:ోతి?|తి?)|మ(?:ోతి?|తి?))|\s*త(?:ిమ(?:ోతి?|తి?)|మ(?:ోతి?|తి?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(త(?:ీత(?:ుకు?|కు?)|త(?:ుకు?|కు?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ప(?:ిల(?:ేమ(?:ోన్?|న్?)|మ(?:ోన్?|న్?))|ల(?:ేమ(?:ోన్?|న్?)|మ(?:ోన్?|న్?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(హ(?:ెబ(?:్రీ?|రీ?)|బ(?:్రీ?|రీ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(య(?:ాక(?:ోబ్?|బ్?)|క(?:ోబ్?|బ్?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ప(?:ేత(?:ుర్?|ర్?)|త(?:ుర్?|ర్?))|\s*ప(?:ేత(?:ుర్?|ర్?)|త(?:ుర్?|ర్?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ప(?:ేత(?:ుర్?|ర్?)|త(?:ుర్?|ర్?))|\s*ప(?:ేత(?:ుర్?|ర్?)|త(?:ుర్?|ర్?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(యూ?ద)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
