  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्रक(?:ा?स(?:ित\s*ब(?:ाक्?य|क्?य)|त\s*ब(?:ाक्?य|क्?य))|ा)?|रक(?:ा?स(?:ित\s*ब(?:ाक्?य|क्?य)|त\s*ब(?:ाक्?य|क्?य))|ा)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मत(?:्‍ती?|‍ती?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र(?:ेर(?:ि?तन\s*क(?:े\s*का?म|\s*का?म)|ि)?|र(?:ि?तन\s*क(?:े\s*का?म|\s*का?म)|ि)?)|र(?:ेर(?:ि?तन\s*क(?:े\s*का?म|\s*का?म)|ि)?|र(?:ि?तन\s*क(?:े\s*का?म|\s*का?म)|ि)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*थ(?:िस(?:्स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?|स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?)|स(?:्स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?|स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?))|\s*थ(?:िस(?:्स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?|स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?)|स(?:्स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?|स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*थ(?:िस(?:्स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?|स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?)|स(?:्स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?|स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?))|\s*थ(?:िस(?:्स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?|स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?)|स(?:्स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?|स(?:ल(?:ुन(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))|न(?:िक(?:िय(?:ों?|ं)?|य(?:ों?|ं)?)|क(?:िय(?:ों?|ं)?|य(?:ों?|ं)?))))?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:िम(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|मु?थ(?:ियु?स|यु?स)|ीमु|मु?|ीम)|\s*त(?:िम(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|मु?थ(?:ियु?स|यु?स)|ीमु|मु?|ीम)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:िम(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|मु?थ(?:ियु?स|यु?स)|ीमु|मु?|ीम)|\s*त(?:िम(?:ुथ(?:ियु?स|यु?स)|थ(?:ियु?स|यु?स))|मु?थ(?:ियु?स|यु?स)|ीमु|मु?|ीम)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
