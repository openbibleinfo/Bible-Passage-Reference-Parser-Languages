var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["kfx"];
    this.translations = [/(?:KFX-|[IO]SJ)NT\b/gi];
    this.first = /1\.?\s*/;
    this.second = /2\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र(?:गट\s*क(?:ी\s*द(?:ी\s*गल(?:्ला?|ला?)|\s*गल(?:्ला?|ला?))|\s*द(?:ी\s*गल(?:्ला?|ला?)|\s*गल(?:्ला?|ला?)))|क(?:(?:ा?श(?:ितव(?:ाक्?य|क्?य)|तव(?:ाक्?य|क्?य))|ा?\.)|ा?))|र(?:गट\s*क(?:ी\s*द(?:ी\s*गल(?:्ला?|ला?)|\s*गल(?:्ला?|ला?))|\s*द(?:ी\s*गल(?:्ला?|ला?)|\s*गल(?:्ला?|ला?)))|क(?:(?:ा?श(?:ितव(?:ाक्?य|क्?य)|तव(?:ाक्?य|क्?य))|ा?\.)|ा?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*य(?:ू?हन(?:्ना?|ना?)|ुहन(?:्ना?|ना?)|ू?ह\.|ू?ह)|\s*य(?:ू?हन(?:्ना?|ना?)|ुहन(?:्ना?|ना?)|ू?ह\.|ू?ह)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*य(?:ू?हन(?:्ना?|ना?)|ुहन(?:्ना?|ना?)|ू?ह\.|ू?ह)|\s*य(?:ू?हन(?:्ना?|ना?)|ुहन(?:्ना?|ना?)|ू?ह\.|ू?ह)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*य(?:ू?हन(?:्ना?|ना?)|ुहन(?:्ना?|ना?)|ू?ह\.|ू?ह)|\s*य(?:ू?हन(?:्ना?|ना?)|ुहन(?:्ना?|ना?)|ू?ह\.|ू?ह)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ू?हन(?:्ना?|ना?)|ुहन(?:्ना?|ना?)|ू?ह\.|ू?ह))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:प(?:(?:्र(?:ेर(?:ि[.त]|[.त])|र(?:ि[.त]|[.त]))|र(?:ेर(?:ि[.त]|[.त])|र(?:ि[.त]|[.त])))|(?:्ररि?|ररि?))|शध(?:ाण(?:ूं?|ं)?|ण(?:ूं?|ं)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(र(?:ोम(?:ि(?:यो?ं|\.)|ि(?:यो?)?|यो?ं|यो?|[.ी])?|म(?:ि(?:यो?ं|\.)|ि(?:यो?)?|यो?ं|यो?|[.ी])?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*क(?:ुर(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?|र(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?)|\s*क(?:ुर(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?|र(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*क(?:ुर(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?|र(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?)|\s*क(?:ुर(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?|र(?:ि?न(?:्थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|थ(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ु?स(?:्स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ु?\.|ु)?|ल(?:ु?स(?:्स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ु?\.|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इफ(?:ि(?:स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|\.)?|स(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|\.)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ि?प(?:्प(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|प(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?|ल(?:ि?प(?:्प(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?|प(?:िय(?:ों?|ं)?|य(?:ों?|ं)?|ी)?)|ि?\.|ि)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
          ...
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*त(?:(?:ीमु?थि?य|मु?थि?य|मु?त)ु?स|िम(?:ुतु?स|तु?स)|ीमु?\.|ीमु?|मु?\.|मु?)|\s*त(?:(?:ीमु?थि?य|मु?थि?य|मु?त)ु?स|िम(?:ुतु?स|तु?स)|ीमु?\.|ीमु?|मु?\.|मु?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*त(?:(?:ीमु?थि?य|मु?थि?य|मु?त)ु?स|िम(?:ुतु?स|तु?स)|ीमु?\.|ीमु?|मु?\.|मु?)|\s*त(?:(?:ीमु?थि?य|मु?थि?य|मु?त)ु?स|िम(?:ुतु?स|तु?स)|ीमु?\.|ीमु?|मु?\.|मु?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ीत(?:ु[.स]|[.स])|ितु?स|ीतु?|त(?:ु[.स]|[.स])|तु?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
