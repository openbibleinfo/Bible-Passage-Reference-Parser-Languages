var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["rei"];
    this.translations = [/NTRPT23\b/gi];
    this.first = /1\.?\s*/;
    this.second = /2\.?\s*/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?))|\s*య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?))|\s*య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?))|\s*య(?:ోహ(?:ాను?|ను?)|హ(?:ాను?|ను?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*క(?:ొర(?:ి(?:ంది?|ది?)|ంది?|ది?)|ర(?:ి(?:ంది?|ది?)|ంది?|ది?))|\s*క(?:ొర(?:ి(?:ంది?|ది?)|ంది?|ది?)|ర(?:ి(?:ంది?|ది?)|ంది?|ది?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*క(?:ొర(?:ి(?:ంది?|ది?)|ంది?|ది?)|ర(?:ి(?:ంది?|ది?)|ంది?|ది?))|\s*క(?:ొర(?:ి(?:ంది?|ది?)|ంది?|ది?)|ర(?:ి(?:ంది?|ది?)|ంది?|ది?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(క(?:ొలస(?:్సీ?|సీ?)|లస(?:్సీ?|సీ?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ఎప(?:ేసీ?|సీ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ప(?:ిల(?:ిప(?:్పీ?|పీ?)|ప(?:్పీ?|పీ?))|ల(?:ిప(?:్పీ?|పీ?)|ప(?:్పీ?|పీ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*త(?:ెస(?:్సల(?:ొని?|ని?)|సల(?:ొని?|ని?))|స(?:్సల(?:ొని?|ని?)|సల(?:ొని?|ని?)))|\s*త(?:ెస(?:్సల(?:ొని?|ని?)|సల(?:ొని?|ని?))|స(?:్సల(?:ొని?|ని?)|సల(?:ొని?|ని?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*త(?:ెస(?:్సల(?:ొని?|ని?)|సల(?:ొని?|ని?))|స(?:్సల(?:ొని?|ని?)|సల(?:ొని?|ని?)))|\s*త(?:ెస(?:్సల(?:ొని?|ని?)|సల(?:ొని?|ని?))|స(?:్సల(?:ొని?|ని?)|సల(?:ొని?|ని?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
