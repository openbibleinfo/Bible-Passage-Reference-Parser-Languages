  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:ार(?:्का?स|का?स)?|र(?:्का?स|का?स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(म(?:ात(?:्‍ति?|‍ति?)|त(?:्‍ति?|‍ति?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(म(?:ार(?:्क(?:ुस?|स)?|क(?:ुस?|स)?)|र(?:्क(?:ुस?|स)?|क(?:ुस?|स)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*य(?:ु?ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))|ु)?|\s*य(?:ु?ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*य(?:ु?ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))|ु)?|\s*य(?:ु?ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(३(?:\.\s*य(?:ु?ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))|ु)?|\s*य(?:ु?ह(?:ान(?:्‍ना?|‍ना?)|न(?:्‍ना?|‍ना?))|ु)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(स(?:ेग(?:ुम(?:्‍पा?क|‍पा?क)?|म(?:्‍पा?क|‍पा?क)?)|ग(?:ुम(?:्‍पा?क|‍पा?क)?|म(?:्‍पा?क|‍पा?क)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*क(?:ो?र(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))|ो)?|\s*क(?:ो?र(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))|ो)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ो?र(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))|ो)?|\s*क(?:ो?र(?:िन(?:्‍थि?|‍थि?)|न(?:्‍थि?|‍थि?))|ो)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ाल(?:ा?स(?:्‍सि?|‍सि?)|ा)?|ल(?:ा?स(?:्‍सि?|‍सि?)|ा)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ग(?:ाल(?:ा(?:ति?)?|ति?)?|ल(?:ा(?:ति?)?|ति?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
          ...
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:ि?प(?:्‍पि?|‍पि?)|ि)?|ल(?:ि?प(?:्‍पि?|‍पि?)|ि)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*थ(?:ेस(?:्‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?|स(?:्‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?)|\s*थ(?:ेस(?:्‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?|स(?:्‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*थ(?:ेस(?:्‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?|स(?:्‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?)|\s*थ(?:ेस(?:्‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?|स(?:्‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?))|‍ल(?:ोन(?:िकि?|कि?)|न(?:िकि?|कि?)))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?)|\s*त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?)|\s*त(?:िम(?:ो(?:थि?)?|थि?)?|म(?:ो(?:थि?)?|थि?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(त(?:ित(?:ास?|स)?|त(?:ास?|स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ह(?:िब(?:्‍रु?|‍रु?)|ब(?:्‍रु?|‍रु?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*प(?:ात(?:्‍त(?:ु?रु?स|ु)?|‍त(?:ु?रु?स|ु)?)|त(?:्‍त(?:ु?रु?स|ु)?|‍त(?:ु?रु?स|ु)?))|\s*प(?:ात(?:्‍त(?:ु?रु?स|ु)?|‍त(?:ु?रु?स|ु)?)|त(?:्‍त(?:ु?रु?स|ु)?|‍त(?:ु?रु?स|ु)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*प(?:ात(?:्‍त(?:ु?रु?स|ु)?|‍त(?:ु?रु?स|ु)?)|त(?:्‍त(?:ु?रु?स|ु)?|‍त(?:ु?रु?स|ु)?))|\s*प(?:ात(?:्‍त(?:ु?रु?स|ु)?|‍त(?:ु?रु?स|ु)?)|त(?:्‍त(?:ु?रु?स|ु)?|‍त(?:ु?रु?स|ु)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ाह(?:ु(?:दा?)?|दा?)?|ह(?:ु(?:दा?)?|दा?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
