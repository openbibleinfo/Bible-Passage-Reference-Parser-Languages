var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["rki"];
    this.translations = [/NTRKB24\b/gi];
    this.first = /၁\.?\s*/;
    this.second = /၂\.?\s*/;
    this.third = /၃\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ဗ(?:(?:ျာ?ဒ|ာ?ဒ)(?:ိတ(?:်တ(?:ော?်|ော?|ာ?်|ာ)?|တ(?:ော?်|ော?|ာ?်|ာ)?)|တ(?:်တ(?:ော?်|ော?|ာ?်|ာ)?|တ(?:ော?်|ော?|ာ?်|ာ)?))|ျာ?|ာ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(မ(?:ဿဲ?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(မ(?:ာ(?:ကု?)?|ကု?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(လ(?:ု(?:ကာ?)?|ကာ?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁(?:\.\s*ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?|\s*ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂(?:\.\s*ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?|\s*ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၃(?:\.\s*ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?|\s*ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ယ(?:(?:ော?ဟ|ာ?ဟ)န်?|ော?|ာ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(တ(?:မန(?:်တ(?:ော?်|ော?|ာ?်|ာ)?|တ(?:ော?်|ော?|ာ?်|ာ)?))?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ရ(?:ေ(?:ာမ?|မ)?|ာမ?|မ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁(?:\.\s*က(?:(?:ော?ရ|ာ?ရ)(?:ိန(?:္သု?|သု?)|န(?:္သု?|သု?))|ော?|ာ)?|\s*က(?:(?:ော?ရ|ာ?ရ)(?:ိန(?:္သု?|သု?)|န(?:္သု?|သု?))|ော?|ာ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂(?:\.\s*က(?:(?:ော?ရ|ာ?ရ)(?:ိန(?:္သု?|သု?)|န(?:္သု?|သု?))|ော?|ာ)?|\s*က(?:(?:ော?ရ|ာ?ရ)(?:ိန(?:္သု?|သု?)|န(?:္သု?|သု?))|ော?|ာ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(က(?:(?:ော?လ|ာ?လ)(?:ေ(?:ာသဲ?|သဲ?)|ာသဲ?|သဲ?)|ော?|ာ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ဂလ(?:ာ(?:တိ?)?|တိ?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ဧ(?:ဖက်?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ဖ(?:ိ?လ(?:ိပ(?:္ပိ?|ပိ?)|ပ(?:္ပိ?|ပိ?))|ိ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁(?:\.\s*သက(?:်?သ(?:ာလ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|လ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?)))|်)?|\s*သက(?:်?သ(?:ာလ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|လ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?)))|်)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂(?:\.\s*သက(?:်?သ(?:ာလ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|လ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?)))|်)?|\s*သက(?:်?သ(?:ာလ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|လ(?:ေ(?:ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?))|ာန(?:ိတ်?|တ်?)|န(?:ိတ်?|တ်?)))|်)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁(?:\.\s*တ(?:ိ?မ(?:ေ(?:ာသေ?|သေ?)|ာသေ?|သေ?)|ိ)?|\s*တ(?:ိ?မ(?:ေ(?:ာသေ?|သေ?)|ာသေ?|သေ?)|ိ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂(?:\.\s*တ(?:ိ?မ(?:ေ(?:ာသေ?|သေ?)|ာသေ?|သေ?)|ိ)?|\s*တ(?:ိ?မ(?:ေ(?:ာသေ?|သေ?)|ာသေ?|သေ?)|ိ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(တ(?:ိ(?:တု?)?|တု?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ဖ(?:ိလ(?:ေ?မ(?:ုန်?|န်?)|ေ)?|လ(?:ေ?မ(?:ုန်?|န်?)|ေ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ဟ(?:ေ(?:ဗ(?:ြဲ?|ဲ)?)?|ဗ(?:ြဲ?|ဲ)?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ယ(?:ာ?က(?:ုပ်?|ပ်?)|ာ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၁(?:\.\s*ပ(?:ေ?တရု?|ေ)?|\s*ပ(?:ေ?တရု?|ေ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(၂(?:\.\s*ပ(?:ေ?တရု?|ေ)?|\s*ပ(?:ေ?တရု?|ေ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ယ(?:ုဒ?|ဒ)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
