  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ബ(?:െ?്ള(?:ിപട(?:്ട\s*ക(?:ാര്?യ|ര്?യ)|ട\s*ക(?:ാര്?യ|ര്?യ))|പട(?:്ട\s*ക(?:ാര്?യ|ര്?യ)|ട\s*ക(?:ാര്?യ|ര്?യ)))|െ?ള(?:ിപട(?:്ട\s*ക(?:ാര്?യ|ര്?യ)|ട\s*ക(?:ാര്?യ|ര്?യ))|പട(?:്ട\s*ക(?:ാര്?യ|ര്?യ)|ട\s*ക(?:ാര്?യ|ര്?യ)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(മര(?:്‌ക(?:്ക(?:ോസു?|സു?)|ക(?:ോസു?|സു?))|‌ക(?:്ക(?:ോസു?|സു?)|ക(?:ോസു?|സു?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ല(?:ൂക(?:്ക(?:ോസു?|സു?)|ക(?:ോസു?|സു?))|ക(?:്ക(?:ോസു?|സു?)|ക(?:ോസു?|സു?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ഓഗന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\s*ഓഗന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ഓഗന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\s*ഓഗന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*ഓഗന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\s*ഓഗന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ഓഗന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(അപ(?:്പ(?:ോസ(?:ുത(?:്തല(?:ാര്?|ര്?)|തല(?:ാര്?|ര്?))|ത(?:്തല(?:ാര്?|ര്?)|തല(?:ാര്?|ര്?)))|സ(?:ുത(?:്തല(?:ാര്?|ര്?)|തല(?:ാര്?|ര്?))|ത(?:്തല(?:ാര്?|ര്?)|തല(?:ാര്?|ര്?))))|പ(?:ോസ(?:ുത(?:്തല(?:ാര്?|ര്?)|തല(?:ാര്?|ര്?))|ത(?:്തല(?:ാര്?|ര്?)|തല(?:ാര്?|ര്?)))|സ(?:ുത(?:്തല(?:ാര്?|ര്?)|തല(?:ാര്?|ര്?))|ത(?:്തല(?:ാര്?|ര്?)|തല(?:ാര്?|ര്?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(റ(?:ോമഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|മഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ക(?:ൊര(?:ിന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))))|ര(?:ിന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))))|\s*ക(?:ൊര(?:ിന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))))|ര(?:ിന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ക(?:ൊര(?:ിന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))))|ര(?:ിന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))))|\s*ക(?:ൊര(?:ിന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))))|ര(?:ിന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ന(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ക(?:ൊല(?:േസ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|സ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ല(?:േസ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|സ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ഗല(?:ാത(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|ത(?:്ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|ത(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(എപസ(?:ോസ(?:ുഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|ഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|സ(?:ുഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|ഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(പ(?:ില(?:ിപ(?:്പ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|പ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|പ(?:്പ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|പ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))))|ല(?:ിപ(?:്പ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|പ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))))|പ(?:്പ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))|പ(?:്യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?))|യഗ(?:ാറ(?:ാര്?|ര്?)|റ(?:ാര്?|ര്?)))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ത(?:െസെലോനിക്ക്യഗാറാര്|സലനകകയഗറര)|\s*ത(?:െസെലോനിക്ക്യഗാറാര്|സലനകകയഗറര)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ത(?:െസെലോനിക്ക്യഗാറാര്|സലനകകയഗറര)|\s*ത(?:െസെലോനിക്ക്യഗാറാര്|സലനകകയഗറര)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ത(?:ിമ(?:ിത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?)))|മ(?:ിത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))))|\s*ത(?:ിമ(?:ിത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?)))|മ(?:ിത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ത(?:ിമ(?:ിത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?)))|മ(?:ിത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))))|\s*ത(?:ിമ(?:ിത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?)))|മ(?:ിത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ത(?:ീത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))|ത(?:്ത(?:ോസു?|സു?)|ത(?:ോസു?|സു?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(പ(?:ില(?:െമ(?:ോനു?|നു?)|മ(?:ോനു?|നു?))|ല(?:െമ(?:ോനു?|നു?)|മ(?:ോനു?|നു?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(എവ(?:ുറ(?:ായ(?:ാര്?|ര്?)|യ(?:ാര്?|ര്?))|റ(?:ായ(?:ാര്?|ര്?)|യ(?:ാര്?|ര്?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*പത(?:്ത(?:്‌റ(?:ോസു?|സു?)|‌റ(?:ോസു?|സു?))|ത(?:്‌റ(?:ോസു?|സു?)|‌റ(?:ോസു?|സു?)))|\s*പത(?:്ത(?:്‌റ(?:ോസു?|സു?)|‌റ(?:ോസു?|സു?))|ത(?:്‌റ(?:ോസു?|സു?)|‌റ(?:ോസു?|സു?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*പത(?:്ത(?:്‌റ(?:ോസു?|സു?)|‌റ(?:ോസു?|സു?))|ത(?:്‌റ(?:ോസു?|സു?)|‌റ(?:ോസു?|സു?)))|\s*പത(?:്ത(?:്‌റ(?:ോസു?|സു?)|‌റ(?:ോസു?|സു?))|ത(?:്‌റ(?:ോസു?|സു?)|‌റ(?:ോസു?|സു?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ജ(?:ൂദ(?:ാന്?|ന്?)|ദ(?:ാന്?|ന്?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
