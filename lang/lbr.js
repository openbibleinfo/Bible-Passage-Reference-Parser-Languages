  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(स(?:ेन(?:्‍चि?|‍चि?)|न(?:्‍चि?|‍चि?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(मट(?:्‌टि?|‌टि?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(म(?:ारक(?:ुस?|स)?|रक(?:ुस?|स)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*य(?:ुह(?:ा?न(?:्‍ना?|‍ना?)|ा)?|ह(?:ा?न(?:्‍ना?|‍ना?)|ा)?)|\s*य(?:ुह(?:ा?न(?:्‍ना?|‍ना?)|ा)?|ह(?:ा?न(?:्‍ना?|‍ना?)|ा)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*य(?:ुह(?:ा?न(?:्‍ना?|‍ना?)|ा)?|ह(?:ा?न(?:्‍ना?|‍ना?)|ा)?)|\s*य(?:ुह(?:ा?न(?:्‍ना?|‍ना?)|ा)?|ह(?:ा?न(?:्‍ना?|‍ना?)|ा)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(३(?:\.\s*य(?:ुह(?:ा?न(?:्‍ना?|‍ना?)|ा)?|ह(?:ा?न(?:्‍ना?|‍ना?)|ा)?)|\s*य(?:ुह(?:ा?न(?:्‍ना?|‍ना?)|ा)?|ह(?:ा?न(?:्‍ना?|‍ना?)|ा)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(स(?:ॆ(?:ःक(?:्‍ढ(?:ु?ङ(?:्‌पा?|‌पा?)|ु)?|‍ढ(?:ु?ङ(?:्‌पा?|‌पा?)|ु)?)|क(?:्‍ढ(?:ु?ङ(?:्‌पा?|‌पा?)|ु)?|‍ढ(?:ु?ङ(?:्‌पा?|‌पा?)|ु)?))|ःक(?:्‍ढ(?:ु?ङ(?:्‌पा?|‌पा?)|ु)?|‍ढ(?:ु?ङ(?:्‌पा?|‌पा?)|ु)?)|क(?:्‍ढ(?:ु?ङ(?:्‌पा?|‌पा?)|ु)?|‍ढ(?:ु?ङ(?:्‌पा?|‌पा?)|ु)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*क(?:ो?र(?:ेन(?:्‍ठि?|‍ठि?)|न(?:्‍ठि?|‍ठि?))|ो)?|\s*क(?:ो?र(?:ेन(?:्‍ठि?|‍ठि?)|न(?:्‍ठि?|‍ठि?))|ो)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ो?र(?:ेन(?:्‍ठि?|‍ठि?)|न(?:्‍ठि?|‍ठि?))|ो)?|\s*क(?:ो?र(?:ेन(?:्‍ठि?|‍ठि?)|न(?:्‍ठि?|‍ठि?))|ो)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ग(?:ाल(?:ाटि?|टि?)|ला?टि?|ला?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*ठ(?:ेस(?:ल(?:(?:ोनि?कि|नि?कि)|(?:ोनि?क|नि?क))|्‍स|‍स)|स(?:ल(?:(?:ोनि?कि|नि?कि)|(?:ोनि?क|नि?क))|्‍स|‍स))|\s*ठ(?:ेस(?:ल(?:(?:ोनि?कि|नि?कि)|(?:ोनि?क|नि?क))|्‍स|‍स)|स(?:ल(?:(?:ोनि?कि|नि?कि)|(?:ोनि?क|नि?क))|्‍स|‍स))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*ठ(?:ेस(?:ल(?:(?:ोनि?कि|नि?कि)|(?:ोनि?क|नि?क))|्‍स|‍स)|स(?:ल(?:(?:ोनि?कि|नि?कि)|(?:ोनि?क|नि?क))|्‍स|‍स))|\s*ठ(?:ेस(?:ल(?:(?:ोनि?कि|नि?कि)|(?:ोनि?क|नि?क))|्‍स|‍स)|स(?:ल(?:(?:ोनि?कि|नि?कि)|(?:ोनि?क|नि?क))|्‍स|‍स))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*ट(?:िम(?:ो(?:ठि?)?|ठि?)?|म(?:ो(?:ठि?)?|ठि?)?)|\s*ट(?:िम(?:ो(?:ठि?)?|ठि?)?|म(?:ो(?:ठि?)?|ठि?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*ट(?:िम(?:ो(?:ठि?)?|ठि?)?|म(?:ो(?:ठि?)?|ठि?)?)|\s*ट(?:िम(?:ो(?:ठि?)?|ठि?)?|म(?:ो(?:ठि?)?|ठि?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ट(?:िटस?|टस?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ह(?:िब(?:ु(?:रु?)?|रु?)?|ब(?:ु(?:रु?)?|रु?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*प(?:ाट(?:्?‌रु?स|्)?|ट(?:्?‌रु?स|्)?)|\s*प(?:ाट(?:्?‌रु?स|्)?|ट(?:्?‌रु?स|्)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*प(?:ाट(?:्?‌रु?स|्)?|ट(?:्?‌रु?स|्)?)|\s*प(?:ाट(?:्?‌रु?स|्)?|ट(?:्?‌रु?स|्)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(य(?:ाह(?:ु(?:डा?)?|डा?)?|ह(?:ु(?:डा?)?|डा?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
