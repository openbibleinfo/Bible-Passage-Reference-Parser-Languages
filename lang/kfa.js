  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ಆದ(?:್ಯ(?:ಯತ(?:್‌ರ\s*ಪ(?:ುಸ್?ತಕ|ಸ್?ತಕ)|‌ರ\s*ಪ(?:ುಸ್?ತಕ|ಸ್?ತಕ))|ತ(?:್‌ರ\s*ಪ(?:ುಸ್?ತಕ|ಸ್?ತಕ)|‌ರ\s*ಪ(?:ುಸ್?ತಕ|ಸ್?ತಕ)))|ಯ(?:ಯತ(?:್‌ರ\s*ಪ(?:ುಸ್?ತಕ|ಸ್?ತಕ)|‌ರ\s*ಪ(?:ುಸ್?ತಕ|ಸ್?ತಕ))|ತ(?:್‌ರ\s*ಪ(?:ುಸ್?ತಕ|ಸ್?ತಕ)|‌ರ\s*ಪ(?:ುಸ್?ತಕ|ಸ್?ತಕ)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rev"],
            testament: "n",
          ...
          },
          {
            osis: ["Esth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ಎಸ(?:್ತ(?:ೆರ್?‌|ರ್?‌)|ತ(?:ೆರ್?‌|ರ್?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Prov"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ಜ(?:್ಞ(?:ಾನತ(?:್‌ರ\s*ಪಡಿ?ಮ|‌ರ\s*ಪಡಿ?ಮ)|ನತ(?:್‌ರ\s*ಪಡಿ?ಮ|‌ರ\s*ಪಡಿ?ಮ))|ಞ(?:ಾನತ(?:್‌ರ\s*ಪಡಿ?ಮ|‌ರ\s*ಪಡಿ?ಮ)|ನತ(?:್‌ರ\s*ಪಡಿ?ಮ|‌ರ\s*ಪಡಿ?ಮ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jonah"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ಯೋ?ನ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mal"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ಮಲ(?:ಾಕಿ?|ಕಿ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಲೂ?ಕ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ಯ(?:ೋಹಾ?ನ|ಹಾ?ನ)|\s*ಯ(?:ೋಹಾ?ನ|ಹಾ?ನ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ಯ(?:ೋಹಾ?ನ|ಹಾ?ನ)|\s*ಯ(?:ೋಹಾ?ನ|ಹಾ?ನ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*ಯ(?:ೋಹಾ?ನ|ಹಾ?ನ)|\s*ಯ(?:ೋಹಾ?ನ|ಹಾ?ನ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಯ(?:ೋಹಾ?ನ|ಹಾ?ನ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಅಪ(?:ೊಸ್?ತಲ|ಸ್?ತಲ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ರ(?:ೋಮ್?|ಮ್?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ಕ(?:ೊರ(?:ಿಂ?ಥ|ಂ?ಥ)|ರ(?:ಿಂ?ಥ|ಂ?ಥ))|\s*ಕ(?:ೊರ(?:ಿಂ?ಥ|ಂ?ಥ)|ರ(?:ಿಂ?ಥ|ಂ?ಥ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
          ...
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಕ(?:ೊಲ(?:ೊಸ(?:್ಸೆ?|ಸೆ?)|ಸ(?:್ಸೆ?|ಸೆ?))|ಲ(?:ೊಸ(?:್ಸೆ?|ಸೆ?)|ಸ(?:್ಸೆ?|ಸೆ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ಥ(?:ೆಸಲ(?:ೊನೀ?ಕ|ನೀ?ಕ)|ಸಲ(?:ೊನೀ?ಕ|ನೀ?ಕ))|\s*ಥ(?:ೆಸಲ(?:ೊನೀ?ಕ|ನೀ?ಕ)|ಸಲ(?:ೊನೀ?ಕ|ನೀ?ಕ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ಥ(?:ೆಸಲ(?:ೊನೀ?ಕ|ನೀ?ಕ)|ಸಲ(?:ೊನೀ?ಕ|ನೀ?ಕ))|\s*ಥ(?:ೆಸಲ(?:ೊನೀ?ಕ|ನೀ?ಕ)|ಸಲ(?:ೊನೀ?ಕ|ನೀ?ಕ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ತ(?:ಿಮ(?:ೊಥೆ?ಯ|ಥೆ?ಯ)|ಮ(?:ೊಥೆ?ಯ|ಥೆ?ಯ))|\s*ತ(?:ಿಮ(?:ೊಥೆ?ಯ|ಥೆ?ಯ)|ಮ(?:ೊಥೆ?ಯ|ಥೆ?ಯ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ತ(?:ಿಮ(?:ೊಥೆ?ಯ|ಥೆ?ಯ)|ಮ(?:ೊಥೆ?ಯ|ಥೆ?ಯ))|\s*ತ(?:ಿಮ(?:ೊಥೆ?ಯ|ಥೆ?ಯ)|ಮ(?:ೊಥೆ?ಯ|ಥೆ?ಯ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಫ(?:ಿಲ(?:ೆಮೋ?ನ|ಮೋ?ನ)|ಲ(?:ೆಮೋ?ನ|ಮೋ?ನ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
          ...
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಯ(?:ಾಕೋ?ಬ|ಕೋ?ಬ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ಪ(?:ೇತ್?ರ|ತ್?ರ)|\s*ಪ(?:ೇತ್?ರ|ತ್?ರ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ಪ(?:ೇತ್?ರ|ತ್?ರ)|\s*ಪ(?:ೇತ್?ರ|ತ್?ರ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ಯೂ?ದ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
