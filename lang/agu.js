var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["agu"];
    this.translations = [/AGU(?:NT)?\b/gi];
    this.first = /(?:1\.?\s*|Bajx\.?\s*)/;
    this.second = /(?:2\.?\s*|Ca\x27p\.?\s*|Ca’p\.?\s*|Caꞌp\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["1Sam"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Bajx(?:\.\s*S(?:amuel)?|\s*S(?:amuel)?)|1(?:\.\s*S(?:amuel)?|\s*S(?:amuel)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Sam"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ca['’ꞌ]p(?:\.\s*S(?:amuel)?|\s*S(?:amuel)?)|2(?:\.\s*S(?:amuel)?|\s*S(?:amuel)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Sam"],
            testament: "o",
          ...
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Toxi['’ꞌ]n\s*Juan|3\s*Jn))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Bajx(?:\.\s*J(?:ua)?n|\s*J(?:ua)?n)|1(?:\.\s*J(?:ua)?n|\s*J(?:ua)?n)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ca['’ꞌ]p(?:\.\s*J(?:ua)?n|\s*J(?:ua)?n)|2(?:\.\s*J(?:ua)?n|\s*J(?:ua)?n)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Bajx(?:\.\s*Co(?:rintios)?|\s*Co(?:rintios)?)|1(?:\.\s*Co(?:rintios)?|\s*Co(?:rintios)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ca['’ꞌ]p(?:\.\s*Co(?:rintios)?|\s*Co(?:rintios)?)|2(?:\.\s*Co(?:rintios)?|\s*Co(?:rintios)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
          ...
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Bajx(?:\.\s*T(?:esalonicense)?s|\s*T(?:esalonicense)?s)|1(?:\.\s*T(?:esalonicense)?s|\s*T(?:esalonicense)?s)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ca['’ꞌ]p(?:\.\s*T(?:esalonicense)?s|\s*T(?:esalonicense)?s)|2(?:\.\s*T(?:esalonicense)?s|\s*T(?:esalonicense)?s)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Bajx(?:\.\s*Ti(?:moteo)?|\s*Ti(?:moteo)?)|1(?:\.\s*Ti(?:moteo)?|\s*Ti(?:moteo)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ca['’ꞌ]p(?:\.\s*Ti(?:moteo)?|\s*Ti(?:moteo)?)|2(?:\.\s*Ti(?:moteo)?|\s*Ti(?:moteo)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
          ...
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Bajx(?:\.\s*Pe(?:dro)?|\s*Pe(?:dro)?)|1(?:\.\s*Pe(?:dro)?|\s*Pe(?:dro)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Ca['’ꞌ]p(?:\.\s*Pe(?:dro)?|\s*Pe(?:dro)?)|2(?:\.\s*Pe(?:dro)?|\s*Pe(?:dro)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
