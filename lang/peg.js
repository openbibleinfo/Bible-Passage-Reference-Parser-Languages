var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["peg"];
    this.translations = [/(?:NTNOO20|PEGNT)\b/gi];
    this.first = /୧\.?\s*/;
    this.second = /୨\.?\s*/;
    this.third = /୩\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ୱ(?:(?:େଚ(?:୍?‍ଚ(?:ି\s*ବେ?ଣ୍|\s*ବେ?ଣ୍)|୍?\.)|ଚ(?:୍?‍ଚ(?:ି\s*ବେ?ଣ୍|\s*ବେ?ଣ୍)|୍?\.))|(?:େଚ୍?‍ଚ(?:ି\s*ବେ?ଣ|\s*ବେ?ଣ)|ଚ୍?‍ଚ(?:ି\s*ବେ?ଣ|\s*ବେ?ଣ)))|ହତ(?:୍‌ତି?|‌ତି?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ମ(?:ା(?:ଥ(?:ି[.ଉ]|[.ଉ])|ତି?ଉ)|ଥ(?:ି[.ଉ]|[.ଉ])|ତି?ଉ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ମ(?:ାର(?:୍କ\.?|କ\.?)|ର(?:୍କ\.?|କ\.?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଲ(?:ୁକ\.?|କ\.?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*(?:ଯ(?:ୋ?ହନ\.|ୋ?ହନ)|ଜହନ୍?‌)|\s*(?:ଯ(?:ୋ?ହନ\.|ୋ?ହନ)|ଜହନ୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*(?:ଯ(?:ୋ?ହନ\.|ୋ?ହନ)|ଜହନ୍?‌)|\s*(?:ଯ(?:ୋ?ହନ\.|ୋ?ହନ)|ଜହନ୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୩(?:\.\s*(?:ଯ(?:ୋ?ହନ\.|ୋ?ହନ)|ଜହନ୍?‌)|\s*(?:ଯ(?:ୋ?ହନ\.|ୋ?ହନ)|ଜହନ୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଯ(?:ୋ?ହନ\.|ୋ?ହନ)|ଜହନ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ବ(?:ାଚିକିତି\s*ଚେଲାହିର୍\s*କାତା|ଚକତ\s*ଚଲହର\s*କତ)|ପକ(?:୍ୟ(?:ାତା?କା|ତା?କା)|ୟ(?:ାତା?କା|ତା?କା))|ପକ(?:୍ୟ(?:ାତା?କ|ତା?କ)|ୟ(?:ାତା?କ|ତା?କ))|କ(?:ାମ(?:ାୟ୍?\.|ୟ୍?\.)|ମ(?:ାୟ୍?\.|ୟ୍?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ର(?:ୋମ(?:ି[.ୟ]|[.ୟ])|ମ(?:ି[.ୟ]|[.ୟ])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*କର(?:ିନ୍?ଥି?ୟ|ନ(?:୍[ତଥ]ି?ୟ|[ତଥ]ି?ୟ)|ି?\.)|\s*କର(?:ିନ୍?ଥି?ୟ|ନ(?:୍[ତଥ]ି?ୟ|[ତଥ]ି?ୟ)|ି?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*କର(?:ନ(?:୍ତି?ୟ|ତି?ୟ)|ି?\.)|\s*କର(?:ନ(?:୍ତି?ୟ|ତି?ୟ)|ି?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨କରନ(?:୍ତି?ୟ|ତି?ୟ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(କଲ(?:ସ(?:[ିୀ])?ୟ|\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଗ(?:ାଲ(?:ା?ତି?ୟ|ା?\.)|ଲ(?:ା?ତି?ୟ|ା?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଏ(?:ଫି?ସୀୟ|ପ(?:ିସି?ୟ|ସି?ୟ)|ଫ(?:ି?ସୟ|ି?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଫ(?:ିଲୀ?ପ|ଲୀ?ପ)ି?ୟ|ପ(?:ିଲ(?:ିପି?ୟ|ପି?ୟ)|ଲ(?:ିପି?ୟ|ପି?ୟ))|ଫ(?:ିଲୀ?\.|ଲୀ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*(?:ତ(?:େସ(?:୍‌ଲନ(?:ିକି?|କି?)|‌ଲନ(?:ିକି?|କି?))|ସ(?:୍‌ଲନ(?:ିକି?|କି?)|‌ଲନ(?:ିକି?|କି?)))|ଥ(?:େସ(?:ଲନ(?:ୀକି?ୟ|କି?ୟ)|\.)|ସ(?:ଲନ(?:ୀକି?ୟ|କି?ୟ)|\.)))|\s*(?:ତ(?:େସ(?:୍‌ଲନ(?:ିକି?|କି?)|‌ଲନ(?:ିକି?|କି?))|ସ(?:୍‌ଲନ(?:ିକି?|କି?)|‌ଲନ(?:ିକି?|କି?)))|ଥ(?:େସ(?:ଲନ(?:ୀକି?ୟ|କି?ୟ)|\.)|ସ(?:ଲନ(?:ୀକି?ୟ|କି?ୟ)|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*(?:ତ(?:େସ(?:୍‌ଲନ(?:ିକି?|କି?)|‌ଲନ(?:ିକି?|କି?))|ସ(?:୍‌ଲନ(?:ିକି?|କି?)|‌ଲନ(?:ିକି?|କି?)))|ଥ(?:େସ(?:ଲନ(?:ୀକି?ୟ|କି?ୟ)|\.)|ସ(?:ଲନ(?:ୀକି?ୟ|କି?ୟ)|\.)))|\s*(?:ତ(?:େସ(?:୍‌ଲନ(?:ିକି?|କି?)|‌ଲନ(?:ିକି?|କି?))|ସ(?:୍‌ଲନ(?:ିକି?|କି?)|‌ଲନ(?:ିକି?|କି?)))|ଥ(?:େସ(?:ଲନ(?:ୀକି?ୟ|କି?ୟ)|\.)|ସ(?:ଲନ(?:ୀକି?ୟ|କି?ୟ)|\.)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ତ(?:ିମ(?:[ତଥ]ି?|\.)|ମ(?:[ତଥ]ି?|\.))|\s*ତ(?:ିମ(?:[ତଥ]ି?|\.)|ମ(?:[ତଥ]ି?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ତ(?:ିମ(?:ଥି?|\.)|ମ(?:ଥି?|\.))|\s*ତ(?:ିମ(?:ଥି?|\.)|ମ(?:ଥି?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ତ(?:ୀତ[.ସ]|ତ[.ସ]))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ପ(?:ିଲ(?:ିମନ୍?‌|ମନ୍?‌)|ଲ(?:ିମନ୍?‌|ମନ୍?‌))|ଫ(?:ିଲ(?:ୀମ(?:ୋ[.ନ]|[.ନ])|ମ(?:ୋ[.ନ]|[.ନ]))|ଲ(?:ୀମ(?:ୋ[.ନ]|[.ନ])|ମ(?:ୋ[.ନ]|[.ନ])))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଏବ(?:୍ର(?:ୀ\.?|[.ି])?|ର(?:ୀ\.?|[.ି])?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଜ(?:ାକ୍?‌ବ|କ୍?‌ବ)|ଯ(?:ାକ(?:ୁ[.ବ]|[.ବ])|କ(?:ୁ[.ବ]|[.ବ]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ପ(?:ିତ(?:ର(?:୍‌(?:ତି?)?|‌(?:ତି?)?)?|\.)|ତ(?:ର(?:୍‌(?:ତି?)?|‌(?:ତି?)?)?|\.))|\s*ପ(?:ିତ(?:ର(?:୍‌(?:ତି?)?|‌(?:ତି?)?)?|\.)|ତ(?:ର(?:୍‌(?:ତି?)?|‌(?:ତି?)?)?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ପ(?:ିତ(?:ର(?:୍‌(?:ତି?)?|‌(?:ତି?)?)?|\.)|ତ(?:ର(?:୍‌(?:ତି?)?|‌(?:ତି?)?)?|\.))|\s*ପ(?:ିତ(?:ର(?:୍‌(?:ତି?)?|‌(?:ତି?)?)?|\.)|ତ(?:ର(?:୍‌(?:ତି?)?|‌(?:ତି?)?)?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ଯ(?:ିହୁ?ଦ|ହୁ?ଦ)ା?|ଜ(?:ିହ(?:ୁଦା?|ଦା?)|ହ(?:ୁଦା?|ଦା?))|ଯ(?:ିହୁ?\.|ହୁ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
