var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["apd"];
    this.translations = [/APD2024\b/gi];
    this.first = /(?:1\.?\s*|١\.?\s*)/;
    this.second = /(?:2\.?\s*|٢\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ru’ya|ر[ؤو]يا))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:م(?:َت(?:َ?ّ|َ?)ى|ت(?:َ?ّ|َ?)ى)|Matta))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ing[iī]l\s*Marqus|م(?:َر(?:ْقُ?س|قُ?س)|ر(?:ْقُ?س|قُ?س))|Markus|Marqus|Mark))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ل(?:ُوقَ?ا|وقَ?ا)|Luuga))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:٣\s*ي(?:ُوح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا)|وح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا))|3\s*Yuu(?:[hḥ]anna|[hḥ])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1١](?:\.\s*(?:ي(?:ُوح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا)|وح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا))|Yuu(?:[hḥ]anna|[hḥ]))|\s*(?:ي(?:ُوح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا)|وح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا))|Yuu(?:[hḥ]anna|[hḥ]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2٢](?:\.\s*(?:ي(?:ُوح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا)|وح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا))|Yuu(?:[hḥ]anna|[hḥ]))|\s*(?:ي(?:ُوح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا)|وح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا))|Yuu(?:[hḥ]anna|[hḥ]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ي(?:ُوح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا)|وح(?:َن(?:َ?ّ|َ?)ا|ن(?:َ?ّ|َ?)ا))|Yuu(?:[hḥ]anna|[hḥ])))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:[أا]عمال\s*الر(?:ُ?ّسُ?ل|ُ?سُ?ل)|Avm(?:aal)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ر(?:ُوم(?:ِيَ?ه|يَ?ه)|وم(?:ِيَ?ه|يَ?ه))|Ruum(?:iya)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1١](?:\.\s*(?:ك(?:ُور(?:ِن(?:ْثُ?وس|ثُ?وس)|ن(?:ْثُ?وس|ثُ?وس))|ور(?:ِن(?:ْثُ?وس|ثُ?وس)|ن(?:ْثُ?وس|ثُ?وس)))|Kuur(?:intuus)?)|\s*(?:ك(?:ُور(?:ِن(?:ْثُ?وس|ثُ?وس)|ن(?:ْثُ?وس|ثُ?وس))|ور(?:ِن(?:ْثُ?وس|ثُ?وس)|ن(?:ْثُ?وس|ثُ?وس)))|Kuur(?:intuus)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2٢](?:\.\s*(?:ك(?:ُور(?:ِن(?:ْثُ?وس|ثُ?وس)|ن(?:ْثُ?وس|ثُ?وس))|ور(?:ِن(?:ْثُ?وس|ثُ?وس)|ن(?:ْثُ?وس|ثُ?وس)))|Kuur(?:intuus)?)|\s*(?:ك(?:ُور(?:ِن(?:ْثُ?وس|ثُ?وس)|ن(?:ْثُ?وس|ثُ?وس))|ور(?:ِن(?:ْثُ?وس|ثُ?وس)|ن(?:ْثُ?وس|ثُ?وس)))|Kuur(?:intuus)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ك(?:ُول(?:ُوس(?:ِ?ّ|ِ?)ي|وس(?:ِ?ّ|ِ?)ي)|ول(?:ُوس(?:ِ?ّ|ِ?)ي|وس(?:ِ?ّ|ِ?)ي))|Kuul(?:uussi)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ghal(?:aa[tṭ]iyya)?|غ(?:َل(?:َاط(?:ِي(?:َ?ّ|َ?)ه|ي(?:َ?ّ|َ?)ه)|اط(?:ِي(?:َ?ّ|َ?)ه|ي(?:َ?ّ|َ?)ه))|ل(?:َاط(?:ِي(?:َ?ّ|َ?)ه|ي(?:َ?ّ|َ?)ه)|اط(?:ِي(?:َ?ّ|َ?)ه|ي(?:َ?ّ|َ?)ه)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Afas(?:us)?|[أا]ف(?:َسُ?س|سُ?س)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Fiilib(?:bi)?|فيل(?:ِبّ?ي|بّ?ي)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1١](?:\.\s*(?:ت(?:َس(?:َال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))|ال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي)))|س(?:َال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))|ال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))))|Tas(?:aluniiki)?)|\s*(?:ت(?:َس(?:َال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))|ال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي)))|س(?:َال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))|ال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))))|Tas(?:aluniiki)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2٢](?:\.\s*(?:ت(?:َس(?:َال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))|ال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي)))|س(?:َال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))|ال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))))|Tas(?:aluniiki)?)|\s*(?:ت(?:َس(?:َال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))|ال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي)))|س(?:َال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))|ال(?:ُون(?:ِيكِ?ي|يكِ?ي)|ون(?:ِيكِ?ي|يكِ?ي))))|Tas(?:aluniiki)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1١](?:\.\s*(?:ت(?:ِيم(?:ُوث(?:َاوُ?س|اوُ?س)|وث(?:َاوُ?س|اوُ?س))|يم(?:ُوث(?:َاوُ?س|اوُ?س)|وث(?:َاوُ?س|اوُ?س)))|Tim(?:utaawus)?)|\s*(?:ت(?:ِيم(?:ُوث(?:َاوُ?س|اوُ?س)|وث(?:َاوُ?س|اوُ?س))|يم(?:ُوث(?:َاوُ?س|اوُ?س)|وث(?:َاوُ?س|اوُ?س)))|Tim(?:utaawus)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2٢](?:\.\s*(?:ت(?:ِيم(?:ُوث(?:َاوُ?س|اوُ?س)|وث(?:َاوُ?س|اوُ?س))|يم(?:ُوث(?:َاوُ?س|اوُ?س)|وث(?:َاوُ?س|اوُ?س)))|Tim(?:utaawus)?)|\s*(?:ت(?:ِيم(?:ُوث(?:َاوُ?س|اوُ?س)|وث(?:َاوُ?س|اوُ?س))|يم(?:ُوث(?:َاوُ?س|اوُ?س)|وث(?:َاوُ?س|اوُ?س)))|Tim(?:utaawus)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Tii(?:[tṭ]us|[tṭ])|ت(?:ِيطُ?س|يطُ?س)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ف(?:ِل(?:ِيمُ?ون|يمُ?ون)|ل(?:ِيمُ?ون|يمُ?ون))|Fili(?:muun|im)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Vib(?:raaniyyiin)?|عِ?برانيين))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ي(?:َع(?:ْقُ?وب|قُ?وب)|ع(?:ْقُ?وب|قُ?وب))|Yav(?:kuub)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([1١](?:\.\s*(?:ب(?:ُط(?:ْرُ?س|رُ?س)|ط(?:ْرُ?س|رُ?س))|Bu(?:[tṭ]rus|[tṭ]))|\s*(?:ب(?:ُط(?:ْرُ?س|رُ?س)|ط(?:ْرُ?س|رُ?س))|Bu(?:[tṭ]rus|[tṭ]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([2٢](?:\.\s*(?:ب(?:ُط(?:ْرُ?س|رُ?س)|ط(?:ْرُ?س|رُ?س))|Bu(?:[tṭ]rus|[tṭ]))|\s*(?:ب(?:ُط(?:ْرُ?س|رُ?س)|ط(?:ْرُ?س|رُ?س))|Bu(?:[tṭ]rus|[tṭ]))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ي(?:َه(?:ُوذَ?ا|وذَ?ا)|ه(?:ُوذَ?ا|وذَ?ا))|Yah(?:uuza)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
