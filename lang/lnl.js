var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["lnl"];
    this.translations = [/LNL\b/gi];
    this.first = /(?:1\.?\s*|Dokʉ̈\.?\s*|Dokʉ\.?\s*)/;
    this.second = /(?:2\.?\s*|Bïchuû\.?\s*|Bichuu\.?\s*|Bïchuu\.?\s*|Bichuû\.?\s*)/;
    this.third = /3\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ap(?:[oö]k[aä]l[iî]b[iï]chi|k))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Mat(?:iyə̈?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(M(?:ar(?:eke)?|âreke))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(L(?:uke?|ûke))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:V[oö]ta[aâ]\s*J[aâ]an|3\s*Jan))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dokʉ(?:̈(?:\.\s*J(?:aa?|âa)n|\s*J(?:aa?|âa)n)|\.\s*J(?:aa?|âa)n|\s*J(?:aa?|âa)n)|1(?:\.\s*J(?:aa?|âa)n|\s*J(?:aa?|âa)n)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:B[iï]chu[uû](?:\.\s*J(?:aa?|âa)n|\s*J(?:aa?|âa)n)|2(?:\.\s*J(?:aa?|âa)n|\s*J(?:aa?|âa)n)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(J(?:aa?|âa)n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ab(?:adj[aâ]ngele|dj))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(R(?:omo?|ômo))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dokʉ(?:̈(?:\.\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte)|\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte))|\.\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte)|\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte))|1(?:\.\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte)|\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:B[iï]chu[uû](?:\.\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte)|\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte))|2(?:\.\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte)|\s*K(?:or(?:ɛ̂?nte)?|örɛ̂?nte))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(K(?:ol[oô]se|öl[oô]se|ol))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(G(?:al[aâ]te|äl[aâ]te|al))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ef(?:e(?:ze)?|êze)|Ëf[eê]ze))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F(?:[iï]l[iî]pe|lp))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dokʉ(?:̈(?:\.\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es)|\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es))|\.\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es)|\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es))|1(?:\.\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es)|\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:B[iï]chu[uû](?:\.\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es)|\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es))|2(?:\.\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es)|\s*T(?:es[aä]l[oö]n[iî]ke|ës[aä]l[oö]n[iî]ke|es))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dokʉ(?:̈(?:\.\s*Tim(?:ot[eë])?|\s*Tim(?:ot[eë])?)|\.\s*Tim(?:ot[eë])?|\s*Tim(?:ot[eë])?)|1(?:\.\s*Tim(?:ot[eë])?|\s*Tim(?:ot[eë])?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:B[iï]chu[uû](?:\.\s*Tim(?:ot[eë])?|\s*Tim(?:ot[eë])?)|2(?:\.\s*Tim(?:ot[eë])?|\s*Tim(?:ot[eë])?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(T(?:ite?|îte))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(F(?:ilem[oö]n|lm))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:Ahebor[oö]|aHe))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(J(?:ake?|âke))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Dokʉ(?:̈(?:\.\s*P(?:i(?:e(?:re)?|êre)|î[eê]re)|\s*P(?:i(?:e(?:re)?|êre)|î[eê]re))|\.\s*P(?:i(?:e(?:re)?|êre)|î[eê]re)|\s*P(?:i(?:e(?:re)?|êre)|î[eê]re))|1(?:\.\s*P(?:i(?:e(?:re)?|êre)|î[eê]re)|\s*P(?:i(?:e(?:re)?|êre)|î[eê]re))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:B[iï]chu[uû](?:\.\s*P(?:i(?:e(?:re)?|êre)|î[eê]re)|\s*P(?:i(?:e(?:re)?|êre)|î[eê]re))|2(?:\.\s*P(?:i(?:e(?:re)?|êre)|î[eê]re)|\s*P(?:i(?:e(?:re)?|êre)|î[eê]re))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(J(?:ude?|ûde))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
