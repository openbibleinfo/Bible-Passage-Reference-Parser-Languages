  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(വ(?:െള(?:ി?പ(?:്പ(?:ാട്?|ട്?)|പ(?:ാട്?|ട്?))|ി?\.)|ള(?:ി?പ(?:്പ(?:ാട്?|ട്?)|പ(?:ാട്?|ട്?))|ി?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(മര(?:ു?ക(?:്ക(?:ോശ്?|ശ്?)|ക(?:ോശ്?|ശ്?))|ു?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ഓക(?:ന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\.)|\s*ഓക(?:ന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ഓക(?:ന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\.)|\s*ഓക(?:ന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*ഓക(?:ന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\.)|\s*ഓക(?:ന(?:്ന(?:ാന്?|ന്?)|ന(?:ാന്?|ന്?))|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(അപ(?:്പ(?:ോ(?:ശ്‌ത്തലര്\s*തെയ്‌വ\s*വേലെ|\.)|\.)|പ(?:ശ‌തതലര\s*തയ‌വ\s*വല|ോ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(റ(?:ോമ(?:ര്?|\.)|മ(?:ര്?|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ക(?:ൊര(?:ി?ന(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ി?\.)|ര(?:ി?ന(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ി?\.))|\s*ക(?:ൊര(?:ി?ന(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ി?\.)|ര(?:ി?ന(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ി?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ക(?:ൊര(?:ി?ന(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ി?\.)|ര(?:ി?ന(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ി?\.))|\s*ക(?:ൊര(?:ി?ന(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ി?\.)|ര(?:ി?ന(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ി?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ക(?:ൊല(?:ോ?ശ(?:ിയര്?|യര്?)|ോ?\.)|ല(?:ോ?ശ(?:ിയര്?|യര്?)|ോ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ക(?:െല(?:ാ?ത(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ാ?\.)|ല(?:ാ?ത(?:്ത(?:ിയര്?|യര്?)|ത(?:ിയര്?|യര്?))|ാ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(എപ(?:േ?ശ(?:ിയര്?|യര്?)|േ?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(പ(?:ില(?:ി?പ(?:്പ(?:ിയര്?|യര്?)|പ(?:ിയര്?|യര്?))|ി?\.)|ല(?:ി?പ(?:്പ(?:ിയര്?|യര്?)|പ(?:ിയര്?|യര്?))|ി?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ത(?:െശല(?:ോ?ന(?:ിയര്?|യര്?)|ോ?\.)|ശല(?:ോ?ന(?:ിയര്?|യര്?)|ോ?\.))|\s*ത(?:െശല(?:ോ?ന(?:ിയര്?|യര്?)|ോ?\.)|ശല(?:ോ?ന(?:ിയര്?|യര്?)|ോ?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ത(?:െശല(?:ോ?ന(?:ിയര്?|യര്?)|ോ?\.)|ശല(?:ോ?ന(?:ിയര്?|യര്?)|ോ?\.))|\s*ത(?:െശല(?:ോ?ന(?:ിയര്?|യര്?)|ോ?\.)|ശല(?:ോ?ന(?:ിയര്?|യര്?)|ോ?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ത(?:ിമ(?:ോ?ത(?:്ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?))|ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?)))|ോ?\.)|മ(?:ോ?ത(?:്ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?))|ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?)))|ോ?\.))|\s*ത(?:ിമ(?:ോ?ത(?:്ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?))|ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?)))|ോ?\.)|മ(?:ോ?ത(?:്ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?))|ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?)))|ോ?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ത(?:ിമ(?:ോ?ത(?:്ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?))|ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?)))|ോ?\.)|മ(?:ോ?ത(?:്ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?))|ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?)))|ോ?\.))|\s*ത(?:ിമ(?:ോ?ത(?:്ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?))|ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?)))|ോ?\.)|മ(?:ോ?ത(?:്ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?))|ത(?:ിയ(?:ോശ്?|ശ്?)|യ(?:ോശ്?|ശ്?)))|ോ?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ത(?:ീത(?:്ത(?:ോ(?:ശ്?|\.)|ശ്?|\.)|ത(?:ോ(?:ശ്?|\.)|ശ്?|\.))|ത(?:്ത(?:ോ(?:ശ്?|\.)|ശ്?|\.)|ത(?:ോ(?:ശ്?|\.)|ശ്?|\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(പ(?:ില(?:േ?മ(?:ോന്?|ന്?)|േ?\.)|ല(?:േ?മ(?:ോന്?|ന്?)|േ?\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(എബ(?:ു?റ(?:ായര്?|യര്?)|ു?\.))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ആക(?:്ക(?:ോ(?:വ്?|\.)|വ്?|\.)|ക(?:ോ(?:വ്?|\.)|വ്?|\.)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*പത(?:്ത(?:ി?ര(?:ോശ്?|ശ്?)|ി?\.)|ത(?:ി?ര(?:ോശ്?|ശ്?)|ി?\.))|\s*പത(?:്ത(?:ി?ര(?:ോശ്?|ശ്?)|ി?\.)|ത(?:ി?ര(?:ോശ്?|ശ്?)|ി?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*പത(?:്ത(?:ി?ര(?:ോശ്?|ശ്?)|ി?\.)|ത(?:ി?ര(?:ോശ്?|ശ്?)|ി?\.))|\s*പത(?:്ത(?:ി?ര(?:ോശ്?|ശ്?)|ി?\.)|ത(?:ി?ര(?:ോശ്?|ശ്?)|ി?\.))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ഊത(?:ാ\.?|\.)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
