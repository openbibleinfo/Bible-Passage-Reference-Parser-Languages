  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ప(?:్రక(?:టన)?|రక(?:టన)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(మత(?:్త(?:యి?)?|త(?:యి?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(మ(?:ార(?:్కు?|కు?)|ర(?:్కు?|కు?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ల(?:ూకా?|కా?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*య(?:ోహ(?:ా(?:ను?)?|ను?)?|హ(?:ా(?:ను?)?|ను?)?)|\s*య(?:ోహ(?:ా(?:ను?)?|ను?)?|హ(?:ా(?:ను?)?|ను?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*య(?:ోహ(?:ా(?:ను?)?|ను?)?|హ(?:ా(?:ను?)?|ను?)?)|\s*య(?:ోహ(?:ా(?:ను?)?|ను?)?|హ(?:ా(?:ను?)?|ను?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(3(?:\.\s*య(?:ోహ(?:ా(?:ను?)?|ను?)?|హ(?:ా(?:ను?)?|ను?)?)|\s*య(?:ోహ(?:ా(?:ను?)?|ను?)?|హ(?:ా(?:ను?)?|ను?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(య(?:ోహ(?:ా(?:ను?)?|ను?)?|హ(?:ా(?:ను?)?|ను?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(బ(?:ార(?:ి?క(?:ుల(?:్\s*కమ(?:్మొ?|మొ?)|\s*కమ(?:్మొ?|మొ?))|ల(?:్\s*కమ(?:్మొ?|మొ?)|\s*కమ(?:్మొ?|మొ?)))|ి?\s*కమ(?:్మొ?|మొ?))|ర(?:ి?క(?:ుల(?:్\s*కమ(?:్మొ?|మొ?)|\s*కమ(?:్మొ?|మొ?))|ల(?:్\s*కమ(?:్మొ?|మొ?)|\s*కమ(?:్మొ?|మొ?)))|ి?\s*కమ(?:్మొ?|మొ?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ర(?:ోమా?|మా?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*క(?:ొర(?:ి?ంది?|ి?ది?|ి)?|ర(?:ి?ంది?|ి?ది?|ి)?)|\s*క(?:ొర(?:ి?ంది?|ి?ది?|ి)?|ర(?:ి?ంది?|ి?ది?|ి)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*క(?:ొర(?:ి?ంది?|ి?ది?|ి)?|ర(?:ి?ంది?|ి?ది?|ి)?)|\s*క(?:ొర(?:ి?ంది?|ి?ది?|ి)?|ర(?:ి?ంది?|ి?ది?|ి)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(క(?:ొల(?:స(?:్సి?|సి?))?|ల(?:స(?:్సి?|సి?))?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(గల(?:తి?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ఎప(?:ె(?:సి?)?|సి?)?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ప(?:ిల(?:ి?ప(?:్పి?|పి?)|ి)?|ల(?:ి?ప(?:్పి?|పి?)|ి)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ద(?:ెస్?స|స్?స)|\s*ద(?:ెస్?స|స్?స)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ద(?:ెస్?స|స్?స)|\s*ద(?:ెస్?స|స్?స)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*త(?:ిమ(?:ో(?:తి?)?|తి?)?|మ(?:ో(?:తి?)?|తి?)?)|\s*త(?:ిమ(?:ో(?:తి?)?|తి?)?|మ(?:ో(?:తి?)?|తి?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*త(?:ిమ(?:ో(?:తి?)?|తి?)?|మ(?:ో(?:తి?)?|తి?)?)|\s*త(?:ిమ(?:ో(?:తి?)?|తి?)?|మ(?:ో(?:తి?)?|తి?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(త(?:ీతు?|తు?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ప(?:ిల(?:ేమ(?:ోను?|ను?)|మ(?:ోను?|ను?)|ె)?|ల(?:ేమ(?:ోను?|ను?)|మ(?:ోను?|ను?)|ె)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ఏబ(?:్రీ?|రీ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(య(?:ాక(?:ో(?:బు?)?|బు?)?|క(?:ో(?:బు?)?|బు?)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*ప(?:ేత(?:ు(?:రు?)?|రు?)?|త(?:ు(?:రు?)?|రు?)?)|\s*ప(?:ేత(?:ు(?:రు?)?|రు?)?|త(?:ు(?:రు?)?|రు?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*ప(?:ేత(?:ు(?:రు?)?|రు?)?|త(?:ు(?:రు?)?|రు?)?)|\s*ప(?:ేత(?:ు(?:రు?)?|రు?)?|త(?:ు(?:రు?)?|రు?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(య(?:ూదా?|దా?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
