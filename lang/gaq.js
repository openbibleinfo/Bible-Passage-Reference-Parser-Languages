var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["gaq"];
    this.translations = [/NTDAA20\b/gi];
    this.first = /୧\.?\s*/;
    this.second = /୨\.?\s*/;
    this.third = /୩\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ପ(?:୍ରକ(?:ାସ(?:ିତ୍?‌|ତ୍?‌)|ସ(?:ିତ୍?‌|ତ୍?‌))|ରକ(?:ାସ(?:ିତ୍?‌|ତ୍?‌)|ସ(?:ିତ୍?‌|ତ୍?‌))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*ଜହନ୍?‌|\s*ଜହନ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ଜହନ୍?‌|\s*ଜହନ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୩(?:\.\s*ଜହନ୍?‌|\s*ଜହନ୍?‌))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଜହନ୍?‌)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୧(?:\.\s*କର(?:ିନ(?:୍‌ତି?ୟ|‌ତି?ୟ)|ନ(?:୍‌ତି?ୟ|‌ତି?ୟ))|\s*କର(?:ିନ(?:୍‌ତି?ୟ|‌ତି?ୟ)|ନ(?:୍‌ତି?ୟ|‌ତି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*କର(?:ିନ(?:୍‌ତି?ୟ|‌ତି?ୟ)|ନ(?:୍‌ତି?ୟ|‌ତି?ୟ))|\s*କର(?:ିନ(?:୍‌ତି?ୟ|‌ତି?ୟ)|ନ(?:୍‌ତି?ୟ|‌ତି?ୟ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(କଲସି?ୟ)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
          ...
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ଜ(?:ାକ(?:ୁବ୍?‌|ବ୍?‌)|କ(?:ୁବ୍?‌|ବ୍?‌)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
          ...
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(୨(?:\.\s*ପି?ତର|\s*ପି?ତର))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
