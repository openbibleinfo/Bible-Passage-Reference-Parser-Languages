  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ॱङ(?:(?:ो(?:़न्?‍पा|न्?‍पा)|़न्?‍पा|न्?‍पा)|(?:ो(?:़न्?‍प|न्?‍प)|़न्?‍प|न्?‍प))|མངོ?ན་པ།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:མད་ཐཱ?།|म(?:े?था|े?थ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:མར་ཀུ?།|म(?:ा?रकु|ा?रक)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ལ(?:ུ་ཀ།?|་ཀ།?)|ल(?:ु?का|ु?क)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:३\s*य(?:(?:ोहा?न्?‍ना|हा?न्?‍ना)|(?:ोह(?:ा?न्?‍न|ा)?|ह(?:ा?न्?‍न|ा)?))|༣\s*ཡ(?:ོ་ཧ(?:་ནན)?།|་ཧ(?:་ནན)?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([१༡](?:\.\s*(?:य(?:(?:ोहा?न्?‍ना|हा?न्?‍ना)|(?:ोह(?:ा?न्?‍न|ा)?|ह(?:ा?न्?‍न|ा)?))|ཡ(?:ོ་ཧ(?:་ནན)?།|་ཧ(?:་ནན)?།))|\s*(?:य(?:(?:ोहा?न्?‍ना|हा?न्?‍ना)|(?:ोह(?:ा?न्?‍न|ा)?|ह(?:ा?न्?‍न|ा)?))|ཡ(?:ོ་ཧ(?:་ནན)?།|་ཧ(?:་ནན)?།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([२༢](?:\.\s*(?:य(?:(?:ोहा?न्?‍ना|हा?न्?‍ना)|(?:ोह(?:ा?न्?‍न|ा)?|ह(?:ा?न्?‍न|ा)?))|ཡ(?:ོ་ཧ(?:་ནན)?།|་ཧ(?:་ནན)?།))|\s*(?:य(?:(?:ोहा?न्?‍ना|हा?न्?‍ना)|(?:ोह(?:ा?न्?‍न|ा)?|ह(?:ा?न्?‍न|ा)?))|ཡ(?:ོ་ཧ(?:་ནན)?།|་ཧ(?:་ནན)?།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:य(?:(?:ोहा?न्?‍ना|हा?न्?‍ना)|(?:ोह(?:ा?न्?‍न|ा)?|ह(?:ा?न्?‍न|ा)?))|ཡ(?:ོ་ཧ(?:་ནན)?།|་ཧ(?:་ནན)?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:མཛད་པ།|ज(?:े?पा|े?प)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ར(?:ོ་མ(?:ཱ?་པ|ཱ?)།|་མ(?:ཱ?་པ|ཱ?)།)|र(?:(?:ोमा?पा|मा?पा)|(?:ोम(?:ाप|प)?|म(?:ाप|प)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([१༡](?:\.\s*(?:ཀ(?:ོ་ར(?:ིན(?:་ཐུ?་པ།|།)|ན(?:་ཐུ?་པ།|།))|་ར(?:ིན(?:་ཐུ?་པ།|།)|ན(?:་ཐུ?་པ།|།)))|क(?:(?:ोर(?:ीन(?:्‍थु?पा|‍थु?पा)|न(?:्‍थु?पा|‍थु?पा))|र(?:ीन(?:्‍थु?पा|‍थु?पा)|न(?:्‍थु?पा|‍थु?पा)))|(?:ोर(?:ीन(?:्‍थु?प|‍थु?प)?|न(?:्‍थु?प|‍थु?प)?)|र(?:ीन(?:्‍थु?प|‍थु?प)?|न(?:्‍थु?प|‍थु?प)?))))|\s*(?:ཀ(?:ོ་ར(?:ིན(?:་ཐུ?་པ།|།)|ན(?:་ཐུ?་པ།|།))|་ར(?:ིན(?:་ཐུ?་པ།|།)|ན(?:་ཐུ?་པ།|།)))|क(?:(?:ोर(?:ीन(?:्‍थु?पा|‍थु?पा)|न(?:्‍थु?पा|‍थु?पा))|र(?:ीन(?:्‍थु?पा|‍थु?पा)|न(?:्‍थु?पा|‍थु?पा)))|(?:ोर(?:ीन(?:्‍थु?प|‍थु?प)?|न(?:्‍थु?प|‍थु?प)?)|र(?:ीन(?:्‍थु?प|‍थु?प)?|न(?:्‍थु?प|‍थु?प)?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([२༢](?:\.\s*(?:ཀ(?:ོ་ར(?:ིན(?:་ཐུ?་པ།|།)|ན(?:་ཐུ?་པ།|།))|་ར(?:ིན(?:་ཐུ?་པ།|།)|ན(?:་ཐུ?་པ།|།)))|क(?:(?:ोर(?:ीन(?:्‍थु?पा|‍थु?पा)|न(?:्‍थु?पा|‍थु?पा))|र(?:ीन(?:्‍थु?पा|‍थु?पा)|न(?:्‍थु?पा|‍थु?पा)))|(?:ोर(?:ीन(?:्‍थु?प|‍थु?प)?|न(?:्‍थु?प|‍थु?प)?)|र(?:ीन(?:्‍थु?प|‍थु?प)?|न(?:्‍थु?प|‍थु?प)?))))|\s*(?:ཀ(?:ོ་ར(?:ིན(?:་ཐུ?་པ།|།)|ན(?:་ཐུ?་པ།|།))|་ར(?:ིན(?:་ཐུ?་པ།|།)|ན(?:་ཐུ?་པ།|།)))|क(?:(?:ोर(?:ीन(?:्‍थु?पा|‍थु?पा)|न(?:्‍थु?पा|‍थु?पा))|र(?:ीन(?:्‍थु?पा|‍थु?पा)|न(?:्‍थु?पा|‍थु?पा)))|(?:ोर(?:ीन(?:्‍थु?प|‍थु?प)?|न(?:्‍थु?प|‍थु?प)?)|र(?:ीन(?:्‍थु?प|‍थु?प)?|न(?:्‍थु?प|‍थु?प)?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ཀ(?:ོ་ལ(?:ོ་ས(?:(?:ཱ?ེ|ཱ?)་པ|(?:ཱ?ེ|ཱ?))།|་ས(?:(?:ཱ?ེ|ཱ?)་པ|(?:ཱ?ེ|ཱ?))།)|་ལ(?:ོ་ས(?:(?:ཱ?ེ|ཱ?)་པ|(?:ཱ?ེ|ཱ?))།|་ས(?:(?:ཱ?ེ|ཱ?)་པ|(?:ཱ?ེ|ཱ?))།))|क(?:(?:ोल(?:ोसे?पा|से?पा)|ल(?:ोसे?पा|से?पा))|(?:ोल(?:ोस(?:ेप?|प)?|स(?:ेप?|प)?)|ल(?:ोस(?:ेप?|प)?|स(?:ेप?|प)?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ག་ལ་ཏ(?:ི་ཡ(?:ཱ?་པ|ཱ?)།|་ཡ(?:ཱ?་པ|ཱ?)།)|ग(?:(?:ाल(?:ात(?:ीया?पा|या?पा)|त(?:ीया?पा|या?पा))|ल(?:ात(?:ीया?पा|या?पा)|त(?:ीया?पा|या?पा)))|(?:ाल(?:ात(?:ीय(?:ाप?|प)?|य(?:ाप?|प)?)|त(?:ीय(?:ाप?|प)?|य(?:ाप?|प)?))|ल(?:ात(?:ीय(?:ाप?|प)?|य(?:ाप?|प)?)|त(?:ीय(?:ाप?|प)?|य(?:ाप?|प)?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ཨ(?:ེ་ཕ(?:ེ་ས(?:ུ?་པ|ུ?)།|་ས(?:ུ?་པ|ུ?)།)|་ཕ(?:ེ་ས(?:ུ?་པ|ུ?)།|་ས(?:ུ?་པ|ུ?)།))|एफ(?:(?:ीसु?पा|सु?पा)|(?:ीस(?:ुप?|प)?|स(?:ुप?|प)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ཕ(?:ི་ལ(?:ིབ(?:་པ(?:ཱ?ི|ཱ?)་པ།|།)|བ(?:་པ(?:ཱ?ི|ཱ?)་པ།|།))|་ལ(?:ིབ(?:་པ(?:ཱ?ི|ཱ?)་པ།|།)|བ(?:་པ(?:ཱ?ི|ཱ?)་པ།|།)))|फ(?:(?:ील(?:ीप(?:्‍पी?पा|‍पी?पा)|प(?:्‍पी?पा|‍पी?पा))|ल(?:ीप(?:्‍पी?पा|‍पी?पा)|प(?:्‍पी?पा|‍पी?पा)))|(?:ील(?:ीप(?:्‍पी?प|‍पी?प)?|प(?:्‍पी?प|‍पी?प)?)|ल(?:ीप(?:्‍पी?प|‍पी?प)?|प(?:्‍पी?प|‍पी?प)?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([१༡](?:\.\s*(?:ཐ(?:ེ་ས(?:་ལ(?:ོ་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།)|་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།))|།)|་ས(?:་ལ(?:ོ་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།)|་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།))|།))|थ(?:(?:ेसा?ल(?:ोन(?:ीके?पा|के?पा)|न(?:ीके?पा|के?पा))|सा?ल(?:ोन(?:ीके?पा|के?पा)|न(?:ीके?पा|के?पा)))|(?:ेस(?:ा?ल(?:ोन(?:ीके?प|के?प)|न(?:ीके?प|के?प))|ा)?|स(?:ा?ल(?:ोन(?:ीके?प|के?प)|न(?:ीके?प|के?प))|ा)?)))|\s*(?:ཐ(?:ེ་ས(?:་ལ(?:ོ་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།)|་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།))|།)|་ས(?:་ལ(?:ོ་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།)|་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།))|།))|थ(?:(?:ेसा?ल(?:ोन(?:ीके?पा|के?पा)|न(?:ीके?पा|के?पा))|सा?ल(?:ोन(?:ीके?पा|के?पा)|न(?:ीके?पा|के?पा)))|(?:ेस(?:ा?ल(?:ोन(?:ीके?प|के?प)|न(?:ीके?प|के?प))|ा)?|स(?:ा?ल(?:ोन(?:ीके?प|के?प)|न(?:ीके?प|के?प))|ा)?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([२༢](?:\.\s*(?:ཐ(?:ེ་ས(?:་ལ(?:ོ་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།)|་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།))|།)|་ས(?:་ལ(?:ོ་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།)|་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།))|།))|थ(?:(?:ेसा?ल(?:ोन(?:ीके?पा|के?पा)|न(?:ीके?पा|के?पा))|सा?ल(?:ोन(?:ीके?पा|के?पा)|न(?:ीके?पा|के?पा)))|(?:ेस(?:ा?ल(?:ोन(?:ीके?प|के?प)|न(?:ीके?प|के?प))|ा)?|स(?:ा?ल(?:ोन(?:ीके?प|के?प)|न(?:ीके?प|के?प))|ा)?)))|\s*(?:ཐ(?:ེ་ས(?:་ལ(?:ོ་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།)|་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།))|།)|་ས(?:་ལ(?:ོ་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།)|་ན(?:ི་ཀེ?་པ།|་ཀེ?་པ།))|།))|थ(?:(?:ेसा?ल(?:ोन(?:ीके?पा|के?पा)|न(?:ीके?पा|के?पा))|सा?ल(?:ोन(?:ीके?पा|के?पा)|न(?:ीके?पा|के?पा)))|(?:ेस(?:ा?ल(?:ोन(?:ीके?प|के?प)|न(?:ीके?प|के?प))|ा)?|स(?:ा?ल(?:ोन(?:ीके?प|के?प)|न(?:ीके?प|के?प))|ा)?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([१༡](?:\.\s*(?:ཏ(?:ི་མ(?:ོ་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)|་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།))|་མ(?:ོ་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)|་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)))|त(?:(?:ीम(?:ोथे?उ|थे?उ)|म(?:ोथे?उ|थे?उ))|(?:ीम(?:ोथे?|थे?)|म(?:ोथे?|थे?))))|\s*(?:ཏ(?:ི་མ(?:ོ་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)|་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།))|་མ(?:ོ་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)|་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)))|त(?:(?:ीम(?:ोथे?उ|थे?उ)|म(?:ोथे?उ|थे?उ))|(?:ीम(?:ोथे?|थे?)|म(?:ोथे?|थे?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([२༢](?:\.\s*(?:ཏ(?:ི་མ(?:ོ་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)|་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།))|་མ(?:ོ་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)|་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)))|त(?:(?:ीम(?:ोथे?उ|थे?उ)|म(?:ोथे?उ|थे?उ))|(?:ीम(?:ोथे?|थे?)|म(?:ोथे?|थे?))))|\s*(?:ཏ(?:ི་མ(?:ོ་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)|་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།))|་མ(?:ོ་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)|་ཐ(?:ེ(?:འུ?།|།)|འུ?།|།)))|त(?:(?:ीम(?:ोथे?उ|थे?उ)|म(?:ोथे?उ|थे?उ))|(?:ीम(?:ोथे?|थे?)|म(?:ोथे?|थे?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ཏ(?:ི་ཏ(?:ོས?།|ས?།)|་ཏ(?:ོས?།|ས?།))|त(?:(?:ीतो?स|तो?स)|(?:ीतो?|तो?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ཕ(?:ི་ལ(?:ེ?་མོ?ན།|ེ?།)|་ལ(?:ེ?་མོ?ན།|ེ?།))|फ(?:(?:ीले?मो?न|ले?मो?न)|(?:ीले?|ले?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ཨ(?:ིབ་ར(?:ི?་པ|ི?)།|བ་ར(?:ི?་པ|ི?)།)|ईब(?:(?:्‍री?पा|‍री?पा)|(?:्‍र(?:ीप?|प)?|‍र(?:ीप?|प)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ཡ་ཀ(?:ོབ?།|བ?།)|य(?:(?:ाको?ब|को?ब)|(?:ाको?|को?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([१༡](?:\.\s*(?:པ(?:ེ་ཏ(?:ྲོ?།|ོ?།)|་ཏ(?:ྲོ?།|ོ?།))|प(?:े?टो|े?ट))|\s*(?:པ(?:ེ་ཏ(?:ྲོ?།|ོ?།)|་ཏ(?:ྲོ?།|ོ?།))|प(?:े?टो|े?ट))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))([२༢](?:\.\s*(?:པ(?:ེ་ཏ(?:ྲོ?།|ོ?།)|་ཏ(?:ྲོ?།|ོ?།))|प(?:े?टो|े?ट))|\s*(?:པ(?:ེ་ཏ(?:ྲོ?།|ོ?།)|་ཏ(?:ྲོ?།|ོ?།))|प(?:े?टो|े?ट))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))((?:ཡ(?:ུ་དཱ?།|་དཱ?།)|य(?:ु?दा|ु?द)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
