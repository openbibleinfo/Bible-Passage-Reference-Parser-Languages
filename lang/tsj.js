  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(མཇལ་ཁ།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(མ་ཏི?།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(མར་ཀུ?ས།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ལུ?་ཀ།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(དང་པ་ཡུ?་ཧན་ན།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(གཉ(?:ིས་པ་ཡུ?་ཧན་ན།|ས་པ་ཡུ?་ཧན་ན།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["3John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(གས(?:ུམ་པ་\s*ཡུ?་ཧན་ན།|མ་པ་\s*ཡུ?་ཧན་ན།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["John"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཡུ?་ཧན་ན།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
          ...
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ར(?:ོ་མི?།|་མི?།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(དང་པ་ཀ(?:ོ་ར(?:ིན་ཐི?།|ན་ཐི?།)|་ར(?:ིན་ཐི?།|ན་ཐི?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(གཉ(?:ིད་པ་ཀ(?:ོ་ར(?:ིན་ཐི?།|ན་ཐི?།)|་ར(?:ིན་ཐི?།|ན་ཐི?།))|ད་པ་ཀ(?:ོ་ར(?:ིན་ཐི?།|ན་ཐི?།)|་ར(?:ིན་ཐི?།|ན་ཐི?།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཀ་ལ(?:ཱས་སི?།|ས་སི?།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ག་ལ་ཏི?།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཨ(?:ེ་ཕ(?:ི་སི?།|་སི?།)|་ཕ(?:ི་སི?།|་སི?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཕ(?:ི་ལ(?:ིབ་པི?།|བ་པི?།)|་ལ(?:ིབ་པི?།|བ་པི?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(དང་པ་ཐ(?:ེ་ས་ལ(?:ོ་ན(?:ི་ཀི?།|་ཀི?།)|་ན(?:ི་ཀི?།|་ཀི?།))|་ས་ལ(?:ོ་ན(?:ི་ཀི?།|་ཀི?།)|་ན(?:ི་ཀི?།|་ཀི?།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(གཉ(?:ིས་པ་ཐ(?:ེ་ས་ལ(?:ོ་ན(?:ི་ཀི?།|་ཀི?།)|་ན(?:ི་ཀི?།|་ཀི?།))|་ས་ལ(?:ོ་ན(?:ི་ཀི?།|་ཀི?།)|་ན(?:ི་ཀི?།|་ཀི?།)))|ས་པ་ཐ(?:ེ་ས་ལ(?:ོ་ན(?:ི་ཀི?།|་ཀི?།)|་ན(?:ི་ཀི?།|་ཀི?།))|་ས་ལ(?:ོ་ན(?:ི་ཀི?།|་ཀི?།)|་ན(?:ི་ཀི?།|་ཀི?།)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(དང་པ་ཏ(?:ི་མ(?:ོ་ཐི?།|་ཐི?།)|་མ(?:ོ་ཐི?།|་ཐི?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(གཉ(?:ིས་པ་ཏ(?:ི་མ(?:ོ་ཐི?།|་ཐི?།)|་མ(?:ོ་ཐི?།|་ཐི?།))|ས་པ་ཏ(?:ི་མ(?:ོ་ཐི?།|་ཐི?།)|་མ(?:ོ་ཐི?།|་ཐི?།))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཏ(?:ི་ཏཱ?ས།|་ཏཱ?ས།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཧ(?:ི་བ(?:ུརུ?།|རུ?།)|་བ(?:ུརུ?།|རུ?།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཡ་ཀུ?བ།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(དང་པ་པ་ཏ(?:ྲུ?ས།|ུ?ས།))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(གཉ(?:ིས་པ་པ་ཏ(?:ྲུ?ས།|ུ?ས།)|ས་པ་པ་ཏ(?:ྲུ?ས།|ུ?ས།)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ཡ་ཧུ?་ད།)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
