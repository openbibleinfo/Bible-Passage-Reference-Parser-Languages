  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Gen"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(ប(?:ាត(?:់\s*អន(?:់ន(?:ួរៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)|រៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម))|ន(?:ួរៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)|រៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)))|\s*អន(?:់ន(?:ួរៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)|រៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម))|ន(?:ួរៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)|រៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម))))|ត(?:់\s*អន(?:់ន(?:ួរៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)|រៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម))|ន(?:ួរៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)|រៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)))|\s*អន(?:់ន(?:ួរៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)|រៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម))|ន(?:ួរៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម)|រៗ\s*ពន(?:់ឋើ?ម|ឋើ?ម))))|អ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ruth"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(រូ?ត)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Ps"],
            testament: "oa",
            testament_books: { Ps: "oa" },
            regexp: /(?:^|(?<=[^\p{L}]))(ព(?:្រត(?:ឹ?ះ\s*ព(?:្រនែ?|រនែ?)|ឹ?\s*ព(?:្រនែ?|រនែ?))|រត(?:ឹ?ះ\s*ព(?:្រនែ?|រនែ?)|ឹ?\s*ព(?:្រនែ?|រនែ?))|ព))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jonah"],
            testament: "o",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:៉(?:ូណះ?|ណះ?)|ូណះ?|ណះ?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ម(?:៉(?:ាក(?:ុ?ះ|ុ)?|ក(?:ុ?ះ|ុ)?)|ាក(?:ុ?ះ|ុ)?|ក(?:ុ?ះ|ុ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ល(?:ូកា?|កា?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ក(?:ាន\s*ពហា?យ|ន\s*ពហា?យ|ព))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ក(?:ូរ(?:ិនថ(?:ុ?ះ|ុ)?|នថ(?:ុ?ះ|ុ)?)|រ(?:ិនថ(?:ុ?ះ|ុ)?|នថ(?:ុ?ះ|ុ)?))|\s*ក(?:ូរ(?:ិនថ(?:ុ?ះ|ុ)?|នថ(?:ុ?ះ|ុ)?)|រ(?:ិនថ(?:ុ?ះ|ុ)?|នថ(?:ុ?ះ|ុ)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ក(?:ូរ(?:ិនថ(?:ុ?ះ|ុ)?|នថ(?:ុ?ះ|ុ)?)|រ(?:ិនថ(?:ុ?ះ|ុ)?|នថ(?:ុ?ះ|ុ)?))|\s*ក(?:ូរ(?:ិនថ(?:ុ?ះ|ុ)?|នថ(?:ុ?ះ|ុ)?)|រ(?:ិនថ(?:ុ?ះ|ុ)?|នថ(?:ុ?ះ|ុ)?))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
          ...
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ក(?:ូឡ(?:ុ?ះ|ុ)?|ឡ(?:ុ?ះ|ុ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(អ(?:៊(?:ែភ(?:ែសូ?|សូ?)|ភ(?:ែសូ?|សូ?))|ែភ(?:ែសូ?|សូ?)|ភ(?:ែសូ?|(?:សូ?)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
          ...
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ទ(?:ីត(?:ុ?ះ|ុ)?|ត(?:ុ?ះ|ុ)?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(ភ(?:ីល(?:ែម(?:៉ូ?ន|ូ?ន)|ម(?:៉ូ?ន|ូ?ន))|ល(?:ែម(?:៉ូ?ន|ូ?ន)|(?:ម(?:៉ូ?ន|ូ?ន))?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(យ(?:៉(?:ាគ(?:់\s*យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប)|\s*យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប))|គ(?:់\s*យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប)|\s*យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប)))|ាគ(?:់\s*យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប)|\s*យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប))|គ(?:់\s*យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប)|\s*យ(?:៉(?:ាកុ?ប|កុ?ប)|ាកុ?ប|កុ?ប))|ក))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(១(?:\.\s*ពត្?រ|\s*ពត្?រ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២(?:\.\s*ពត្?រ|\s*ពត្?រ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(ត(?:ើម\s*ប៊ឹង\s*យ៉ាគ់\s*ពែត្រុះ|ម\s*បង\s*យគ\s*ពតរ))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(២ព(?:ែត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)|ត(?:្រ(?:ុ?ះ|ុ)?|រ(?:ុ?ះ|ុ)?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
