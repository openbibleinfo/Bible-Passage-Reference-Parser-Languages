var bcv_regexps = class {
  constructor() {
    this.books = [];
    this.languages = ["hoy"];
    this.translations = [/NTHAA20\b/gi];
    this.first = /१\.?\s*/;
    this.second = /२\.?\s*/;
    this.third = /३\.?\s*/;
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(प(?:्र(?:ेर(?:ितगो?ळ|तगो?ळ)|र(?:ितगो?ळ|तगो?ळ))|र(?:ेर(?:ितगो?ळ|तगो?ळ)|र(?:ितगो?ळ|तगो?ळ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
          ...
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*क(?:ुर(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?))|र(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?)))|\s*क(?:ुर(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?))|र(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*क(?:ुर(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?))|र(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?)))|\s*क(?:ुर(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?))|र(?:िन(?:्थि?|थि?)|न(?:्थि?|थि?)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(क(?:ुल(?:ुस(?:्स(?:िगो?ळ|गो?ळ)|स(?:िगो?ळ|गो?ळ))|स(?:्स(?:िगो?ळ|गो?ळ)|स(?:िगो?ळ|गो?ळ)))|ल(?:ुस(?:्स(?:िगो?ळ|गो?ळ)|स(?:िगो?ळ|गो?ळ))|स(?:्स(?:िगो?ळ|गो?ळ)|स(?:िगो?ळ|गो?ळ)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(गल(?:ात(?:िगो?ळ|गो?ळ)|त(?:िगो?ळ|गो?ळ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इफ(?:िस(?:िगो?ळ|गो?ळ)|स(?:िगो?ळ|गो?ळ)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(फ(?:िल(?:िप(?:्प(?:िगो?ळ|गो?ळ)|प(?:िगो?ळ|गो?ळ))|प(?:्प(?:िगो?ळ|गो?ळ)|प(?:िगो?ळ|गो?ळ)))|ल(?:िप(?:्प(?:िगो?ळ|गो?ळ)|प(?:िगो?ळ|गो?ळ))|प(?:्प(?:िगो?ळ|गो?ळ)|प(?:िगो?ळ|गो?ळ)))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(१(?:\.\s*थ(?:िस(?:्सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))|सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?)))|स(?:्सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))|सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))))|\s*थ(?:िस(?:्सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))|सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?)))|स(?:्सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))|सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(२(?:\.\s*थ(?:िस(?:्सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))|सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?)))|स(?:्सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))|सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))))|\s*थ(?:िस(?:्सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))|सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?)))|स(?:्सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))|सल(?:ुन(?:ीकि?|कि?)|न(?:ीकि?|कि?))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(इब(?:्र(?:ान(?:िगो?ळ|गो?ळ)|न(?:िगो?ळ|गो?ळ))|र(?:ान(?:िगो?ळ|गो?ळ)|न(?:िगो?ळ|गो?ळ))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
