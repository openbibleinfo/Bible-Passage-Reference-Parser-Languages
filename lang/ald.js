  ...
  constructor() {
    ...
    this.all_books = [
          ...
          },
          {
            osis: ["Rev"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ɔwɔ-mɛ(?:̀n-yrik[aà]n|n-yrik[aà]n))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Matt"],
            testament: "n",
          ...
          },
          {
            osis: ["Mark"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Markɛ̀?n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Luke"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(L[uü]kɛ̀?n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1John"],
            testament: "n",
          ...
          },
          {
            osis: ["Acts"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ɔkɔ(?:̀hɔ(?:̀n-w[aá]-bɔ(?:̀\s*kɔ(?:̀hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)|hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n))|\s*kɔ(?:̀hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)|hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)))|n-w[aá]-bɔ(?:̀\s*kɔ(?:̀hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)|hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n))|\s*kɔ(?:̀hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)|hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n))))|hɔ(?:̀n-w[aá]-bɔ(?:̀\s*kɔ(?:̀hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)|hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n))|\s*kɔ(?:̀hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)|hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)))|n-w[aá]-bɔ(?:̀\s*kɔ(?:̀hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)|hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n))|\s*kɔ(?:̀hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n)|hɔ(?:̀n\s*h[aá]n|n\s*h[aá]n))))))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Rom"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Rɔmɛ(?:̀n-anm[aà]n-bɔ̀?|n-anm[aà]n-bɔ̀?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*Korɛntɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?)|\s*Korɛntɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Cor"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*Korɛntɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?)|\s*Korɛntɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Col"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Kɔlɔs[eè]n\s*anm[aà]n-bɔ̀?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Gal"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Galasi\s*anm[aà]n-bɔ̀?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Eph"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Efɛzɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phil"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Filipɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*Tesalonikɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?)|\s*Tesalonikɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Thess"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*Tesalonikɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?)|\s*Tesalonikɛ(?:̀n\s*anm[aà]n-bɔ̀?|n\s*anm[aà]n-bɔ̀?)))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Kp[aà]kp[aà]\s*timote)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Tim"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Anhyrɛmɛ̀?n\s*timote)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Titus"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Titɛ̀?n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Phlm"],
            testament: "n",
          ...
          },
          {
            osis: ["Heb"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Ebre-bɔ̀?)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jas"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Zhakɛ̀?n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["1Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(1(?:\.\s*Piɛrɛ̀?n|\s*Piɛrɛ̀?n))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["2Pet"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(2(?:\.\s*Piɛrɛ̀?n|\s*Piɛrɛ̀?n))(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          },
          {
            osis: ["Jude"],
            testament: "n",
            regexp: /(?:^|(?<=[^\p{L}]))(Zh[uü]dɛ̀?n)(?:(?=[\d\s\.?:,;\x1e\x1f&\(\)（）\[\]\/"’'\*=~\-–—])|$)/giu
          }
        ];
  }
};
